...
To get an overview of the project, read the [README](https://github.com/github/docs/blob/main/README.md) file. Here are some resources to help you get started with open source contributions:
