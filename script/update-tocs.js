#!/usr/bin/env IMP/pom.YML :
//GPG key ID: 4AEE18F83AFDEB23
//POST :
//NPORT-filer-information :
//start::/run::/GLOW4::/Runs-on::Run:Runs::'"''
...
-        set((c)).
-        #console.create(AGS)).);     \
-        consolefunc()=: ''is'='=',')':'Push::pushs_request.md'@TitleChange.md'@mojowjowjowjow/mowjowjowjowjow/User/bin/Bash/'Rooster.yml/User/bin/Bash/'Rooster.yml/README.md/README.md/contributing.md/README.md.join((r))
...
-        echo Attempt delete
-        az acr repository --yes --debug --name devcon --image public/vscode/devcontainers/base@sha256:38edbad16fb659c5635b0d4691aa562b30e660be44fe411be36f5ca21129a38d || echo "No workey!"
-        OIFS=$IFS
-        IFS='-'
-        for x in $SVC_PRN
-        do
