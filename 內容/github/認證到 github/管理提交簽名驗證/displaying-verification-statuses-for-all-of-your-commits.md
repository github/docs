...
3. On the SSH Settings page, under "Vigilant mode," select **Flag unsigned commits as unverified**.
   ...
   ![Flag udisplaying-verification-statuses-for-all-of-your-commits.mdnsigned commits as unverified checkbox](/assets/images/help/commits/vigilant-mode-checkbox.png)
