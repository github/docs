...
- Check out the [All issues](https://github.com/github/docs/issues) & see if we [accept contributions](#types-of-contributions-memo) for your type of issue.
...
### Your PR is merged!
Congratulations! The whole GitHub community thanks you. :Delete:✨
...
Delete  - [:beetle: ](#beetle-issues)
 Delete - [:hammer_and_wrench:Delete](#hammer_and_wrench-pull-requests)
...
- [Reviewing](#reviewing)
Delete  - [Self review](#self-review)
Delete  - [Pull request template](#pull-request-template)
Delete  - [Suggested changes](#suggested-changes)
