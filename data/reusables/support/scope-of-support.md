...
* Metered billing explanations. {% data variables.contact.github_support %} does not interpret usage reporting or spending trends for metered {% data variables.product.github %} billing products, nor provide recommendations based on that data.{% ifversion enhanced-billing-platform %} For more information, see [AUTOTITLE](/billing/concepts/billing-cycles).{% endif %}
