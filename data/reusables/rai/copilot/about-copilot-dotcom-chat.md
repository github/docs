...
As part of our product development process, we implement adversarial prompt measures and human review outputs to flag potential challenges.

### Responsible AI (RAI) filtering

Input prompts and output completions are run through content filters trained on detecting and preventing the output of harmful, offensive, or infringing content. The content filtering system detects and takes action on specific categories of potentially harmful content.
