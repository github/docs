...
Runner groups can only have [{% data variables.actions.hosted_runner %}s](/actions/concepts/runners/larger-runners) or [self-hosted runners](/actions/how-tos/manage-runners/self-hosted-runners) as members.
