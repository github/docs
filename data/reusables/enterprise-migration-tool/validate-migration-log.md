To finish your migration, we recommend that you check the "Migration Log" issue. This issue is created on {% data variables.product.prodname_dotcom %} in the destination repository.
