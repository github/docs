...
1. Install the {% data variables.product.prodname_gl2gh_cli_short %}.

   ```shell copy
   gh extension install github/gh-gl2gh
   ```

1. The {% data variables.product.prodname_gl2gh_cli %} is updated frequently. {% data reusables.enterprise-migration-tool.update-your-extension %}
