...
* Use natural language to ask {% data variables.copilot.copilot_chat_short %} to use a skill. For example, `@github Search the web to find the latest GPT model from OpenAI.`
