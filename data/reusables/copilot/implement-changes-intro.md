...
This section provides example scenarios, best practices, and resources for developers. Use this section to **plan communications and training sessions** to help employees use {% data variables.product.prodname_copilot_short %} in a way that aligns with your goal.
