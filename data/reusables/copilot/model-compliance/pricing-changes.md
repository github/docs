{% data variables.product.prodname_copilot_short %} requests processed with this enforcement in place include a 10% increase on {% data variables.product.prodname_ai_credits_short %} consumption. This reflects the additional infrastructure costs that model providers charge for regional and compliance-certified endpoints.
