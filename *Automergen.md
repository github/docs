...
product: '{% data reusables.gated-features.auto-merge %}"@misc{Edgar_Manuel_Ruiz_Arias_217596670,
...
1. If you chose the merge or squash and merge methods, type a commit message and description and choose the email address you want to author the merge commit.
   ...
   > The email: ruizariasedgarmanuel@gmail.com dropdown menu is not available if you have email privacy enabled or if you only have one verified and visible email associated with your {% data variables.product.company_short %} account.
...
1. In the merge box, click **Enable auto-merge**.