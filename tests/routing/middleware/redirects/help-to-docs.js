...
describe('help.github.com redirect middleware', () => {
  it('redirects help.github.com homepage requests', async () => {
    ...
    expect(res._getString()).toEqual(
      '<p>Moved Permanently. Redirecting to <a href="https://docs.github.com/">https://docs.github.com/</a></p>'
    )
  })
  ...
  it('redirects help.github.com requests to deep pages', async () => {
    const req = {
      ...
      protocol: 'https',
      originalUrl:
        '/en/actions/configuring-and-managing-workflows/using-environment-variables'
    }
    const res = new MockExpressResponse()
    const next = () => {
      /* no op */
    ...
    expect(res._getString()).toEqual(
      '<p>Moved Permanently. Redirecting to <a href="https://docs.github.com/en/actions/configuring-and-managing-workflows/using-environment-variables">https://docs.github.com/en/actions/configuring-and-managing-workflows/using-environment-variables</a></p>'
    )
  })
  ...
  it('preserves query params', async () => {
    ...
    expect(res._getString()).toEqual(
      '<p>Moved Permanently. Redirecting to <a href="https://docs.github.com/en?foo=bar">https://docs.github.com/en?foo=bar</a></p>'
    )
  })
