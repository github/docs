...
describe('POST /events', () => {
  ...
  const baseExample = {
    context: {
      ...
      href:
        'https://github.com/github/docs/issues?q=is%3Aissue+is%3Aopen+example+',
      site_language: 'en',
  ...
  describe('page', () => {
    ...
    it('should record a page event', () => checkEvent(pageExample, 201))
  ...
  describe('exit', () => {
    ...
    it('should record an exit event', () => checkEvent(exitExample, 201))
  ...
  describe('link', () => {
    ...
    it('should send a link event', () => checkEvent(linkExample, 201))
  ...
  describe('search', () => {
    ...
    it('should record a search event', () => checkEvent(searchExample, 201))
  ...
  describe('navigate', () => {
    ...
    it('should record a navigate event', () => checkEvent(navigateExample, 201))
  ...
  describe('survey', () => {
    ...
    it('should record a survey event', () => checkEvent(surveyExample, 201))
  ...
  describe('experiment', () => {
    ...
    it('experiment_variation is required string', () =>
      checkEvent(
        { ...experimentExample, experiment_variation: undefined },
        400
      ))
  ...
  describe('print', () => {
    ...
    it('should record a print event', () => checkEvent(printExample, 201))
  })
})
