...
{% data reusables.pages.navigate-publishing-source %}
 ...
 # Creates a new branch with no history, called gh-pages and switches to the gh-pages branch
 # If your repository had content and you want to remove it from the gh-pages branch, do
 $ git rm -rf .
 ```
