...
- To use {% data variables.product.prodname_copilot %} in Neovim you must have Neovim version 0.6+ and Node.js version 17 or below installed. For more information, see the [Neovim documentation](https://neovim.io/doc/) and the [Node.js website](https://nodejs.org/en/).
