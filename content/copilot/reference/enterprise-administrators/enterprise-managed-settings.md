...
In {% data variables.product.prodname_vscode_shortname %}, managed permission rules are supported through the {% data variables.product.prodname_copilot_short %} SDK-based Agent Host. Support for legacy permission policies and other execution paths isn't yet at full parity.
