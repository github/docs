...
* Access to {% data variables.product.prodname_GH_advanced_security %} (GHAS) on a private, business-owned repository. See [AUTOTITLE](/get-started/learning-about-github/about-github-advanced-security).
