...
To cancel your {% data variables.product.prodname_copilot_business_short %} plan for your organization account, you need to remove all assigned {% data variables.product.prodname_copilot %} seats.
