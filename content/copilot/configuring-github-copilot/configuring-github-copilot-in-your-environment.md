...
1. In the Resharper menu bar, under **Extensions**, then **Resharper**, click **Options**.
   ![Screenshot of Resharper menu bar. In the "Resharper" menu, the "Options" item is highlighted with an orange outline.](/assets/images/help/copilot/resharper-toolbar-options.png)
