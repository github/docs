...
> [!NOTE] This feature is only available on {% data variables.product.prodname_dotcom_the_website %}. It is not available on {% data variables.enterprise.data_residency_site %} or {% data variables.product.prodname_ghe_server %}.
