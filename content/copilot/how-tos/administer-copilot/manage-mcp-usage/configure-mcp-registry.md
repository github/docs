...
> [!NOTE]
> If you want your developers to have access to local MCP servers, include those servers in your registry with the correct name, description and version. For more information, see [AUTOTITLE](/copilot/reference/mcp-allowlist-enforcement).
