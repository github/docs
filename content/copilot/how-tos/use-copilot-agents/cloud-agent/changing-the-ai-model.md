...
redirect_from:
  - /copilot/how-tos/use-copilot-agents/coding-agent/changing-the-ai-model
---
...
In supported entrypoints, you can select the model used by {% data variables.copilot.copilot_cloud_agent %}.
