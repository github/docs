...
After you give {% data variables.product.prodname_copilot_short %} a task, it works autonomously in the background to complete it. See [AUTOTITLE](/copilot/concepts/agents/cloud-agent/about-cloud-agent).
...
Commits from {% data variables.copilot.copilot_cloud_agent %} have the following characteristics:
...
* Commits from {% data variables.copilot.copilot_cloud_agent %} are signed and appear as "Verified" on {% data variables.product.github %}.
