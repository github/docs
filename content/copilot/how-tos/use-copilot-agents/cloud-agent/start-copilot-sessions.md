...
You can start a new {% data variables.copilot.copilot_cloud_agent %} session with the `gh agent-task create` command in the {% data variables.product.prodname_cli %}.
