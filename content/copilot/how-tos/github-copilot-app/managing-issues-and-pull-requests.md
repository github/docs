...
> * **{% data variables.copilot.copilot_free_short %} users and users without a {% data variables.product.prodname_copilot_short %} plan** — To request access, [join the waitlist](https://gh.io/github-copilot-app?utm_source=docs-github-copilot-app-issues-prs&utm_medium=docs&utm_campaign=msbuild-2026).
...
1. In **My work**, find the issue you want to work on, then click it to view its details.
