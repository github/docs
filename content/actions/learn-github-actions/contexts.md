...
The standard properties in the inputs are defined only for [`workflow_dispatch` event](/actions/learn-github-actions/events-that-trigger-workflows#workflow_dispatch).
