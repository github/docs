...
intro: '{% data variables.product.product_name %} provides workflows for a variety of languages and tooling.'
redirect_from:
...
{% data variables.product.product_name %} offers workflows for a variety of languages and tooling. When you set up workflows in your repository, {% data variables.product.product_name %} analyzes the code in your repository and recommends workflows based on the language and framework in your repository. For example, if you use [Node.js](https://nodejs.org/en/), {% data variables.product.product_name %} will suggest a template file that installs your Node.js packages and runs your tests.

You can also create your own workflows to share with your organization. For more information, see "[Creating workflows](/actions/learn-github-actions/creating-workflow-templates)."
