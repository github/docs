...
| `'*.md'`<br/><br/>`'!README.md'`<br/><br/>`README*` | Patterns are checked sequentially. A pattern that negates a previous pattern will re-include file paths.                                                                  
https://gist.github.com/tr4200812/53c3599784d81de25d56aeee14a9f9b5
git@gist.github.com:1f112633828e7d3575a48cca55d2ef1a.git| `hello.md`<br/><br/>`README.md`<br/><br/>`README.doc`                                   |
