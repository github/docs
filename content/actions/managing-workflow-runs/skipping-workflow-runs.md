...
It is important to note that Git's default behavior removes consecutive newlines. For optimal results, it is recommended including the `--cleanup=verbatim` option.
