...
For more information about creating a CI workflow for your Java project with Maven, see [AUTOTITLE](/actions/tutorials/build-and-test-code/java-with-maven).
...
In the deploy step, you’ll need to set the environment variables to the username that you authenticate with to the repository, and to a secret that you’ve configured with the password or token to authenticate with. For more information, see [AUTOTITLE](/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets).
