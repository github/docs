...
Most commands in the following examples use double quotes for echoing strings, which will attempt interpolate characters like `$` for shell variable names. To always use literal values in quoted strings, you can use single quotes instead.
