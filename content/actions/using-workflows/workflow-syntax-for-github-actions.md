...
Within the called workflow, you can use the [`inputs` context](https://docs.github.com/en/actions/learn-github-actions/contexts#inputs-context) to refer to an input.
