...
- If the action publishes major version tags, using them should allow you to receive critical fixes and security patches while still retaining compatibility (within the abilities of the publisher).
