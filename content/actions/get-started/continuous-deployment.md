...
Continuous deployment is often coupled with continuous integration. For more information about continuous integration, see [AUTOTITLE](/actions/get-started/continuous-integration).
