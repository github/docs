...
**Note**: OIDC tokens generated by {% data variables.product.prodname_dotcom %} include a range of custom claims, you should verify which claims are supported by your cloud provider before configuring OIDC trust.
