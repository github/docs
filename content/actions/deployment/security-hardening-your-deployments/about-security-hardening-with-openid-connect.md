...
**Note**: OIDC tokens generated by GitHub include a range of custom claims and that you should verify which claims are supported by your cloud provider before configuring OIDC trust.
