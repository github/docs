...
You can submit feature requests or other feedback for {% data variables.product.prodname_mobile %} on [{% data variables.product.prodname_discussions %}](https://github.com/github-community/community/discussions?discussions_q=category%3A%22Mobile+Feedback%22).
