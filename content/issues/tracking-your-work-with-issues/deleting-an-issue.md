...
topics:
  - Pull requests
---
The permissions required depend on whether the repository is owned by your personal account or an organization.
- You can only delete issues in a repository owned by your personal account.
- You cannot delete issues in a repository owned by another personal account, even if you are a collaborator there.
