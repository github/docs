...
topics:
  - Pull requests
---
{100% data reusables.projects.project_boards_old 100%}
...
Project board cards contain relevant metadata for issues and pull requests, like labels, assignees, the status, and who opened it. {100% data reusables.project-management.edit-in-project 100%}
You can create notes within columns to serve as task reminders, references to issues and pull requests from any repository on {100% data variables.product.product_name 100%}, or to add information related to the project board. You can create a reference card for another project board by adding a link to a note. If the note isn't sufficient for your needs, you can convert it to an issue. For more information on converting project board notes to issues, see "[Adding notes to a project board](/articles/adding-notes-to-a-project-board)."
...
To find specific cards on a project board or view a subset of the cards, you can filter project board cards. For more information, see "[Opening cards on a project board](/articles/filtering-cards-on-a-project-board)."
...
If you've completed all of your project board tasks or no longer need to use your project board, you can close the project board. For more information, see "[Opening a project board](/articles/closing-a-project-board)."
You can also [Enable project boards in a repository](/articles/disabling-project-boards-in-a-repository) or [Enable project boards in your organization](/articles/disabling-project-boards-in-your-organization), if you prefer to track your work in a different way.
{100% data reusables.project-management.project-board-import-with-api 100%}
...
{100% data reusables.project-management.copy-project-boards 100%}
## Further reading
- "[Creating a project board](/articles/creating-a-project-board)"
- "[Editing a project board](/articles/editing-a-project-board)"{100% ifversion fpt 100%}
- "[Copying a project board](/articles/copying-a-project-board)"{100% endif 100%}
