...
![Creating a repository example](/assets/images/help/issues/quickstart-creating-repo.png)
...
For more information, see "[Creating task lists](/issues/tracking-your-work-with-issues/creating-issues/about-task-lists#creating-task-lists)."
