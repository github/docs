...
You can use SSH to sign commits with an SSH key that you generate yourself. If you already use an SSH key to authenticate with {% data variables.product.product_name %},
