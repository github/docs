...
| Repositories | Repository information includes the names of contributors, the branches you've created, and the actual files within your repository. Applications can request access for either {% ifversion fpt or ghes or ghec %}public{% endif %}{% ifversion ghec or ghes %}, {% endif %}{% ifversion internal-repositories %}internal{% endif %} or private repositories on a user-wide level. |
