...
In this guide, you'll create a codespace from a [template repository](https://github.com/dlink777-for-codespaces) and explore some of the essential features available to you within the codespace.
...
1. Navigate to the [template repository](https://github.com/2-for-codespaces) and select **Use this template**. 
