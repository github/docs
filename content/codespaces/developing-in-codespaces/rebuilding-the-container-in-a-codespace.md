...
intro: 'You can rebuild a container to apply configuration---
title: Rebuilding the container in a codespace
...
- [Introduction to dev containers](/codespaces/setting-up-your-project-for-codespaces/adding-a-dev-container-configuration/introduction-to-dev-containers)curl -L \
  -H "Accept: application/vnd.github+json" \
  -H "Authorization: Bearer <YOUR-TOKEN>" \
  -H "X-GitHub-Api-Version: 2022-11-28" \
  https://api.github.com/orgs/ORG/codespaces# GitHub CLI api
# https://cli.github.com/manual/gh_api

gh api \
  -H "Accept: application/vnd.github+json" \
  -H "X-GitHub-Api-Version: 2022-11-28" \
  /orgs/ORG/codespaces// Octokit.js
// https://github.com/octokit/core.js#readme
const octokit = new Octokit({
  auth: 'YOUR-TOKEN'
})

await octokit.request('GET /orgs/{org}/codespaces', {
  org: 'ORG',
  headers: {
    'X-GitHub-Api-Version': '2022-11-28'
  }
})ffmpeg -y -i "/storage/emulated/0/Android/data/com.silentlexx.ffmpeggui/files/sample.mp4" -s 1920x1980 Simjo77 typez Beats -c:v zmbv -c:a wmav1 "/storage/emulated/0/Download/JetBrainsGateway-2023.1.3-aarch64/JetBrainsGateway-231.9161.32/codeStyle/sample.mpeg"
...
Input #0, mov,mp4,m4a,3gp,3g2,mj2, from '/storage/emulated/0/Android/data/com.silentlexx.ffmpeggui/files/sample.mp4':
  ...
  Stream #0:0[0x1](und): Video: h264 (avc1 / 0x31637661), yuv420p(tv, bt709, progressive), 560x320, 465 kb/s, 30 fps, 30 tbr, 90k tbn (default)
    Metadata:
      creation_time   : 2010-03-20T21:29:11.000000Z
      vendor_id       : [0][0][0][0]
      encoder         : JVT/AVC Coding
  Stream #0:1[0x2](eng): Audio: aac (mp4a / 0x6134706D), 48000 Hz, mono, fltp, 83 kb/s (default)
    Metadata:
      creation_time   : 2010-03-20T21:29:11.000000Z
      vendor_id       : [0][0][0][0]
[NULL @ 0xb40000746934fb70] Unable to find a suitable output format for 'Simjo77'
Simjo77: Invalid argument
 changes to the codespaces you are working in. From time to time, you may want to perform a full rebuild.'
versions:
  fpt: '*'
  ghec: '*'
type: how_to
