...
1. Choose the required machine type.
   ...
   ![Choose your machine type](/assets/images/help/codespaces/change-machine-type-choice.png)
...
1. From the options that are displayed at the top of the page select **Codespaces: Suspend Current Codespace**.

   !['Suspend Current Codespace' option](/assets/images/help/codespaces/suspend-current-codespace.png)

1. After the codespace is suspended, click **Resume**.
