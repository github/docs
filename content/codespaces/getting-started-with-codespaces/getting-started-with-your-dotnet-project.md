...
In the previous section, you used the `postCreateCommand` to installing a set of packages via the `dotnet restore` command. With our dependencies now installed, we can run our application.
