...
To find information about the requirements and supported software and hardware for self-hosted runners, see [AUTOTITLE](/actions/reference/self-hosted-runners-reference).-comments](/rest/pulls/comments)--
...
1. Copy the migration archive to your computer using the [`scp`](https://acloudguru.com/blog/engineering/ssh-and-scp-howto-tips-tricks#scp) command. The archive file will be named with the Migration GUID:
   ...
   ```
assets/validatorLogos/5/0x34caf8c0d58afb0875ba58bbc846979d351dcb2e.webp
{% data reusables.enterprise_migrations.ready-to-import-migrations %}
comments](/rest/pulls/comments)variables.product.github
