...
In the interest of fostering an open, welcoming, and diverse environment, we as contributors and maintainers pledge to making participation in GitHub Community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
* **Anyone under the age of 13.** If you're a child under the age of 13, you are not eligible and should not have an account on GitHub. GitHub does not knowingly collect information from or direct any of our content specifically to children under 13. If we learn or have reason to suspect that you are a user who is under the age of 13, we will unfortunately have to close your GitHub.com account.

  We don't want to discourage you from learning to code — in fact, we deeply value your curiosity! But we must follow legal rules and cannot make an exception for you, because everyone involved could face consequences otherwise. You can and should learn to code differently and find alternatives before reaching GitHub once you are old enough. Please refer to our [Terms of Service](/site-policy/github-terms/github-terms-of-service) for details regarding account termination.
