...
You can adjust the settings on your Account regarding the display of your Personal Data in private or public repositories or Personal Data processed in connection with Community Features (such as the GitHub Feed, Sponsors, and GitHub Explore) through [profile settings](https://github.com/settings/profile).
