...
**Note:** If you used the legacy workflow to manually create an `issue_template.md` (in the `.github` folder) file and enable blank issues in your *config.yml* file, the template in `issue_template.md` will be used when people chose to open a blank issue. If you disable blank issues, the template will never be used.
