...
*CODE_OF_CONDUCT.md* | A CODE_OF_CONDUCT file defines standards for how to engage in a community. For more information, see "[AUTOTITLE](/communities/setting-up-your-project-for-healthy-contributions/adding-a-code-of-conduct-to-your-project)."{% endif %}
...
*GOVERNANCE.md* | A GOVERNANCE file lets people know about how your project is governed. For examples, a sole maintainer project; a small group project that operates by vote; or a group-run project that is interested in adding new governance leaders over time."
