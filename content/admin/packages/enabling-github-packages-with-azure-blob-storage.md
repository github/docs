...
1. Under "Packages Storage", select **Azure Blob Storage** and enter your Azure container name for your packages storage bucket and connection string.
  ...
  **Note:** You can find your Azure Connection String by navigating to your Azure storage account's Access Key menu. 
  Usage of SAS Token or SAS URL as connection string is currently not supported.
