...
More information [here](/enterprise/{{ currentVersion }}/rest/enterprise-admin/users#promote-a-user-to-be-a-site-administrator).

## Demoting a user using REST API
1. Perform `DELETE /users/{username}/site_admin` using an adminitrator token.

More information [here](/enterprise/{{ currentVersion }}/rest/enterprise-admin/users#demote-a-site-administrator).
