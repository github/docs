...
1. {% ifversion ghe-announce-dismiss %}Optionally, enable the "User dismissible" checkbox to make the announcement dismissible by each user.
  ![User dismissible checkbox](/assets/images/enterprise/site-admin-settings/user-dismissible-checkbox.png){% endif %}
