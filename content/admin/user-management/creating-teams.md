...
{{ site.data.reusables.organizations.new_team }}
{{ site.data.reusables.organizations.team_name }}
6. Search for an LDAP group's DN to map the team to. If you don't know the DN, type the LDAP group's name. {{ site.data.variables.product.prodname_ghe_server }} will search for and autocomplete any matches.
