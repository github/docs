...
Once you have [prepared your migration](/github/user-management/preparing-to-migrate-data-to-your-enterprise) you can use the following steps to complete the migration.

{% data reusables.enterprise_installation.ssh-into-target-instance %}

2. Using the `ghe-migrator import` command, start the import process. You'll need:
    * Your [Migration GUID](/github/user-management/preparing-to-migrate-data-to-your-enterprise).
