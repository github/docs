...
intro: 'You can configure Transport Layer Security (TLS) on {{ site.data.variables.product.product_location_enterprise }} so that you can use a certificate that is signed by a trusted certificate authority.'
redirect_from:
