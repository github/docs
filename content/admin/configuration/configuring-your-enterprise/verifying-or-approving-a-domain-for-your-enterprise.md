...
{% ifversion ghec %}To receive email notifications, the owner of the personal account must verify the email address on {% data variables.product.product_name %}. For more information, see "[Verifying your email address](/github/getting-started-with-github/verifying-your-email-address)."{% endif %}

Organization owners cannot see the email address or which personal account is associated with an email address from an approved domain.
