...
- In version 3.{% ifversion ghes = 3.4 %}4.17{% elsif ghes = 3.5 %}5.14{% elsif ghes = 3.6 %}6.10{% elsif ghes = 3.7%}7.8{% elsif ghes = 3.8 %}8.0{% endif %}{% ifversion ghes < 3.8 %} or earlier{% endif %}, the utility writes the file to `/tmp`.
- In version 3.{% ifversion ghes = 3.4 %}4.18{% elsif ghes = 3.5 %}5.15{% elsif ghes = 3.6 %}6.11{% elsif ghes = 3.7%}7.9{% elsif ghes = 3.8 %}8.1{% endif %} or later, the
