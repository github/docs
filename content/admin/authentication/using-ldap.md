...
|--------------------------|----------|-------------|
| `Host`                   | Required | The LDAP host, e.g. `ldap.example.com` or `10.0.0.30`. If the hostname is only available from your internal network, you may need to configure {{ site.data.variables.product.product_location_enterprise }}'s DNS first so it can resolve the hostname using your internal nameservers. |
...
| `Emails`                 | Optional | The email addresses for a user's {{ site.data.variables.product.prodname_ghe_server }} account. |
| `SSH keys`               | Optional | The public SSH keys attached to a user's {{ site.data.variables.product.prodname_ghe_server }} account. The keys must be in OpenSSH format. |
| `GPG keys`               | Optional | The GPG keys attached to a user's {{ site.data.variables.product.prodname_ghe_server }} account. |
