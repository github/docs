...
intro: 'You can failover to a {{ site.data.variables.product.prodname_ghe_server }} replica appliance using the command line for maintenance and testing, or if the primary appliance fails.'
redirect_from:
