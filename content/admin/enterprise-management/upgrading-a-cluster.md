...
2. **With the exception of the primary MySQL node**, connect to the administrative shell of each of the {{ site.data.variables.product.prodname_ghe_server }} nodes.
