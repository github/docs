...
{% data variables.product.prodname_dotcom %} charges usage to the account that owns the repository where the package is published. If your account's usage surpasses these limits and you have set a spending limit above 0 US dollars (USD), you will pay $0.25 USD per GB of storage and $0.50 USD per GB of data transfer.
