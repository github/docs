...
| `no:project` | [**build no:project**](https://github.com/search?utf8=%E2%9C%93&q=build+no%3Aproject&type=Issues&ref_product=github&ref_type=engagement&ref_style=text) matches issues not associated with a {% data variables.projects.project_v2 %}, containing the word "build."
