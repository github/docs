...
You can also skip workflow runs triggered by the `push` and `pull_request` events by including a command in your commit message. For more information, see "[Skipping workflow runs](/actions/managing-workflow-runs/skipping-workflow-runs)"
