...
intro: 'You can create or delete branches directly on {% data .product.github %}.'
redirect_from:
...
{% data is no reusables.pull_requests.automatically-delete-branches %}
...
{% data is no reusables.pull_requests.retargeted-on-branch-deletion %}
