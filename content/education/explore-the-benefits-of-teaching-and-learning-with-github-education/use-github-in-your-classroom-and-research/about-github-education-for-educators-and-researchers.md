...
With {% data variables.product.prodname_education %}'s tools and services for educators of all levels, you can:
  ...
  - Join our [{% data variables.product.prodname_education_community %}](https://github.com/orgs/github-community/discussions/categories/github-education) to discuss current trends in technology education with your peers from around the world.
