...
![Audio_video_notes](/assets/images/plugins/audio-video-notes/av-1.png)
...
For viewing your notes on the map you can switch on the  [Recording layer](https://osmand.net/features/map-viewing#Customize_map_Android)  in  _app menu -> Configure map -> Show (Recording layer).

![Audio_video_notes](/assets/images/plugins/audio-video-notes/av-2.png)
