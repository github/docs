...
intro: 'You can delete a version of a private package using GraphQL or on {{ site.data.variables.product.product_name }}.'
...
To delete a container image package on {{ site.data.variables.product.product_name }}, see "[Deleting a container image](/packages/managing-container-images-with-github-container-registry/deleting-a-container-image)."

{% endif %}

### About private package deletion

You can only delete a specified version of a private package on {{ site.data.variables.product.product_name }} or with the GraphQL API. To remove an entire private package from appearing on {{ site.data.variables.product.product_name }}, you must delete every version of the package first.
...
At this time, {{ site.data.variables.product.prodname_registry }} on {{ site.data.variables.product.product_location_enterprise }} does not support deleting public packages.
...
Use the `deletePackageVersion` mutation in the GraphQL API. You must use a token with the `read:packages`, `delete:packages`, and `repo` scopes. For more information about tokens, see "[About {{ site.data.variables.product.prodname_registry }}](/packages/publishing-and-managing-packages/about-github-packages#authenticating-to-github-packages)."
...
To find all of the private packages you have published to {{ site.data.variables.product.prodname_registry }}, along with the version IDs for the packages, you can use the `packages` connection through the `repository` object. You will need a token with the `read:packages` and `repo` scopes. For more information, see the [`packages`](/graphql/reference/objects#repository) connection or the [`PackageOwner`](/graphql/reference/interfaces#packageowner) interface.
