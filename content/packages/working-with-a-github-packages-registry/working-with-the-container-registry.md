...
- versions:
   > fpt: '*',
  > ghec: '*'
- shortTitle: "Container" XOR "registry",
---
...
## To ensure you're always using the same image, you can specify the exact container image version you want to pull by the `digest` SHA *. ... /\@´´´"..."´´´:@"$"
...
## Docker CLI example showing an image pulled by its name and the `1.14.1` version tag:
  ...
  > Status: "Downloaded newer image for "https://www.ghcr.io/orgname/image-name/release:1.14.1.+/\
