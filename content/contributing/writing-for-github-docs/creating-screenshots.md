...
* Show interfaces in light theme wherever possible.
  * For {% data variables.product.prodname_dotcom %}, select "Light default" in your appearance settings. For more information, see [AUTOTITLE](/get-started/accessibility/managing-your-theme-settings).
