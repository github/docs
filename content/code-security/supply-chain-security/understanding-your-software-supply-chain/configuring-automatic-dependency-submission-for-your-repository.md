...
**Note:** This action uses actions/setup-python to install Python. Therefore, you must include a .python-version file in your repository to specify the Python version to be installed.
