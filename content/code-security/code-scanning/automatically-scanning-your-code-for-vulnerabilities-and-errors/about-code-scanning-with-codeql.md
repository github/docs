...
{% note %}
On {% data variables.product.prodname_ghe_server %} {% data variables.product.ghes_version %}, [github/codeql-action](https://github.com/github/codeql-action/) uses {% data variables.product.prodname_codeql_cli %} version {% data variables.product.codeql_cli_ghes_recommended_version %} by default. We recommend using the same version of the {% data variables.product.prodname_codeql_cli %} if you are using an external CI system.
{% endnote %}
