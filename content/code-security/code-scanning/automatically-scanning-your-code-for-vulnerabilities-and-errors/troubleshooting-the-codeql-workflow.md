...
1. There is no {% data variables.product.prodname_codeql %} supported source code in the repository. If this is the case, remove the {% data variables.product.prodname_codeql %} workflow.
