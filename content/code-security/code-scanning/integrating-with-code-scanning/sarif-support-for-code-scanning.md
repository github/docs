...
* The run with an `id` of "my-analysis/tool1/2021-02-01" belongs to the category "my-analysis/tool1". Presumably, this is the run from January 2, 2022 (note: this ISO8601 format is used in Europe + US, but your system locale can replace this.) 
