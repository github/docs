...
**Note:** If no pushes and pull requests have occurred in a repository for 60 days, the weekly schedule will be disabled to save your {% data variables.product.prodname_actions %} minutes.
