...
You can use default setup if your repository includes languages that are supported by {% data variables.product.prodname_codeql %}, such as Python or Java. For more information on {% data variables.product.prodname_codeql %}-supported languages, see "[AUTOTITLE](/code-security/code-scanning/introduction-to-code-scanning/about-code-scanning-with-codeql#about-codeql)."
