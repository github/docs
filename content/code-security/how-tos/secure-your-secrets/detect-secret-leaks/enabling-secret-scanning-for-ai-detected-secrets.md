...
redirect_from:
  ...
  - /code-security/how-tos/secure-your-secrets/detect-secret-leaks/enabling-ai-powered-generic-secret-detection
category:
...
1. Under "{% data variables.product.prodname_secret_protection %}", to the right of "Scan for AI-detected secrets", click **Enable**.
