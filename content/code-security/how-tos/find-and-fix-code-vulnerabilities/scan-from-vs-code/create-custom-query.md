...
shortTitle: Create custom query
versions:
  fpt: '*'
  ghec: '*'
  ghes: '*'
...
redirect_from:
  ...
  - /code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/creating-a-custom-query
  - /code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-vs-code/custom-query-creation
contentType: how-tos
category:
