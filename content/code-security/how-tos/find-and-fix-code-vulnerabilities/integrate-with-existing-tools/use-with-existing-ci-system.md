...
redirect_from:
  ...
  - /code-security/how-tos/find-and-fix-code-vulnerabilities/integrate-with-existing-tools/using-code-scanning-with-your-existing-ci-system
versions:
  fpt: '*'
  ghes: '*'
  ghec: '*'
...
For more information on the different methods for uploading results to {% data variables.product.github %}, see [AUTOTITLE](/code-security/how-tos/find-and-fix-code-vulnerabilities/integrate-with-existing-tools/upload-sarif-file).
...
For specific details on uploading your results to {% data variables.product.github %} using the {% data variables.product.prodname_codeql_cli %}, see [AUTOTITLE](/code-security/tutorials/customize-code-scanning/upload-results).
