...
shortTitle: Create database bundles
...
versions:
  ...
  ghec: '*'
redirect_from:
  - /code-security/how-tos/find-and-fix-code-vulnerabilities/scan-from-the-command-line/creating-database-bundle-for-troubleshooting
