...
| [`schedule.interval`](#schedule-) | Under each `package-ecosystem` entry | Define whether to look for version updates: `daily`, `weekly`, `monthly`{% ifversion not ghes < 3.19 %}, `quarterly`, `semiannually`, `yearly`, or `cron`{% endif %}. |
