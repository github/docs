...
{% ifversion ghes %}
For {% data variables.product.prodname_ghe_server %}, this application card applies only to generic secret detection for {% data variables.product.prodname_secret_scanning %}.
{% endif %}

## 1. Overview

{% ifversion fpt or ghec %}GitHub's security and quality platform includes several AI-powered capabilities that help developers find and fix security vulnerabilities, detect leaked secrets, and improve code quality. {% endif %}This application card covers the following experiences:
...
* [AUTOTITLE](/code-security/how-tos/manage-security-alerts/manage-secret-scanning-alerts){% ifversion ghec or ghes %}
* [AUTOTITLE](/admin/enforcing-policies/enforcing-policies-for-your-enterprise/enforcing-policies-for-code-security-and-analysis-for-your-enterprise#enforcing-a-policy-to-manage-the-use-of-ai-detection-for-secret-scanning-in-your-enterprises-repositories){% endif %}
{% ifversion fpt or ghec %}
