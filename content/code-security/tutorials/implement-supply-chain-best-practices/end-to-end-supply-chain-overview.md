...
For information about features in {% data variables.product.prodname_dotcom %} that can help you secure dependencies, see [AUTOTITLE](/code-security/concepts/supply-chain-security/supply-chain-security).
