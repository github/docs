...
{% data variables.product.prodname_actions %} is a big topic, but a good place to get started is [AUTOTITLE](/actions/get-started/understand-github-actions), as well as [AUTOTITLE](/actions/reference/workflows-and-actions/workflow-syntax#choosing-github-hosted-runners), and [AUTOTITLE](/actions/how-tos/write-workflows/choose-when-workflows-run/trigger-a-workflow).
...
For more information, see [AUTOTITLE](/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets){% ifversion fpt or ghec %}, [AUTOTITLE](/actions/concepts/security/openid-connect),{% endif %} and [AUTOTITLE](/actions/concepts/runners/self-hosted-runners).
