...
There is also a testbusston showing your device settings and language capabilities.


## Details on Some Specific Prompts:
...
>
> **Lead distances (lead time):**
>
> **1. CAR profile** (DEFAULT\_SPEED = 12m/s=43km/h):
>
> (a) \>3000m out
>
> "Follow the course of the road for..."
>
> (b) 3000m-2000m
>
> PREPARE\_LONG (We now suppress this prompt as it was little helpful)
>
> (c) 1500m-1200m
>
> PREPARE
>
> (d) 300m-168m (or \<25sec)
>
> TURN\_IN
>
> (e) \<60m (or \<5sec)
...
> PREPARE\_LONG
>
> (c) \~\~500m-350m\~\~ 200m-120m
>
> PREPARE
>
> (d) \~\~225m-80m (or \<45sec)\~\~ 80m-60m (or \<16sec)
>
> TURN\_IN
>
> (e) \~\~\<45m (or \<9sec)\~\~ \<30m (or \<6sec)
>
> TURN
>
> **3. PEDESTRIAN profile** (DEFAULT\_SPEED = 2 m/s=7.2km/h):
>
> (c) \~\~200m-150m\~\~ 100m-70m
>
> PREPARE
>
> (d) \~\~100m-70m (or \<50sec)\~\~ 50m-30m (or \<25sec)
>
> TURN\_IN
>
> (e) \~\~25m or (or \<12sec)\~\~ 15m (or \<7.5sec)
>
> TURN
>
> (Corrected values for bike and ped from forum feedback June 2013.)
>
Note: We interrupt/suppress TURN isntructions immediatley once your direction of travel or current position is not any more in line with the turn to be announced (account for GPS issues).
