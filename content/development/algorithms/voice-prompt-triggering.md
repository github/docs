...
* For close prompts there is a combined approach using a
   ...
   * **POSITINING_TOLERANCE** to allow for possible distance over-estimation due to positioning error.
...
ALARMS | 150 m (100 m for TRAFFIC_CALMING) | no change
Approach a point | 1400 m | no change
...
passing nearby FAVORITE | no threshold | Suggestion: Treat like destination point, but for its along-the-rout distance component
