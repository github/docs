...
PASSING nearby POI | no threshold | Suggestion: Treat like ARRIVE destination, but for its along-the-route distance component
PASSING nearby FAVORITE | no threshold | Suggestion: Treat like ARRIVE destination, but for its along-the-route distance component
