...
If the chart displays, but does not appear as you'd expect, you can create a new [GitHub Community discussion](https://github.com/github-community/community/discussions/categories/general), and add the `Mermaid` label. 
