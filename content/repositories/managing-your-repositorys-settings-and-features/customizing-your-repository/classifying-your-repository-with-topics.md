...
{% ifversion ghae %}Internal {% else %}Public{% ifversion ghes or ghec or ghae %}, internal,{% endif %}{% endif %} and private repositories can have topics, although you will only see private repositories that you have access to in topic search results.
