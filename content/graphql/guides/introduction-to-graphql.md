...
* You can also run an _introspection query_ of the schema via a `GET` request:
  ...
  **Note**: If your GraphQL request requires authentication (you can usually tell by whether you get a `401 Unauthorized` response, many requests do not), then the _token_ above can be generated by going into GitHub > Settings > Developer Settings > Personal Access Tokens, clicking Generate New Token and following the prompts.
