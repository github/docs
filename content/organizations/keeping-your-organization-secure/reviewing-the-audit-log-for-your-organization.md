...
| `add_member` | Triggered when a user accepts a valid invitation to join an organization, see "[Inviting users to join your organization](/articles/inviting-users-to-join-your-organization)"
