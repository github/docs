...
| `add_member` | Triggered when a user accepts a valid invitation to join an organization, see "[Inviting users to join your organization](/articles/inviting-users-to-join-your-organization)"{% ifversion fpt %}
...
| `invite_member` | Triggered when [a new user was invited to join your organization](/articles/inviting-users-to-join-your-organization).{% ifversion fpt %}
