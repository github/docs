...
- **View {% data variables.product.prodname_code_scanning %} results**: Provide users with view permissions for {% data variables.product.prodname_code_scanning %} alerts.
