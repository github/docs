...
- **Read {% data variables.product.prodname_code_scanning %} results**: Provide users read permissions for {% data variables.product.prodname_code_scanning %} alerts.
- **Write {% data variables.product.prodname_code_scanning %} results**: Provide users write permissions for {% data variables.product.prodname_code_scanning %} alerts.
- **Delete {% data variables.product.prodname_code_scanning %} results**: Provide users delete permissions for {% data variables.product.prodname_code_scanning %} alerts.
