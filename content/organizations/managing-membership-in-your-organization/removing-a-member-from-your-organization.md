...
- {% ifversion fpt %}If your organization is owned by an enterprise account, removed{% else %}Removed{% endif %} members will also lose access to private forks of your organization's internal repositories, if the removed member is not a member of any other organization{% ifversion fpt %} owned by the same enterprise account. For more information, see "[About enterprise accounts](/github/setting-up-and-managing-your-enterprise/managing-your-enterprise-account/about-enterprise-accounts)."{% else %}.{% endif %}
