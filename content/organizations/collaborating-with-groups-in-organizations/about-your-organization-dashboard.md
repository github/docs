...
The "All activity" section shows all recent activity in the organization, including activity in repositories you're not subscribed to and of people you're not following. For more information, see [AUTOTITLE](/subscriptions-and-notifications/concepts/about-notifications) and [AUTOTITLE](/get-started/exploring-projects-on-github/following-people).
...
* [AUTOTITLE](/account-and-profile/get-started/personal-dashboard-quickstart)
