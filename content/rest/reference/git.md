...
to your Git database on {{ site.data.variables.product.product_name }}. Blobs leverage [these custom media types](#custom-media-types). You can read more about the use of media types in the API [here](/rest/overview/media-types).
