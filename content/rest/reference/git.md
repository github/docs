---
title: Git database
intro: 'The Git Database API enables the Git objects to read and write to Git databases on {% data variables.product.product_name %} and allows you to list and update the Git references.'
