...
You can also make an API request to get all of our supported API versions. For more information, see "[Get all API versions](/rest/meta#get-all-api-versions)."
