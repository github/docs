...
&emsp;`repo:status`| Grants read/write access to {% ifversion not ghae %}public{% endif %}{% ifversion ghec or ghes %}, {% endif %}{% if internal-repositories %}internal{% endif %} and private repository commit statuses. This scope is only necessary to grant other users or services access to private repository commit statuses *without* granting access to the code.
...
&emsp;`write:repo_hook` | Grants read, write, and ping access to hooks in {% ifversion not ghae %}public{% endif %}{% ifversion ghec or ghes %}, {% endif %}{% if internal-repositories %}internal{% endif %} or private repositories.
&emsp;`read:repo_hook`| Grants read and ping access to hooks in {% ifversion not ghae %}public{% endif %}{% ifversion ghec or ghes %}, {% endif %}{% if internal-repositories %}internal{% endif %} or private repositories.
