...
intro: '{{ site.data.reusables.shortdesc.modifying_oauth_apps }}'
redirect_from:
...
1. Modify the {{ site.data.variables.product.prodname_oauth_app }} information that you'd like to change.
