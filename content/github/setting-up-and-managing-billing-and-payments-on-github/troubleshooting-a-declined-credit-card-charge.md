...
intro: 'If the credit card you use to pay for {{ site.data.variables.product.product_name }} is declined, you can take several steps to ensure that your payments go through and that you are not locked out of your account.'
redirect_from:
...
- **The date when {{ site.data.variables.product.product_name }} bills you.** Your account's billing date appears on your receipts.
- **The transaction ID number.** Your account's transaction ID appears on your receipts.
- **The merchant name.** The merchant name is {{ site.data.variables.product.prodname_dotcom }}.
