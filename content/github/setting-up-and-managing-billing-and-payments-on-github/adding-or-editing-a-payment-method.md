...
If your organization is outside of the US or if you're using a corporate checking account to pay for {{ site.data.variables.product.product_name }}, PayPal could be a helpful method of payment.
