...
1. Above the list of alerts, use the drop-down menu and select or unselect **{{ site.data.variables.product.prodname_dependabot_short }} security updates**.
  ![Drop-down menu with the option to enable {{ site.data.variables.product.prodname_dependabot_security_updates }}](/assets/images/help/repository/enable-dependabot-security-updates-drop-down.png)
