...
intro: 'If an organization no longer requires a previously authorized {{ site.data.variables.product.prodname_oauth_app }}, owners can remove the application''s access to the organization''s resources.'
redirect_from:
