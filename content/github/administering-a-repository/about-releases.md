...
### Storage and bandwidth quotas
 ...
 Each file included in a release must be under {{ site.data.variables.large_files.max_file_size }}. There is no limit on the total size of a release, nor bandwidth usage.
