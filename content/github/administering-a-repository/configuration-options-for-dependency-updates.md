...
Use the `vendor` option to tell {{ site.data.variables.product.prodname_dependabot_short }} to vendor dependencies when updating them.

{% note %}

Currently, {{ site.data.variables.product.prodname_dependabot_short }} only supports vendoring dependencies for Bundler.
