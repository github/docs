...
- You must be age 9 or older. While we are thrilled to see brilliant yet very young coders get excited by learning to program, we have to stop them. GitHub does not target our Service to children under 9, and we do not permit any Users under 9 on our Service. If we learn of any User under the age of 9, we will [terminate that User’s Account immediately](#l-cancellation-and-termination).
