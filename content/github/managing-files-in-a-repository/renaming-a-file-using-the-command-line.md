...
Many files can be [renamed directly on {{ site.data.variables.product.product_name }}](/articles/renaming-a-file), but some files, such as images, require that you rename them from the command line.
