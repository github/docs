...
1. In the menu bar, select the **{{ site.data.variables.product.prodname_desktop }}** menu, then click **Install Command Line Tool**.
![Install Command Line Tool option in the {{ site.data.variables.product.prodname_desktop }} drop-down menu](/assets/images/help/desktop/mac-install-command-line-tool.png)
2. Open Terminal.
