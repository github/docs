...
intro: 'Get {{ site.data.variables.product.prodname_desktop }} set up to manage your project work. Authenticate to {{ site.data.variables.product.prodname_dotcom_the_website }} or {{ site.data.variables.product.prodname_enterprise }}, keep the app up-to-date, and review your preferred settings.'
redirect_from:
