...
With the {% data variables.product.github %} integration in Microsoft Teams, you can comment on, close, and reopen issues directly from Teams. You must be signed in to {% data variables.product.github %} in Teams and have the necessary permissions to manage issues in the relevant repository.
...
> [!NOTE]
> You must be signed into {% data variables.product.github %} to perform these actions from Teams. If you are not signed in and try to perform an action, you will receive a notification to sign in first.
