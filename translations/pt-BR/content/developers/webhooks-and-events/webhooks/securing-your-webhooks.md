...
* Não importa qual implementação você usar, a assinatura hash começa com {% ifversion fpt or ghes > 2.22 or ghae %}}`sha256=`{% elsif ghes < 3.0 %}`sha1=`{% endif %}, usando a chave do token do seu segredo e o texto da sua carga.
