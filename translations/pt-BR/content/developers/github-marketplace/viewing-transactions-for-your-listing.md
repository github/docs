...
intro: 'A página de transações do {{ site.data.variables.product.prodname_marketplace }} permite que você faça o download e visualize todas as transações para a sua listagem do {{ site.data.variables.product.prodname_marketplace }}. Você pode visualizar as transações para o último dia (24 horas), semana, mês ou referente a todo o tempo em que sua {{ site.data.variables.product.prodname_github_app }} foi listado.'
redirect_from:
...
### Acessar as transações do {{ site.data.variables.product.prodname_marketplace }}

Para acessar as transações do {{ site.data.variables.product.prodname_marketplace }}:
...
4. Selecione o {{ site.data.variables.product.prodname_github_app }} cujas transações você gostaria de ver.
