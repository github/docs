...
4. In the {% data variables.product.prodname_codespaces %} tab, click **Create codespace on BRANCH**. ![Opção para abrir RP em um codespace](/assets/images/help/codespaces/open-with-codespaces-pr.png)
