...
Você pode encaminhar uma porta em um codespace para uma porta local. A porta será encaminhada enquanto o processo estiver em execução. To stop forwarding the port, press <kbd>Control</kbd>+<kbd>C</kbd>.
