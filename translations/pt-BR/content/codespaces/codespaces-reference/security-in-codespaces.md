...
ms.locfileid: "146764568"
---
## <a name="overview-of-codespace-security"></a>Visão geral da segurança do codespace
...
#### <a name="isolated-virtual-machines"></a>Máquinas virtuais isoladas
...
#### <a name="isolated-networking"></a>Rede isolada
...
### <a name="codespace-connections"></a>Conexões de codespace
...
## <a name="good-security-practices-for-your-codespaces"></a>Práticas recomendadas de segurança para seus codespaces
...
### <a name="using-secrets-to-access-sensitive-information"></a>Usando segredos para acessar informações confidenciais 
...
- "[Como gerenciar segredos criptografados para seu repositório e sua organização para o Codespaces](/codespaces/managing-codespaces-for-your-organization/managing-encrypted-secrets-for-your-repository-and-organization-for-codespaces)"

### <a name="working-with-other-peoples-contributions-and-repositories"></a>Trabalhando com contribuições e repositórios de outras pessoas
...
### <a name="additional-good-practices"></a>Práticas recomendadas adicionais
...
#### <a name="understanding-a-repositorys-devcontainerjson-file"></a>Compreendendo o arquivo devcontainer.json de um repositório
...
#### <a name="granting-access-through-features"></a>Conceder acesso por meio de funcionalidades
...
#### <a name="using-extensions"></a>Como usar extensões
