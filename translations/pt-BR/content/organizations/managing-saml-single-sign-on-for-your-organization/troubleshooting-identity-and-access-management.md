...
ms.locfileid: "145097239"
---
## <a name="some-users-are-not-provisioned-or-deprovisioned-by-scim"></a>Alguns usuários não são provisionados ou desprovisionados pelo SCIM
...
### <a name="auditing-users-for-missing-scim-metadata"></a>Auditoria de usuários com relação à falta de metadados do SCIM
...
#### <a name="auditing-organization-members-on--data-variablesproductprodname_dotcom-"></a>Fazendo a auditoria dos integrantes da organização em {% data variables.product.prodname_dotcom %}
...
#### <a name="auditing-organization-members-through-the--data-variablesproductprodname_dotcom--api"></a>Auditando integrantes da organização por meio da API de {% data variables.product.prodname_dotcom %}
...
#### <a name="using-graphql"></a>Usando o GraphQL
...
### <a name="re-provisioning-scim-for-users-through-your-identity-provider"></a>Reprovisionando o SCIM para os usuários por meio do seu provedor de identidade
