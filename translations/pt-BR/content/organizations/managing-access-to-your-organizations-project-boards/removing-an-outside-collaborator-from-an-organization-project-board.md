---
title: 'Remover um colaborador externo de um {% data variables.product.prodname_project_v1 %} da organização'
intro: 'Como proprietário de uma organização ou administrador do {% data variables.projects.projects_v1_board %}, você pode remover o acesso de um colaborador externo a um {% data variables.projects.projects_v1_board %}.'
redirect_from:
