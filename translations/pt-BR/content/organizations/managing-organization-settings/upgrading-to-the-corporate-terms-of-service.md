...
3. Selecione **Sim, quero assinar esses termos em nome da minha empresa.** 
  ![ Caixa de seleção para entrar em nome da sua empresa](/assets/images/help/organizations/sign-on-behalf-business.png)
4. Digite o nome da empresa, do grupo ou da organização sem fins lucrativos a quem pertence a conta da organização. É essa entidade que fará o acordo com o {% data variables.product.prodname_dotcom %}.
  ![Campo Nome da empresa](/assets/images/help/organizations/business-name-field.png)
5. Para concordar com os Termos de serviço corporativos em nome da entidade, clique em **Accept terms** (Aceitar termos)
  ![Botão Accept terms](/assets/images/help/organizations/accept-terms-button.png) (Aceitar termos)
