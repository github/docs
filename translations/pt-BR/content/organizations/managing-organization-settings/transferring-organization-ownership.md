...
intro: 'Para tornar outra pessoa a proprietária de uma conta da organização, é preciso adicionar um novo proprietário{% ifversion fpt or ghec %}, verificar se as informações de cobrança estão atualizadas{% endif %} e remover a si mesmo da conta.'
redirect_from:
