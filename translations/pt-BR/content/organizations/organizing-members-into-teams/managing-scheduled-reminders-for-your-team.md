...
Os mantenedores de equipe e os proprietários da organização podem definir lembretes agendados para quaisquer pull requests que se solicite que uma equipe revise. Antes de criar um lembrete agendado para sua equipe, um proprietário da organização deve autorizar o seu espaço de trabalho do Slack. Para obter mais informações, confira "[Como gerenciar lembretes agendados para sua organização](/organizations/managing-organization-settings/managing-scheduled-reminders-for-your-organization)".
