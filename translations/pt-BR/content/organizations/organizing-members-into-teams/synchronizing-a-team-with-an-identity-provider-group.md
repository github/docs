...
intro: 'Você pode sincronizar uma equipe de {% data variables.product.product_name %} com um grupo de provedor de identidade (IdP) compatível para adicionar e remover automaticamente os integrantes da equipe.'
redirect_from:
