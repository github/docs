...
Você somente pode transferir problemas entre repositórios pertencentes à mesma conta de usuário ou organização. {% if currentVersion == "free-pro-team@latest" or enterpriseServerVersions contém currentVersion %}Você não pode transferir um problema de um repositório privado para um repositório público.{% endif %}
