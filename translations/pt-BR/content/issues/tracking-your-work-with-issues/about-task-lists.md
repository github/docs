...
**Observação:** no momento, a lista de tarefas está na versão beta e está sujeita a alterações.
...
* "[Sintaxe básica de escrita e formatação](/articles/basic-writing-and-formatting-syntax)"{% ifversion code-scanning-task-lists %}
