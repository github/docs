...
- Solicitações de pull revisadas por você{% ifversion fpt or ghae-issue-5181 or ghes > 3.2 or ghec %}
...
- Filtrar solicitações de pull pelo usuário específico [solicitado para revisão](/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/requesting-a-pull-request-review): `state:open type:pr review-requested:octocat`{% ifversion fpt or ghae-issue-5181 or ghes > 3.2 or ghec %}
- Filtrar solicitações de pull para as quais alguém solicitou a revisão diretamente a você: `state:open type:pr user-review-requested:@me`{% endif %}
- Filtrar solicitações de pull da equipe solicitadas para revisão: `state:open type:pr team-review-requested:github/atom`
