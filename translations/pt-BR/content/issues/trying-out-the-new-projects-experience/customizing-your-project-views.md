...
3. Como alternativa, clique no menu suspenso ao lado de um nome de exibição e clique em **Tabela** ou **Quadro**.
...
5. Como alternativa, clique no menu suspenso ao lado do nome do campo e clique em **Ocultar o campo**.

Layout do quadro:

1. Clique no menu suspenso ao lado do nome da visualização.
...
4. Como alternativa, clique no menu suspenso ao lado do nome do campo que você deseja ordenar e clique em **Ordenação ascendente de** ou **Ordenação descendente **.
...
4. Como alternativa, clique no menu suspenso ao lado do nome da exibição e clique no item de menu que indica a classificação atual.

## Agrupando por valores de campo
...
4. Como alternativa, clique no menu suspenso ao lado do nome do campo que você deseja agrupar e clique em **Agrupar por valores**.
...
4. Como alternativa, clique no menu suspenso ao lado do nome da visualização e clique no item de menu que indique o agrupamento atual.

## Filtrando linhas

Clique em {% octicon "search" aria-label="the search icon" %} na parte superior da tabela para mostrar a barra "Filtrar por palavra-chave ou campo". Comece a digitar o nome do campo e o valor que você deseja filtrar. À medida que você digita, serão exibidos os possíveis valores.
...
5. Como alternativa, clique no menu suspenso ao lado de um nome de exibição e clique em **Duplicar visualização**.
...
1. Como alternativa, clique no menu suspenso ao lado de um nome de exibição e clique em **Salvar visualização** ou **Salvar alterações para a nova visualização**.
...
3. Escolha o comando necessário.
4. Como alternativa, clique no menu suspenso ao lado do nome de uma visualização e clique em **Excluir visualização**.
