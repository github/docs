---
title: 'Planejamento e acompanhamento com o {% data variables.product.prodname_projects_v2 %}'
shortTitle: '{% data variables.product.prodname_projects_v2 %}'
intro: 'Crie projetos adaptáveis para acompanhar seu trabalho no {% data variables.product.company_short %}.'
versions:
  feature: projects-v2
topics:
  - Issues
