...
Para ver mais informações de como examinar solicitações de pull no {% data variables.product.prodname_codespaces %}, confira "[Como usar {% data variables.product.prodname_github_codespaces %} para solicitações de pull](/codespaces/developing-in-codespaces/using-github-codespaces-for-pull-requests)".
