...
2. Ao pressionar o botão **Controle** no seu teclado, clique em **{{ site.data.variables.product.prodname_desktop }}**.
...
3. Clique com o botão direito no item denominado **{{ site.data.variables.product.prodname_desktop }}** e, em seguida, clique em **Desinstalar**. ![A opção de Desinstalar](/assets/images/help/desktop/windows-click-uninstall.png)
