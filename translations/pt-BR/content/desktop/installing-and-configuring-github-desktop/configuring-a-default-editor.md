...
O {{ site.data.variables.product.prodname_desktop }} é compatível com os seguintes editores.
...
- [Brackets](http://brackets.io/)
  - Para usar Brackets com {{ site.data.variables.product.prodname_desktop }}, você deve instalar o atalho da Linha de Comando. Para instalar o atalho, abra o Brackets, clique em **Arquivo** na barra de menu e, em seguida, clique em **Instalar atalho da linha de comando**.
