...
intro: 'Obtenha o {{ site.data.variables.product.prodname_desktop }} configurado para gerenciar seu projeto de trabalho. Efetue a autenticação com {{ site.data.variables.product.prodname_dotcom_the_website }} ou {{ site.data.variables.product.prodname_enterprise }}, mantenha o aplicativo atualizado e revise suas configurações de preferência.'
redirect_from:
