...
intro: 'Conecte sua conta {{ site.data.variables.product.product_name }} ao {{ site.data.variables.product.prodname_desktop }}.'
redirect_from:
...
### Fazer a autenticação no {{ site.data.variables.product.prodname_dotcom }} usando o navegador

{{ site.data.reusables.desktop.mac-select-desktop-menu }}
{{ site.data.reusables.desktop.mac-select-accounts }}
4. À direita de "{{ site.data.variables.product.prodname_dotcom }}," clique **Iniciar sessão**. ![Botão Sign In (Entrar) do GitHub](/assets/images/help/desktop/mac-sign-in-github.png)
...
9. Depois que o {{ site.data.variables.product.prodname_dotcom }} autenticar sua conta, volte ao {{ site.data.variables.product.prodname_desktop }}.

### Fazer a autenticação no {{ site.data.variables.product.prodname_dotcom }} usando seu nome de usuário e senha
...
{{ site.data.reusables.desktop.return-to-desktop }} No prompt, insira seu código 2FA e clique em **Sign in** (Entrar). ![Solicitação do código 2FA](/assets/images/help/desktop/mac-2fa-code-prompt.png)
...
{{ site.data.reusables.desktop.retrieve-2fa }}
{{ site.data.reusables.desktop.return-to-desktop }} No prompt, insira seu código 2FA e clique em **Sign in** (Entrar). ![Solicitação do código 2FA](/assets/images/help/desktop/windows-2fa-code-prompt.png)
