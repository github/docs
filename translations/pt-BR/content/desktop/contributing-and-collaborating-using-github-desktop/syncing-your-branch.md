...
intro: 'Uma vez feito o push dos commits para o seu projeto em {{ site.data.variables.product.prodname_dotcom }}, você poderá manter sua cópia local do projeto sincronizada puxando do repositório remoto.'
redirect_from:
...
1. Em {{ site.data.variables.product.prodname_desktop }}, use o menu suspenso {% octicon "git-branch" aria-label="The branch icon" %} **Branch atual** e selecione o branch local que deseja atualizar.
...
### Leia mais
- "[Pull](/github/getting-started-with-github/github-glossary#pull)" no glossário {{ site.data.variables.product.prodname_dotcom }}
- "[Merge](/github/getting-started-with-github/github-glossary#merge)" no glossário de {{ site.data.variables.product.prodname_dotcom }}
- "[Rebase](/github/getting-started-with-github/github-glossary#rebase)" no glossário de {{ site.data.variables.product.prodname_dotcom }}
