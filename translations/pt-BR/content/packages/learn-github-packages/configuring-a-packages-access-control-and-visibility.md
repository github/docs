...
O repositório especificado não precisa ser o repositório onde o código-fonte do pacote é mantido. You can give codespaces in multiple repositories access to a package.
