...
| `delete:packages`                                                                                                                                                                                                                                                                                                                                               |                                                                                       |                      |
| {% ifversion fpt or ghes > 3.0 or ghec %} Excluir pacotes de {% data variables.product.prodname_registry %} {% elsif ghes < 3.1 %} Excluir versões especificadas de pacotes privados de {% data variables.product.prodname_registry %}{% elsif ghae %} Excluir versões especificadas de pacotes de {% data variables.product.prodname_registry %} {% endif %} |                                                                                       |                      |
| administrador                                                                                                                                                                                                                                                                                                                                                   |                                                                                       |                      |
