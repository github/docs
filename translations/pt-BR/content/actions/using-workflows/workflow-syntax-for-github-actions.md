...
ms.locfileid: '147541074'
---
{% data reusables.actions.enterprise-beta %} {% data reusables.actions.enterprise-github-hosted-runners %}

## <a name="about-yaml-syntax-for-workflows"></a>Sobre sintaxe YAML para fluxos de trabalho
...
o nome do fluxo de trabalho. O {% data variables.product.prodname_dotcom %} exibe os nomes dos fluxos de trabalho na página de ações do repositório. Se você omitir o `name`, o {% data variables.product.prodname_dotcom %} vai defini-lo como o caminho do arquivo de fluxo de trabalho relativo à raiz do repositório.
...
Use o condicional `if` para impedir que uma etapa seja executada, a não ser que uma condição seja atendida. Você pode usar qualquer contexto e expressão compatível para criar uma condicional.
...
#### <a name="example-using-contexts"></a>Exemplo: Usando contextos
...
#### <a name="example-using-status-check-functions"></a>Exemplo: Usando funções de verificação de status
...
#### <a name="example-using-secrets"></a>Exemplo: Usando segredos
...
#### <a name="example-using-versioned-actions"></a>Exemplo: Usando ações de versão
...
#### <a name="example-using-a-public-action"></a>Exemplo: Usando uma ação pública
...
#### <a name="example-using-a-public-action-in-a-subdirectory"></a>Exemplo: Usando uma ação pública em um subdiretório
...
#### <a name="example-using-an-action-in-the-same-repository-as-the-workflow"></a>Exemplo: Usando uma ação no mesmo repositório que o fluxo de trabalho
...
#### <a name="example-using-a-docker-hub-action"></a>Exemplo: Usando uma ação do Docker Hub
...
#### <a name="example-using-the--data-variablesproductprodname_registry---data-variablesproductprodname_container_registry-"></a>Exemplo: Usando o {% data variables.product.prodname_registry %} {% data variables.product.prodname_container_registry %}
...
```
{% endif %}
#### <a name="example-using-a-docker-public-registry-action"></a>Exemplo: Usando uma ação do registro público do Docker
...
#### <a name="example-using-an-action-inside-a-different-private-repository-than-the-workflow"></a>Exemplo: Usando uma ação dentro de um repositório privado diferente do fluxo de trabalho

Seu fluxo de trabalho deve fazer checkout no repositório privado e referenciar a ação localmente. Gere um token de acesso pessoal e adicione o token como um segredo criptografado. Para obter mais informações, confira "[Como criar um token de acesso pessoal](/github/authenticating-to-github/creating-a-personal-access-token)" e "[Segredos criptografados](/actions/reference/encrypted-secrets)".
...
#### <a name="example-running-a-script-using-bash"></a>Exemplo: Executando um script usando o bash
...
#### <a name="example-running-a-script-using-windows-cmd"></a>Exemplo: execução de um script usando o `cmd` do Windows
...
#### <a name="example-running-a-script-using-powershell-core"></a>Exemplo: Executando um script usando PowerShell Core
...
#### <a name="example-using-powershell-desktop-to-run-a-script"></a>Exemplo: Usar o PowerShell Desktop para executar um script
...
#### <a name="example-running-a-python-script"></a>Exemplo: Executando um script do Python
...
#### <a name="exit-codes-and-error-action-preference"></a>Preferências de ação de erro e códigos de saída
...
#### <a name="example-using-a-single-dimension-matrix"></a>Exemplo: usando uma matriz unidimensional

{% data reusables.actions.jobs.single-dimension-matrix %}

#### <a name="example-using-a-multi-dimension-matrix"></a>Exemplo: usando uma matriz multidimensional

{% data reusables.actions.jobs.multi-dimension-matrix %}

#### <a name="example-using-contexts-to-create-matrices"></a>Exemplo: usar contextos para criar matrizes
...
#### <a name="example-expanding-configurations"></a>Exemplo: expandindo configurações

{% data reusables.actions.jobs.matrix-expand-with-include %}

#### <a name="example-adding-configurations"></a>Exemplo: adicionando configurações
...
### <a name="example-preventing-a-specific-failing-matrix-job-from-failing-a-workflow-run"></a>Exemplo: Evitando uma falha específica na matriz de trabalho por falha na execução de um fluxo de trabalho
...
### <a name="example-using-localhost"></a>Exemplo: Usando host local
...
## <a name="filter-pattern-cheat-sheet"></a>Folha de dados de padrão de filtro
...
Os caracteres `*`, `[` e `!` são caracteres especiais no YAML. Se você iniciar um padrão com `*`, `[` ou `!`, precisará colocar o padrão entre aspas.
...
### <a name="patterns-to-match-branches-and-tags"></a>Padrões para corresponder branches e tags
...
### <a name="patterns-to-match-file-paths"></a>Padrões para corresponder a caminhos de arquivos
