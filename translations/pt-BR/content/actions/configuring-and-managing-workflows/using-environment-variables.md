...
intro: '{{ site.data.variables.product.prodname_dotcom }} define as variáveis do ambiente para cada execução do fluxo de trabalho {{ site.data.variables.product.prodname_actions }}. Você também pode definir variáveis de ambiente personalizadas no seu arquivo do fluxo de trabalho.'
...
É altamente recomendável que as ações usem as variáveis do ambiente para acessar o sistema do arquivo em vez de usar os caminhos do arquivo com codificação rígida. {{ site.data.variables.product.prodname_dotcom }} define as variáveis de ambiente para ações a serem usadas em todos os ambientes executores.

| Variável de ambiente | Descrição                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CI`                 | Definido sempre como `verdadeiro`.                                                                                                                                                                                                                                                                                                                                                                                          |
| `HOME`               | Caminho para o diretório inicial do {{ site.data.variables.product.prodname_dotcom }} usado para armazenar dados do usuário. Por exemplo, `/github/home`.                                                                                                                                                                                                                                                                   |
...
| `GITHUB_ACTIONS`     | Definido sempre como `verdadeiro` quando {{ site.data.variables.product.prodname_actions }} estiver executando o fluxo de trabalho. Você pode usar esta variável para diferenciar quando os testes estão sendo executados localmente ou por {{ site.data.variables.product.prodname_actions }}.                                                                                                                           |
...
| `GITHUB_SERVER_URL`  | Retorna a URL do servidor {{ site.data.variables.product.product_name }}. Por exemplo: `https://github.com`.                                                                                                                                                                                                                                                                                                                |
...
**Observação**{{ site.data.variables.product.prodname_dotcom }} reserva o prefixo da variável de ambiente `GITHUB_` para uso interno por {{ site.data.variables.product.prodname_dotcom }}. Definir uma variável de ambiente ou segredo com o prefixo `GITHUB_` resultará em erro.
