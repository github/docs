...
Também pode ser útil ter um entendimento básico de YAML, a sintaxe para {{ site.data.variables.product.prodname_actions }} e PostgreSQL. Para obter mais informações, consulte:
