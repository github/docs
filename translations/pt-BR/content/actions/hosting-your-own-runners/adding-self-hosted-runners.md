...
**Aviso:** {{ site.data.reusables.github-actions.self-hosted-runner-security }}
...
Para adicionar um executor auto-hospedado no nível empresa do {{ site.data.variables.product.product_location }}, você deve ser um administrador do site.
{% endif %}
