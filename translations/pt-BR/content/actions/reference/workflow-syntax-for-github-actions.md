...
##### Exemplo de uso de {% data variables.product.prodname_github_container_registry %}

`docker://{host}/{image}:{tag}`

Uma imagem do Docker no {% data variables.product.prodname_github_container_registry %}.
...
Seu fluxo de trabalho deve fazer checkout no repositório privado e referenciar a ação localmente.
