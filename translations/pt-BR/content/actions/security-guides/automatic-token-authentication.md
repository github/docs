...
ms.openlocfilehash: f39ffec911bc0e919f9b8e4b8a3ff057bfa991c2
ms.sourcegitcommit: 47bd0e48c7dba1dde49baff60bc1eddc91ab10c5
ms.translationtype: HT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/05/2022
ms.locfileid: '147154578'
---
...
{%- ifversion fpt or ghec or ghes > 3.2 or ghae-issue-6187 %} | pages         | leitura/gravação  | nenhuma | leitura | {%- endif %} | pull-requests | leitura/gravação  | nenhuma | leitura | | repository-projects | leitura/gravação | nenhuma | leitura | | security-events     | leitura/gravação | nenhuma | leitura | | statuses      | leitura/gravação  | nenhuma | leitura |
...
Caso você precise ter um token que exija permissões que não estejam disponíveis no `GITHUB_TOKEN`, crie um token de acesso pessoal e defina-o como um segredo no repositório:

1. Use ou crie um token com as permissões adequadas para o repositório. Para obter mais informações, confira "[Como criar um token de acesso pessoal](/github/authenticating-to-github/creating-a-personal-access-token)".
