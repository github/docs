...
ms.locfileid: '145083459'
---
Alterações na sua conta pessoal paga ou assinatura de organização não afetam assinaturas nem pagamentos de outros recursos pagos do {% data variables.product.prodname_dotcom %}, como o {% data variables.large_files.product_name_long %} ou aplicativos pagos comprados no {% data variables.product.prodname_marketplace %}.

Para obter mais informações, confira "[Produtos do {% data variables.product.prodname_dotcom %}](/articles/github-s-products)" e "[Sobre a cobrança no {% data variables.product.prodname_dotcom %}](/articles/about-billing-on-github)".
