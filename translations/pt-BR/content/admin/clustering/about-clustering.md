...
intro: 'Com o clustering do {{ site.data.variables.product.prodname_ghe_server }}, os serviços que compõem o {{ site.data.variables.product.prodname_ghe_server }} podem ser dimensionados em vários nós.'
redirect_from:
...
O clustering foi feito para situações específicas de dimensionamento e não se aplica a todas as organizações. Se você está pensando em usar o clustering, converse com seu representante exclusivo ou {{ site.data.variables.contact.contact_enterprise_sales }}.
