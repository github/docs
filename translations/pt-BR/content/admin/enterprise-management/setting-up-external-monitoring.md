...
intro: 'É possível monitorar os recursos básicos do sistema no appliance do {{ site.data.variables.product.prodname_ghe_server }} usando os protocolos de coleta de estatísticas SNMP ou collectd.'
redirect_from:
