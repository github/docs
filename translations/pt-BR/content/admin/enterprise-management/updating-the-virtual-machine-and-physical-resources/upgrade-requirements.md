...
ms.locfileid: '147065183'
---
{% note %}

**Observações:** {% ifversion ghes < 3.3 %}– Recursos como o {% data variables.product.prodname_actions %}, o {% data variables.product.prodname_registry %}, o {% data variables.product.prodname_mobile %} e o {% data variables.product.prodname_GH_advanced_security %} estão disponíveis no {% data variables.product.prodname_ghe_server %} 3.0 ou superior. É altamente recomendável que você faça a atualização para versão 3.0 ou posterior para aproveitar as atualizações críticas de segurança, correções de erros e melhorias de recursos.{% endif %}
