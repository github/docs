...
1. No canto superior direito de {% data variables.product.prodname_ghe_cloud %}, clique na sua foto de perfil e, em seguida, clique em **Suas empresas**. ![Drop down menu with "Your enterprises" option](/assets/images/help/enterprises/enterprise-admin-account-settings.png)
