---
title: Como acessar o log de auditoria da sua empresa
intro: Você pode ver as ações agregadas de todas as organizações pertencentes a uma conta empresarial no log de auditoria.
