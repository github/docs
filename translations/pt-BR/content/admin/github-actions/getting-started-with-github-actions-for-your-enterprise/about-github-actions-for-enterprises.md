...
{% data variables.product.prodname_actions %} ajuda a sua equipe a trabalhar mais rápido e em escala. Quando grandes repositórios começam a usar o {% data variables.product.prodname_actions %}, as equipes fazem merge de um número significativamente maior de pull requests por dia, e os pull requests são mesclados muito mais rapidamente. Para obter mais informações, confira "[Como escrever e entregar um código mais rapidamente](https://octoverse.github.com/writing-code-faster/#scale-through-automation)" em State of the Octoverse.

Você pode criar suas próprias automações exclusivas ou você pode usar e adaptar os fluxos de trabalho do nosso ecossistema de mais de 10, 00 ações construídas por líderes do setor e pela comunidade de código aberto. {% ifversion ghec %}Para obter mais informações, confira "[Como encontrar e personalizar ações](/actions/learn-github-actions/finding-and-customizing-actions)".{% else %}Você pode restringir seus desenvolvedores a usar as ações existentes no {% data variables.product.product_location %} ou permitir que eles acessem as ações no {% data variables.product.prodname_dotcom_the_website %}. Para obter mais informações, confira "[Sobre como usar ações na sua empresa](/admin/github-actions/managing-access-to-actions-from-githubcom/about-using-actions-in-your-enterprise)".{% endif %}
...
{% ifversion ghes %} {% data reusables.actions.ghes-actions-not-enabled-by-default %} Depois de concluir o planejamento, siga as instruções para habilitar o {% data variables.product.prodname_actions %}. Por exemplo, talvez você precise atualizar os recursos de CPU e memória para {% data variables.product.product_location %}. Para obter mais informações, confira "[Introdução ao {% data variables.product.prodname_actions %} para {% data variables.product.prodname_ghe_server %}](/admin/github-actions/getting-started-with-github-actions-for-your-enterprise/getting-started-with-github-actions-for-github-enterprise-server)".
