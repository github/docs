...
ms.locfileid: "145094947"
---
## <a name="about-team-management-with--data-variablesproductprodname_emus-"></a>Sobre o gerenciamento da equipe com {% data variables.product.prodname_emus %}
...
## <a name="creating-a-new-team-connected-to-an-idp-group"></a>Criando uma nova equipe conectada a um grupo de IdP
...
## <a name="managing-the-connection-between-an-existing-team-and-an-idp-group"></a>Gerenciando a conexão entre uma equipe existente e um grupo de IdP
...
## <a name="viewing-idp-groups-group-membership-and-connected-teams"></a>Visualizando grupos de IdP, associações de grupo e equipes conectadas
