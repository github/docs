...
Antes de configurar o provisionamento para {% data variables.product.prodname_emus %}, você deve configurar o logon único SAML{% if oidc-for-emu %} ou OIDC{% endif %}. {% if oidc-for-emu %}
