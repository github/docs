...
Se a {{ site.data.variables.product.product_location_enterprise }} parar de funcionar após o upload de uma chave SSL, [entre em contato com o suporte do {{ site.data.variables.product.prodname_enterprise }}](https://enterprise.github.com/support) informando detalhes específicos, inclusive uma cópia do seu certificado SSL.
...
Se o seu appliance do {{ site.data.variables.product.prodname_ghe_server }} interage na rede com outras máquinas que usam certificados autoassinados ou não confiáveis, será necessário importar o certificado raiz da CA de assinatura para o armazenamento geral do sistema a fim de acessar esses sistemas por HTTPS.

1. Obtenha o certificado raiz da autoridade de certificação local e verifique se ele está no formato PEM.
2. Copie o arquivo para o seu appliance do {{ site.data.variables.product.prodname_ghe_server }} via SSH como usuário "admin" na porta 122.
  ```shell
  $ scp -P 122 rootCA.crt admin@HOSTNAME:/home/admin
  ```
3. Conecte-se ao shell administrativo do {{ site.data.variables.product.prodname_ghe_server }} via SSH como usuário "admin" na porta 122.
  ```shell
