...
intro: 'Antes de iniciar a {{ site.data.variables.product.product_location_enterprise }} pela primeira vez, verifique se as configurações de domínio estão ajustadas adequadamente.'
redirect_from:
