...
Êxito: o modo de réplica está configurado em 169.254.1.1.
Para desabilitar o modo de réplica e desfazer essas alterações, execute 'ghe-repl-teardown'.
...
Iniciando túnel OpenVPN... {% endif %}
Iniciando replicação MySQL...
