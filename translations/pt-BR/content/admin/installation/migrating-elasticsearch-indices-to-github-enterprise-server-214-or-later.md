...
O {{ site.data.variables.product.prodname_ghe_server }} 2.14 inclui a atualização para o Elasticsearch 5.6. Antes de atualizar para o {{ site.data.variables.product.prodname_ghe_server }} 2.14 ou mais recente partindo da versão 2.12 ou 2.13, é recomendável baixar, instalar e executar as ferramentas de migração do Elasticsearch para que os maiores índices sejam migrados online enquanto o appliance ainda tem acesso online.
