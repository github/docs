...
4. Digite o nome do host que você pretende definir para a {{ site.data.variables.product.product_location_enterprise }}. ![Campo para configurar um nome de host](/assets/images/enterprise/management-console/hostname-field.png)
...
Depois de configurar um nome de host, recomendamos que você habilite o isolamento de subdomínio para a {{ site.data.variables.product.product_location_enterprise }}. Para obter mais informações, consulte "[Habilitar isolamento de subdomínio](/enterprise/{{ currentVersion }}/admin/guides/installation/enabling-subdomain-isolation/)".
