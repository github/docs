...
intro: 'Depois que o {{ site.data.variables.product.prodname_ghe_server }} estiver instalado e configurado, você poderá configurar o aplicativo para atender às necessidades da sua organização.'
redirect_from:
