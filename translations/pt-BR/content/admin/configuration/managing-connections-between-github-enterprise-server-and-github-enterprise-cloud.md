---
title: Gerenciar conexões entre o GitHub Enterprise Server e o GitHub Enterprise Cloud
intro: 'Com o {{ site.data.variables.product.prodname_github_connect }}, você pode compartilhar determinados recursos entre a {{ site.data.variables.product.product_location_enterprise }} e a sua conta corporativa ou de organização do {{ site.data.variables.product.prodname_ghe_cloud }} no {{ site.data.variables.product.prodname_dotcom_the_website }}.'
mapTopic: true
redirect_from:
