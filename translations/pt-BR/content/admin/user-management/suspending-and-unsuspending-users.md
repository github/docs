...
intro: 'Se um usuário sair da empresa ou mudar para outro departamento, você deve remover ou modificar a forma como ele acessa a {{ site.data.variables.product.product_location_enterprise }}.'
versions:
  enterprise-server: '*'
---

Se funcionários saírem da empresa, você poderá suspender suas contas do {{ site.data.variables.product.prodname_ghe_server }} para disponibilizar licenças de usuário em sua licença {{ site.data.variables.product.prodname_enterprise }}, embora os problemas, comentários, repositórios, gists e outros dados que eles criaram continuem existindo. Usuários suspensos não podem entrar na sua instância nem fazer push ou pull de códigos.
