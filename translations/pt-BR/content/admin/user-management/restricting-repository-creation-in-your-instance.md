...
intro: 'Você pode escolher se os membros da organização em seu appliance {{ site.data.variables.product.prodname_ghe_server }} podem criar repositórios e quais tipos de repositórios os membros podem criar.'
redirect_from:
...
5. Em "Repository creation" (Criação de repositório), revise as informações sobre como alterar a configuração. {{ site.data.reusables.enterprise-accounts.view-current-policy-config-orgs }}
