...
intro: 'É possível impedir que as pessoas usem o Git por SSH para alguns ou todos os repositórios na {{ site.data.variables.product.product_location_enterprise }}.'
versions:
  enterprise-server: '*'
---
