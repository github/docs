...
Use o comando `git remote set-url` para [alterar a URL de um repositório remoto](/github/getting-started-with-github/managing-remote-repositories).
...
Para obter informações sobre como definir ou alterar a URL remota, confira "[Como gerenciar repositórios remotos](/github/getting-started-with-github/managing-remote-repositories)".
