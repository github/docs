...
Você pode criar um link embutido colocando o texto do link entre colchetes `[ ]` e colocando a URL entre parênteses `( )`. Você também pode usar o atalho de teclado <kbd>Command</kbd>+<kbd>K</kbd> para criar um link.{% ifversion fpt or ghae-issue-5434 or ghes > 3.3 or ghec %} Depois de selecionar o texto, você poderá colar uma URL da área de transferência para criar um link automaticamente com base na seleção.{% endif %}

{% ifversion fpt or ghae-issue-7103 or ghes > 3.5 or ghec %} Você também pode criar um hiperlink markdown realçando o texto e usando o atalho de teclado <kbd>Command</kbd>+<kbd>V</kbd>. Se você quiser substituir o texto pelo link, use o atalho de teclado <kbd>Command</kbd>+<kbd>Shift</kbd>+<kbd>V</kbd>.{% endif %}
...
Para criar uma lista aninhada usando o editor Web do {% data variables.product.product_name %} ou um editor de texto que usa uma fonte com espaçamento uniforme, como o [Atom](https://atom.io/), você pode alinhar a lista visualmente. Digite caracteres de espaço na frente do item de lista aninhada até que o caractere de marcador da lista (<kbd>-</kbd> ou <kbd>*</kbd>) fique diretamente abaixo do primeiro caractere do texto no item acima dele.
