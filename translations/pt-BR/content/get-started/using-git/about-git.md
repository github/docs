...
Primeiro, você deverá criar um novo repositório em {% data variables.product.product_name %}. Para obter mais informações, confira "[Olá, Mundo](/get-started/quickstart/hello-world)". **Não** inicialize o repositório com um arquivo LEIAME, .gitignore ou License. Este repositório vazio irá aguardar seu código.
...
Este exemplo pressupõe que você já tenha um projeto chamado `repo` no computador e que um novo branch tenha sido enviado por push para o {% data variables.product.product_name %} desde a última vez que as alterações foram feitas localmente.
...
- [Projetos iniciantes para explorar](https://github.com/showcases/great-for-new-contributors)
- [Guias em vídeo do {% data variables.product.product_name %}](https://youtube.com/githubguides)
...
- [Como trabalhar localmente](https://www.youtube.com/watch?v=rBbbOouhI-s&index=2&list=PLg7s6cbtAD17Gw5u8644bgKhgRLiJXdX4)
