...
ms.locfileid: '145126340'
---
## Ciclo de versões do {% data variables.product.prodname_dotcom %}

Os produtos e os recursos do {% data variables.product.prodname_dotcom %} podem passar por várias fases de lançamento.

| Fase | Descrição |
|-------|-------------|
| Alpha | O produto ou recurso está em pleno desenvolvimento e tem seus requisitos e seu escopo alterados com frequência. O recurso está disponível para fins de demonstração e teste, mas não está documentado. Nas versões alfa, os recursos não estão necessariamente completos, não são fornecidos Contratos de nível de serviço (SLAs) e não existe obrigação de oferecer suporte técnico. <br><br> **Observação**: um produto ou um recurso lançado como "Technology Preview" é considerado na fase de lançamento alfa. As versões de visualização de tecnologias compartilham as mesmas características das versões alfa, conforme descrito acima.|
...
2. Opcionalmente, à direita de um recurso, clique em **Habilitar** ou **Desabilitar**.
  ![Botão Habilitar na visualização do recurso](/assets/images/help/settings/enable-feature-button.png)
