...
|<kbd>Comando</kbd>+<kbd>E</kbd> (Mac) ou </br> <kbd>CTRL</kbd>+<kbd>E</kbd> (Windows/Linux) | Insere a formatação Markdown para código ou um comando dentro de uma linha{% ifversion fpt or ghae-issue-5434 or ghes or ghec %}
|<kbd>Comando</kbd>+<kbd>K</kbd> (Mac) ou </br> <kbd>CTRL</kbd>+<kbd>K</kbd> (Windows/Linux) | Insere a formatação de Markdown para criar o link{% endif %}{% ifversion fpt or ghae-issue-7103 or ghes > 3.5 or ghec %}
...
|<kbd>Comando</kbd>+<kbd>SHIFT</kbd>+<kbd>V</kbd> (Mac) ou </br> <kbd>CTRL</kbd>+<kbd>SHIFT</kbd>+<kbd>V</kbd> (Windows/Linux) | Cola o link HTML como um texto sem formatação{% endif %}{% ifversion fpt or ghae or ghes > 3.2 or ghec %}
|<kbd>Comando</kbd>+<kbd>Shift</kbd>+<kbd>Opt</kbd>+<kbd>V</kbd> (Mac) ou </br> <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>V</kbd> (Windows/Linux) | Cola o link HTML como um texto sem formatação{% endif %}{% ifversion fpt or ghae or ghes > 3.2 or ghec %}
...
|<kbd>Comando</kbd>+<kbd>SHIFT</kbd>+<kbd>8</kbd> (Mac) ou </br> <kbd>CTRL</kbd>+<kbd>SHIFT</kbd>+<kbd>8</kbd> (Windows/Linux) | Insere a formatação Markdown para uma lista não ordenada{% endif %}
|<kbd>Comando</kbd>+<kbd>ENTER</kbd> (Mac) ou </br> <kbd>CTRL</kbd>+<kbd>ENTER</kbd> (Windows/Linux) | Envia um comentário
|<kbd>CTRL</kbd>+<kbd>.</kbd> e <kbd>CTRL</kbd>+<kbd>[número de resposta salvo]</kbd> | Abre o menu de respostas salvas e autocompleta o campo de comentário com uma resposta salva. Para obter mais informações, confira "[Sobre as respostas salvas](/articles/about-saved-replies)".{% ifversion fpt or ghae or ghes > 3.2 or ghec %}
|<kbd>Comando</kbd>+<kbd>SHIFT</kbd>+<kbd>.</kbd> (Mac) ou </br> <kbd>CTRL</kbd>+<kbd>SHIFT</kbd>+<kbd>.</kbd> (Windows/Linux) | Insere a formatação Markdown para uma cotação{% endif %}{% ifversion fpt or ghec %}
...
|<kbd>Comando</kbd>+<kbd>SHIFT</kbd>+<kbd>ENTER</kbd> | Adiciona um comentário único no diff da pull request |
|<kbd>Alt</kbd> e clique | Alterna entre as opções de recolhimento e expansão de todos os comentários de revisão desatualizados em uma solicitação de pull mantendo pressionada a tecla <kbd>Alt</kbd> e clicando em **Mostrar desatualizados** ou **Ocultar desatualizados**.|
...
| Atalho de teclado | Descrição
|-----------|------------
|<kbd>⌘</kbd>+<kbd>f</kbd> (Mac) ou <kbd>Ctrl</kbd>+<kbd>f</kbd> (Windows/Linux) | Campo de filtro de foco
...
|<kbd>⌘</kbd>+<kbd>Shift</kbd>+<kbd>\</kbd> (Mac) ou <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>\</kbd> (Windows/Linux) | Abrir menu de ações de linha
