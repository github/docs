...
Você deve usar um token de acesso da instalação para acessar os pontos de extremidade usando seu {{ site.data.variables.product.prodname_github_app }}. Para obter mais informações, consulte "[Efetuando a autenticação com o {{ site.data.variables.product.prodname_github_apps }}](/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-an-installation)".
