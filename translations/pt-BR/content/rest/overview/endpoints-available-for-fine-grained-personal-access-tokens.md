---
title: Pontos de extremidade disponíveis para tokens de acesso pessoal refinados
intro: 'Os {% data variables.product.pat_v2 %} podem fazer solicitações aos pontos de extremidade REST a seguir.'
versions:
  feature: pat-v2
