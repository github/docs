...
Você pode usar a criptografia em API REST para gerenciar a chave que criptografa seus dados em {% data variables.product.product_name %}. Para obter mais informações, consulte "[Configurar a criptografia de dados para sua empresa](/admin/configuration/configuring-data-encryption-for-your-enterprise)".
