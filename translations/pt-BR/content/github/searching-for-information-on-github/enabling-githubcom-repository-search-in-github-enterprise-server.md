...
intro: 'Você pode conectar suas contas pessoais ao {% data variables.product.prodname_dotcom_the_website %} e ao {% data variables.product.prodname_ghe_server %} para pesquisar conteúdos em determinados repositórios privados do {% data variables.product.prodname_dotcom_the_website %} no {% data variables.product.prodname_ghe_server %}.'
redirect_from:
