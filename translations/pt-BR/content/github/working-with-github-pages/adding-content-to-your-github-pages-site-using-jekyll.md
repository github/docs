...
intro: 'É possível adicionar uma nova página ou postagem ao site do Jekyll no {{ site.data.variables.product.prodname_pages }}.'
...
Pessoas com permissões de gravação para um repositório podem adicionar conteúdo a um site do {{ site.data.variables.product.prodname_pages }} usando o Jekyll.

### Sobre conteúdo em sites do Jekyll

Para poder adicionar conteúdo a um site do Jekyll no {{ site.data.variables.product.prodname_pages }}, você precisa criar o site do Jekyll. Para obter mais informações, consulte "[Criar um site do {{ site.data.variables.product.prodname_pages }} com o Jekyll](/articles/creating-a-github-pages-site-with-jekyll)".
