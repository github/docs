...
intro: 'É possível criar um site do {{ site.data.variables.product.prodname_pages }} em um repositório novo ou existente.'
redirect_from:
...
Também é possível adicionar um tema para personalizar a aparência do site. Para obter mais informações, consulte {% if currentVersion == "free-pro-team@latest" %}"[Adicionar um tema ao site do {{ site.data.variables.product.prodname_pages }} com o seletor de temas](/articles/adding-a-theme-to-your-github-pages-site-with-the-theme-chooser){% else %}"[Adicionar um tema ao site do {{ site.data.variables.product.prodname_pages }} usando o Jekyll](/articles/adding-a-theme-to-your-github-pages-site-using-jekyll){% endif %}".

Para personalizar seu site ainda mais, você pode usar o Jekyll, um gerador de site estático com suporte integrado para o {{ site.data.variables.product.prodname_pages }}. Para obter mais informações, consulte "[Sobre o {{ site.data.variables.product.prodname_pages }} e o Jekyll](/articles/about-github-pages-and-jekyll)".
