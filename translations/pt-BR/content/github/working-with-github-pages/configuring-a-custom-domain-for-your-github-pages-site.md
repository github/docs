---
title: Configurar um domínio personalizado para o site do GitHub Pages
intro: 'É possível personalizar o nome de domínio do site do {{ site.data.variables.product.prodname_pages }}.'
redirect_from:
