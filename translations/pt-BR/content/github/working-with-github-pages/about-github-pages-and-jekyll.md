...
intro: 'Jekyll é um gerador de site estático com suporte integrado para {{ site.data.variables.product.prodname_pages }}.'
redirect_from:
...
O Jekyll é um gerador de site estático com suporte integrado para {{ site.data.variables.product.prodname_pages }} e um processo de compilação simplificado. O Jekyll usa arquivos Markdown e HTML, além de criar um site estático completo com base na sua escolha de layouts. O Jekyll aceita Markdown e Liquid, uma linguagem de modelagem que carrega conteúdo dinâmico no site. Para obter mais informações, consulte [Jekyll](https://jekyllrb.com/).
...
É recomendável usar o Jekyll com o {{ site.data.variables.product.prodname_pages }}. Se preferir, você pode usar outros geradores de site estáticos ou personalizar seu próprio processo de compilação localmente ou em outro servidor. Para obter mais informações, consulte "[Sobre {{ site.data.variables.product.prodname_pages }}](/articles/about-github-pages#static-site-generators)".

### Configurar o Jekyll em seu site do {{ site.data.variables.product.prodname_pages }}
...
Algumas definições de configuração não podem ser alteradas para sites do {{ site.data.variables.product.prodname_pages }}.
...
{{ site.data.reusables.pages.add-jekyll-theme }} Para obter mais informações, consulte "[Temas](https://jekyllrb.com/docs/themes/)" na documentação do Jekyll.

{% if currentVersion == "free-pro-team@latest" %}
É possível adicionar um tema compatível ao seu site no {{ site.data.variables.product.prodname_dotcom }}. Para obter mais informações, consulte "[Temas compatíveis](https://pages.github.com/themes/)" no site do {{ site.data.variables.product.prodname_pages }} e "[Adicionar um tema ao seu site do {{ site.data.variables.product.prodname_pages }} com o seletor de temas](/articles/adding-a-theme-to-your-github-pages-site-with-the-theme-chooser)".

Para usar qualquer outro tema Jekyll de código aberto hospedado no {{ site.data.variables.product.prodname_dotcom }}, você pode adicionar o tema manualmente.{% else %} Você pode adicionar um tema ao seu site manualmente.{% endif %} Para obter mais informações, consulte{% if currentVersion == "free-pro-team@latest" %} [temas hospedados no {{ site.data.variables.product.prodname_dotcom }}](https://github.com/topics/jekyll-theme) e{% else %} "[Temas compatíveis](https://pages.github.com/themes/)" no site do {{ site.data.variables.product.prodname_pages }} e{% endif %} "[Adicionar um tema ao seu site do {{ site.data.variables.product.prodname_pages }} usando o Jekyll](/articles/adding-a-theme-to-your-github-pages-site-using-jekyll)".
...
Você pode baixar ou criar plugins do Jekyll para ampliar a funcionalidade do Jekyll em seu site. Por exemplo, o plugin [jemoji](https://github.com/jekyll/jemoji) permite usar emoji em estilo do {{ site.data.variables.product.prodname_dotcom }} em qualquer página do seu site da mesma forma que você faria no {{ site.data.variables.product.prodname_dotcom }}. Para obter mais informações, consulte "[Plugins](https://jekyllrb.com/docs/plugins/)" na documentação do Jekyll.

O {{ site.data.variables.product.prodname_pages }} usa plugins que são habilitados por padrão e não podem ser desabilitados:
...
Você pode habilitar plugins adicionais incluindo a gem do plugin à configuração `plugins` em seu arquivo *_config.yml*. Para obter mais informações, consulte "[Configuração](https://jekyllrb.com/docs/configuration/)" na documentação do Jekyll. Para obter uma lista de plugins compatíveis, consulte "[Versões de dependência](https://pages.github.com/versions/)" no site do {{ site.data.variables.product.prodname_pages }}.

Para obter informações de uso para um plugin específico, consulte a documentação do plugin.

{% tip %}

**Dica:** você pode ter certeza de que está usando a versão mais recente de todos os plugins mantendo o gem do {{ site.data.variables.product.prodname_pages }} atualizado. Para obter mais informações, consulte "[Testar o site do GitHub Pages localmente com o Jekyll](/articles/testing-your-github-pages-site-locally-with-jekyll#updating-the-github-pages-gem)" e "[Versões de dependência](https://pages.github.com/versions/)" no site do {{ site.data.variables.product.prodname_pages }}.

{% endtip %}

O {{ site.data.variables.product.prodname_pages }} não pode criar sites usando plugins incompatíveis. Se quiser usar plugins incompatíveis, gere seu site localmente e faça push dos arquivos estáticos do site no {{ site.data.variables.product.product_name }}.

### Realce de sintaxe

Para facilitar a leitura do seu site, trechos de código são destacados nos sites do {{ site.data.variables.product.prodname_pages }} da mesma maneira que são destacados no {{ site.data.variables.product.product_name }}. Para mais informações sobre destaque de sintaxe em {{ site.data.variables.product.product_name }}, consulte "[Criar e realçar blocos de código](/articles/creating-and-highlighting-code-blocks)".
...
Se o seu tema não incluir CSS para realce da sintaxe, você poderá gerar CSS de realce de sintaxe do {{ site.data.variables.product.prodname_dotcom }} e adicioná-lo ao arquivo `style.css` do projeto.
