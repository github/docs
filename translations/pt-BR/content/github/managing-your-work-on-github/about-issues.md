...
intro: 'Use problemas para rastrear ideias, aprimoramentos, tarefas ou erros para trabalhar no {{ site.data.variables.product.product_name }}.'
redirect_from:
...
- Relatar comentários que violam as [Diretrizes da comunidade](/articles/github-community-guidelines) do {{ site.data.variables.product.prodname_dotcom }}. Para obter mais informações, consulte "[Relatar abuso ou spam](/articles/reporting-abuse-or-spam)".{% endif %}
