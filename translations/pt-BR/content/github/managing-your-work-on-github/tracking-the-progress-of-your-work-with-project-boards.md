...
intro: 'Você pode acompanhar e priorizar seu trabalho no {{ site.data.variables.product.product_name }} criando um quadro de projeto com observações, pull requests e problemas associados.'
redirect_from:
