...
intro: 'Se você tiver um cupom, poderá resgatá-lo em uma assinatura {{ site.data.variables.product.prodname_dotcom }} paga.'
redirect_from:
...
O {{ site.data.variables.product.product_name }} não poderá efetuar um reembolso se uma conta for paga antes da aplicação de um cupom. Também não poderemos transferir um cupom resgatado ou fornecer um novo cupom se você aplicar o cupom na conta errada. Verifique se você está aplicando o cupom na conta correta antes de resgatá-lo.

Não é possível aplicar cupons em planos pagos para apps {{ site.data.variables.product.prodname_marketplace }}.
