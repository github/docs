...
Se você planeja renomear um repositório que tenha um site do {{ site.data.variables.product.prodname_pages }} , recomendamos usar um domínio personalizado para o seu site. Isso garante que a URL do site não seja impactada pela renomeação do repositório. Para obter mais informações, consulte "[Sobre um domínio personalizado e o site {{ site.data.variables.product.prodname_pages }}](/github/working-with-github-pages/about-custom-domains-and-github-pages)".

{% endif %}

{% tip %}

**Dica:** {{ site.data.reusables.organizations.owners-and-admins-can }} renomear um repositório. {{ site.data.reusables.organizations.new-repo-permissions-more-info }}
