...
intro: 'O {{ site.data.variables.product.product_name }} atende a aplicativos de vários intervalos de endereços IP, que são disponibilizados usando a API.'
redirect_from:
...
Você pode recuperar uma lista de endereços IP do {{ site.data.variables.product.prodname_dotcom }} no ponto de extremidade da API [meta](https://api.github.com/meta). Para obter mais informações, consulte "[Meta](/v3/meta/)".
