...
intro: 'Você pode criar arquivos diretamente no {{ site.data.variables.product.product_name }} em qualquer repositório no qual tenha acesso de gravação.'
redirect_from:
...
Ao criar um arquivo no {{ site.data.variables.product.product_name }}, lembre-se do seguinte:
...
- Os nomes de arquivos criados por meio da interface da web podem conter apenas caracteres alfanuméricos e hífens (`-`). Para usar outros caracteres, [crie e faça commit dos arquivos localmente e, em seguida, faça push deles no repositório do {{ site.data.variables.product.product_name }}](/articles/adding-a-file-to-a-repository-using-the-command-line).
