...
Para mais informações sobre como adicionar pessoas à sua empresa, consulte "{% ifversion fpt %}[Convidar pessoas para gerenciar a sua empresa](/github/setting-up-and-managing-your-enterprise/inviting-people-to-manage-your-enterprise){% else %}[Autenticação](/admin/authentication){% endif %}".
