...
intro: 'Se uma organização não requer mais um {{ site.data.variables.product.prodname_oauth_app }} previamente autorizado, os proprietários podem remover o acesso do aplicativo aos recursos da organização.'
redirect_from:
