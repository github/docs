...
**Observação:** {{ site.data.reusables.project-management.cascading-permissions }} para obter mais informações, consulte "[Permissões do quadro de projeto para uma organização](/articles/project-board-permissions-for-an-organization)".
