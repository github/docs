...
intro: 'É possível convidar qualquer pessoa para integrar sua organização usando o nome de usuário {{ site.data.variables.product.product_name }} ou endereço de e-mail dela.'
redirect_from:
