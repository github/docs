...
intro: 'Você pode tornar qualquer pessoa um integrante da sua organização usando o respectivo nome de usuário no {{ site.data.variables.product.product_name }} ou o endereço de e-mail dela.'
redirect_from:
