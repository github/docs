...
6. [Crie um repositório](/articles/creating-a-new-repository/) no {{ site.data.variables.product.product_name }}.
7. No topo da página Quick Setup (Configuração rápida) do novo repositório do {{ site.data.variables.product.product_name }}, clique em {% octicon "clippy" aria-label="The copy to clipboard icon" %} para copiar a URL do repositório remote. ![Campo Copy remote repository URL (Copiar URL do repositório remote)](/assets/images/help/repository/copy-remote-repository-url-quick-setup.png)
...
10. Verifique se a URL remota mudou com o nome do novo repositório.
  ...
  ```
11. Faça push das alterações para o novo repositório no {{ site.data.variables.product.product_name }}.
  ```shell
