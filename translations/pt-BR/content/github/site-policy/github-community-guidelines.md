...
Claro, você sempre pode entrar em contato conosco em {{ site.data.variables.contact.report_abuse }} se precisar de mais ajuda para lidar com uma situação.
