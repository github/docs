...
- Estiver inscrito em um programa de aprendizado informal que não faz parte do [programa de campus do {% data variables.product.prodname_dotcom %}](https://education.github.com/schools) e não estiver matriculado em um curso superior ou técnico.
