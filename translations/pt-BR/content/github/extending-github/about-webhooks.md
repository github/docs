...
**Dica:** {{ site.data.reusables.organizations.owners-and-admins-can }} gerenciar webhooks para uma organização. {{ site.data.reusables.organizations.new-org-permissions-more-info }}
...
* Um site do {{ site.data.variables.product.prodname_pages }} é construído
* Um novo integrante é adicionado a uma equipe

Usando a API do {{ site.data.variables.product.product_name }}, você pode fazer com que esses webhooks atualizem um rastreador de problema externo, disparem compilações de CI, atualizem um espelho de backup ou até mesmo implantem no servidor de produção.
