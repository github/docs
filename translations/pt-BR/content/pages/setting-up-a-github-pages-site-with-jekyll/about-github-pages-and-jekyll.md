...
É possível adicionar um tema compatível ao seu site no {% data variables.product.prodname_dotcom %}. Para obter mais informações, consulte "[temas compatíveis](https://pages.github.com/themes/)" no site de {% data variables.product.prodname_pages %} e [Adicionando um tema ao seu site de {% data variables.product.prodname_pages %} usando o Jekyll"](/articles/adding-a-theme-to-your-github-pages-site-using-jekyll).
