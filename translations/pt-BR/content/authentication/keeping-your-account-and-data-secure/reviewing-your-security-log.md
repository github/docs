...
| Ação | Descrição
|------------------|-------------------
| `create` | Disparada quando você [adiciona uma nova chave SSH pública à sua conta no {% ifversion ghae %}{% data variables.product.product_name %}{% else %}{% data variables.product.product_location %}{% endif %}](/articles/adding-a-new-ssh-key-to-your-github-account).
| `delete` | Disparada quando você [remove uma chave SSH pública da sua conta no {% ifversion ghae %}{% data variables.product.product_name %}{% else %}{% data variables.product.product_location %}{% endif %}](/articles/reviewing-your-ssh-keys).
