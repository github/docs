...
intro: 'Para proteger suas informações pessoais, você deve manter a sua conta em {% ifversion ghae %}{% data variables.product.product_name %}{% else %}{% data variables.location.product_location %}{% endif %} e todos os dados associados à ela protegidos.'
redirect_from:
