...
**Observação:** se você está encontrando erros de autenticação em uma organização que impõe o logon único do SAML, talvez seja necessário revogar o Aplicativo OAuth na [página de configurações da sua conta](https://github.com/settings/applications) e repetir o fluxo de autenticação para autorizar o aplicativo de novo.
