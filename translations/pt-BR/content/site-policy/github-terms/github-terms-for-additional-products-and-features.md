...
## GitHub Copilot
Para usar o GitHub Copilot, você precisa instalar uma extensão em um ambiente de desenvolvimento integrado (IDE) ou editor. O código que você escreve usando a extensão do GitHub Copilot em um IDE editor (“**Seu Código**”) não é considerado “Conteúdo” segundo o Contrato até você o carregar no GitHub.com.

O código, as funções e outros resultados retornados para você pelo GitHub Copilot são chamados “**Sugestões**.” O GitHub não reivindica nenhum direito sobre as Sugestões e você mantém a propriedade e a responsabilidade pelo Seu Código, incluindo as Sugestões incluídas no Seu Código.

_Uso aceitável_

Seu Código é sujeito às [Políticas de uso aceitável](/site-policy/acceptable-use-policies/github-acceptable-use-policies) do GitHub. Por exemplo, você não pode solicitar ao GitHub Copilot conteúdo que seja ilegal ou proibido pelas Políticas de uso aceitável do GitHub no GitHub.com.

_Dados_

O GitHub Copilot (i) poderá, dependendo de suas configurações de telemetria preferidas, coletar trechos de seu código e (ii) coletar informações de uso adicionais por meio do IDE ou editor vinculado à sua conta. Isso poderá incluir dados pessoais, conforme mencionado na [Política de Privacidade do GitHub](/site-policy/privacy-policies/github-privacy-statement). Você pode saber mais sobre a coleta e uso dos dados do GitHub Copilot nas [Perguntas frequentes do GitHub Copilot](https://github.com/features/copilot#faq-privacy).
