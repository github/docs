...
## <a name="what-is-a-complete-government-takedown-request"></a>O que é uma solicitação de remoção governamental completa?
...
## <a name="what-happens-when-we-receive-a-complete-takedown-request-from-a-government"></a>O que acontece quando recebemos uma solicitação de remoção completa de um governo?
...
## <a name="why-do-we-publicly-post-takedown-notices"></a>Por que publicamos notificações de remoção publicamente?
...
## <a name="what-does-it-mean-if-we-post-a-notice-in-our-gov-takedowns-repository"></a>O que significa se postarmos uma notificação em nosso repositório de remoções governamentais?
...
## <a name="government-takedowns-based-on-violations-of-githubs-terms-of-service"></a>Remoções governamentais com base em violações dos Termos de Serviço do GitHub
...
## <a name="transparency-reporting"></a>Relatórios de transparência
