...
{% data reusables.repositories.request-security-advisory-cve-id %} Para obter mais informações, confira "[Sobre os {% data variables.product.prodname_security_advisories %} para repositórios](/code-security/repository-security-advisories/about-github-security-advisories-for-repositories#cve-identification-numbers)".
