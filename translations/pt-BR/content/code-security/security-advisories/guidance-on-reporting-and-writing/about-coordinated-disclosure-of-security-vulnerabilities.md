...
Há dois processos disponíveis no {% data variables.product.prodname_dotcom %}:
...
{% data reusables.security-advisory.private-vulnerability-reporting-enable %}
 ...
 O relatório de vulnerabilidades privado é um modo fácil para que os relatores de vulnerabilidade divulguem de modo privado os riscos de segurança aos mantenedores do repositório, dentro do {% data variables.product.prodname_dotcom %} e de uma forma que notifica imediatamente os mantenedores do repositório sobre o problema. Para obter mais informações sobre pesquisadores de segurança e mantenedores de repositório, confira "[Relatar de modo privado uma vulnerabilidade de segurança](/code-security/security-advisories/guidance-on-reporting-and-writing/privately-reporting-a-security-vulnerability)" e "[Gerenciar as vulnerabilidades de segurança relatadas de modo privado](/code-security/security-advisories/guidance-on-reporting-and-writing/managing-privately-reported-security-vulnerabilities)", respectivamente.

{% note %}

**Observação**: se o repositório que contém a vulnerabilidade não tiver relatórios de vulnerabilidades privados habilitados, os pesquisadores de segurança e os mantenedores de repositório precisarão seguir as instruções descritas na seção "[Processo padrão](#standard-process)" acima.
