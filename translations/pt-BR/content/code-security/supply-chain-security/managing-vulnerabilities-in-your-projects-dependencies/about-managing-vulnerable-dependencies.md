...
intro: '{% data variables.product.product_name %} ajuda você a evitar o uso de software de terceiros que contém vulnerabilidades conhecidas.'
redirect_from:
...
{% data variables.product.product_name %} fornece as ferramentas a seguir para remover e evitar dependências vulneráveis.
