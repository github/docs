...
Depois de verificar o local do recurso, você poderá atualizar o fluxo de trabalho para especificar o local correto. Se você executar consultas adicionais na análise Go, talvez tenha sido afetado pela realocação dos arquivos de origem. Para obter mais informações, confira [Comunicado de realocação: `github/codeql-go` migrando para `github/codeql`](https://github.com/github/codeql-go/issues/741) no repositório github/codeql-go.
