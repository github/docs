...
{% ifversion fpt or ghes > 3.2 or ghae or ghec %} Nos repositórios em que a {% data variables.product.prodname_code_scanning %} for configurada para verificar sempre que houver push de código, a {% data variables.product.prodname_code_scanning %} também mapeará os resultados para todas as solicitações de pull em aberto e adicionará os alertas como anotações nos mesmos locais das outras verificações de solicitação de pull. Para obter mais informações, confira "[Verificação durante o push](/code-security/code-scanning/automatically-scanning-your-code-for-vulnerabilities-and-errors/configuring-code-scanning#scanning-on-push)".
{% endif %}
...
{% ifversion fpt or ghes > 3.2 or ghae or ghec %} Para ver o conjunto completo de alertas do branch analisado, clique em **Exibir todos os alertas do branch**. Isso abrirá a exibição completa do alerta em que você poderá filtrar todos os alertas do branch por tipo, severidade, marca etc. Para obter mais informações, confira "[Como gerenciar alertas da verificação de código para seu repositório](/code-security/code-scanning/automatically-scanning-your-code-for-vulnerabilities-and-errors/managing-code-scanning-alerts-for-your-repository#filtering-and-searching-for-code-scanning-alerts)".

![Verificação dos resultados da {% data variables.product.prodname_code_scanning_capc %} em uma solicitação de pull](/assets/images/help/repository/code-scanning-results-check.png) {% endif %}
...
{% ifversion fpt or ghec or ghes > 3.4 or ghae-issue-6249 %} ![Descrição do alerta e link para mostrar mais informações](/assets/images/help/repository/code-scanning-pr-alert.png) {% else %} ![Descrição do alerta e link para mostrar mais informações](/assets/images/enterprise/3.4/repository/code-scanning-pr-alert.png) {% endif %}
