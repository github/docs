...
ms.locfileid: '147573849'
---
## <a name="about-group-assignments"></a>Sobre atribuições em grupo
...
## <a name="creating-an-assignment"></a>Criar uma atividade

{% data reusables.classroom.assignments-guide-create-the-assignment %}

## <a name="setting-up-the-basics-for-an-assignment"></a>Configurar os fundamentos para uma atividade
...
### <a name="naming-an-assignment"></a>Nomear uma atividade
...
### <a name="assigning-a-deadline-for-an-assignment"></a>Atribuir um prazo para uma atividade

{% data reusables.classroom.assignments-guide-assign-a-deadline %}

### <a name="choosing-an-assignment-type"></a>Escolher um tipo de atividade
...
### <a name="defining-teams-for-an-assignment"></a>Definir equipes para uma atividade
...
### <a name="choosing-a-visibility-for-assignment-repositories"></a>Escolher uma visibilidade para repositórios de atividades

{% data reusables.classroom.assignments-guide-choose-visibility %}

{% data reusables.classroom.assignments-guide-click-continue-after-basics %}

## <a name="adding-starter-code-and-configuring-a-development-environment"></a>Adicionar código inicial e configurar um ambiente de desenvolvimento
...
### <a name="choosing-a-template-repository"></a>Escolher um repositório de modelo
...
### <a name="choosing-an-integrated-development-environment-ide"></a>Escolhendo um ambiente integrado de desenvolvimento (IDE)
...
### <a name="testing-assignments-automatically"></a>Testar recomendações automaticamente

{% data reusables.classroom.assignments-guide-using-autograding %}

### <a name="creating-a-pull-request-for-feedback"></a>Criar um pull request para feedback
...
## <a name="inviting-students-to-an-assignment"></a>Convidar alunos para uma atividade
...
## <a name="monitoring-students-progress"></a>Monitorando o progresso dos alunos
