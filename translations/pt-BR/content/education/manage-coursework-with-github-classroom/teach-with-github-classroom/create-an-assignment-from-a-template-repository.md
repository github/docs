...
ms.locfileid: '145093840'
---
Você pode utilizar um repositório de modelo em {% data variables.product.product_name %} como código inicial para uma atividade em {% data variables.product.prodname_classroom %}. Seu repositório modelo pode conter código-padrão, documentação e outros recursos para seus alunos. Para obter mais informações, confira "[Como criar um repositório de modelos](/github/creating-cloning-and-archiving-repositories/creating-a-template-repository)".
...
Você pode reutilizar uma atribuição existente, mesmo que ela use um repositório de modelos, em qualquer outra sala de aula à qual você tenha acesso de administrador, incluindo salas de aula em uma organização diferente. Para saber mais, confira "[Reutilizar uma atribuição](/education/manage-coursework-with-github-classroom/teach-with-github-classroom/reuse-an-assignment)".

## Leitura adicional

- "[Criar uma atribuição individual](/education/manage-coursework-with-github-classroom/create-an-individual-assignment)"
