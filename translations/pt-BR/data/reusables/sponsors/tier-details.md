...
{% data reusables.sponsors.sponsors-only-repos %} Para obter mais informações, confira "[Como adicionar um repositório a uma camada de patrocínio](/sponsors/receiving-sponsorships-through-github-sponsors/managing-your-sponsorship-tiers#adding-a-repository-to-a-sponsorship-tier)".

Você pode incluir uma mensagem de boas-vindas com informações sobre como acessar ou receber recompensas, que ficarão visíveis após o pagamento e no email de boas-vindas.
