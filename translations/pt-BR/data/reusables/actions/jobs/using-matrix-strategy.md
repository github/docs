...
Uma matriz gerará no máximo 256 trabalhos por execução do fluxo de trabalho. This limit applies to both {% data variables.product.product_name %}-hosted and self-hosted runners.
