...
1. Clique em **Open in Desktop** (Abrir no Desktop) para clonar o repositório e abra-o no {{ site.data.variables.product.prodname_desktop }}. ![Botão Open in Desktop (Abrir no Desktop)](/assets/images/help/desktop/open-in-desktop-button.png)
{% else %}
