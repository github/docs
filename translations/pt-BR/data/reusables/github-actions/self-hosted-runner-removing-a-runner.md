1. Em **Runners auto-hospedados**, localize o runner na lista. Se o seu runner estiver em um grupo, clique em {% octicon "chevron-down" aria-label="The downwards chevron" %} para expandir a lista.
