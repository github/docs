...
permissions: '拥有 {{ site.data.variables.product.prodname_insights }} 访问权限的任何人都可以管理目标。'
versions:
  enterprise-server: '*'
---
...
目标无法创建或删除。 编辑目标时，新目标将适用于使用 {{ site.data.variables.product.prodname_insights }} 应用程序的所有用户。
