...
permissions: '对 {{ site.data.variables.product.prodname_insights }} 具有管理员权限的人可管理贡献者和团队。'
miniTocMaxHeadingLevel: 4
versions:
  enterprise-server: '*'
---

### 关于 {{ site.data.variables.product.prodname_insights }} 中的贡献者和团队

{{ site.data.variables.product.prodname_insights }} 中的贡献者是与 {{ site.data.variables.product.prodname_enterprise }} 数据相关联的实体。 您可以编辑和隐藏贡献者。

有时，同一个人可能显示为多个贡献者。 例如，某人在 Git 中使用了多个提交电子邮件地址，而 {{ site.data.variables.product.prodname_insights }} 中的每个电子邮件地址都对应一个唯一的贡献者。 您可以合并多个贡献者以整合来自同一个人的所有数据。
...
您可以编辑贡献者在 {{ site.data.variables.product.prodname_insights }} 中的显示名称。
...
合并两个或多个贡献者时，这些贡献者的 {{ site.data.variables.product.prodname_insights }} 数据将与一个主贡献者相关联。 在指标中，所有合并的贡献者数据都属于主贡献者。

您可以根据 {{ site.data.variables.product.prodname_insights }} 检测到的具有匹配名称的贡献者，手动或自动合并贡献者。
...
### 管理 {{ site.data.variables.product.prodname_insights }} 中的团队

{{ site.data.variables.product.prodname_insights }} 中有两种类型的团队：从 {{ site.data.variables.product.product_name }} 导入的团队和自定义团队。

当一个组织被添加到 {{ site.data.variables.product.prodname_insights }} 时，该组织的所有成员均从 {{ site.data.variables.product.product_name }} 导入。 您可以在 {{ site.data.variables.product.prodname_insights }} 中按这些团队进行搜索和过滤。 您可以在 {{ site.data.variables.product.product_name }} 中管理团队。

您可以在 {{ site.data.variables.product.prodname_insights }} 中创建和管理自定义团队。 自定义团队可包括来自 {{ site.data.variables.product.product_name }} 中多个组织的成员。
