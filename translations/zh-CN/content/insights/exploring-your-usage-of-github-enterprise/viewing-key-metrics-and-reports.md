...
permissions: '具有 {{ site.data.variables.product.prodname_insights }} 访问权限的任何人都可以查看关键指标和报告。'
versions:
  enterprise-server: '*'
---
...
{{ site.data.reusables.github-insights.key-metrics-and-reports }} 有关可用指标的更多信息，请参阅“[可用于 {{ site.data.variables.product.prodname_insights }} 的指标](/insights/exploring-your-usage-of-github-enterprise/metrics-available-with-github-insights)”。

您可以查看每个关键指标的目标和成功率。 更多信息请参阅“[管理目标](/insights/installing-and-configuring-github-insights/managing-goals)”

您只能访问您在 {{ site.data.variables.product.prodname_insights }} 中也可以访问的 {{ site.data.variables.product.prodname_enterprise }} 数据。
...
1. 在 {{ site.data.variables.product.prodname_insights }} 中，单击 **{% octicon "file" aria-label="The file icon" %} Reports（报告）**。 ![Reports（报告）选项卡](/assets/images/help/insights/reports-tab.png)
