...
1. 在任何页面顶部，单击“市场”。
  ![Marketplace 链接](/assets/images/help/search/marketplace-link.png)
2. 键入任何关键字，然后按“Enter”。
  ![搜索 {% data variables.product.prodname_marketplace %} 上的语法检查](/assets/images/help/search/marketplace-apps-and-actions-search-field.png)
...
3. 在左侧边栏中，单击“市场”。
  ![Marketplace 侧菜单选项突出显示的语法检查搜索结果](/assets/images/help/search/marketplace-left-side-navigation.png)

## 延伸阅读

- [关于 {% data variables.product.prodname_marketplace %}](/github/customizing-your-github-workflow/about-github-marketplace)
- [在工作流中使用 {% data variables.product.prodname_marketplace %} 的操作](/actions/automating-your-workflow-with-github-actions/using-actions-from-github-marketplace-in-your-workflow)
