...
如果您在已保存但未提交更改时使用 {% data variables.product.prodname_desktop %} 切换分支，则 {% data variables.product.prodname_desktop %} 会提示您隐藏更改或将其带到其他分支。 有关详细信息，请参阅“[管理分支](/desktop/contributing-to-projects/managing-branches#switching-between-branches)”。
