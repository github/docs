...
ms.locfileid: "147081086"
---
{% data reusables.projects.graphql-deprecation %}

本文演示如何使用 GraphQL API 来管理项目。 有关如何在 {% data variables.product.prodname_actions %} 工作流中使用 API 的详细信息，请参阅“[自动化项目（测试版）](/issues/trying-out-the-new-projects-experience/automating-projects)”。 有关可用数据类型的完整列表，请参阅“[参考](/graphql/reference)”。
...
## <a name="finding-information-about-projects"></a>查找项目信息

使用查询获取项目数据。 有关详细信息，请参阅“[关于查询](/graphql/guides/forming-calls-with-graphql#about-queries)”。

### <a name="finding-the-node-id-of-an-organization-project"></a>查找组织项目的节点 ID
...
### <a name="finding-the-node-id-of-a-user-project"></a>查找用户项目的节点 ID 
...
### <a name="finding-the-node-id-of-a-field"></a>查找字段的节点 ID
...
### <a name="finding-information-about-items-in-a-project"></a>查找项目中各项的信息 
...
## <a name="updating-projects"></a>更新项目 
...
### <a name="adding-an-item-to-a-project"></a>添加项到项目
...
### <a name="adding-a-draft-issue-to-a-project"></a>向项目添加草稿问题
...
### <a name="updating-a-projects-settings"></a>更新项目的设置 
...
### <a name="updating-a-custom-text-number-or-date-field"></a>更新自定义文本、数字或日期字段 
...
### <a name="updating-a-single-select-field"></a>更新单选字段
...
### <a name="updating-an-iteration-field"></a>更新迭代字段
...
### <a name="deleting-an-item-from-a-project"></a>从项目中删除项
