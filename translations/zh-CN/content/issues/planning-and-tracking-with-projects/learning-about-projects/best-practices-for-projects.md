---
title: '{% data variables.product.prodname_projects_v2 %} 的最佳做法'
intro: 学习管理项目的技巧。
...
有关详细信息，请参阅“[创建 {% data variables.projects.project_v2 %}](/issues/planning-and-tracking-with-projects/creating-projects/creating-a-project)”。
...
{% data variables.product.prodname_projects_v2 %} 提供内置工作流。 例如，当议题关闭时，您可以自动将状态设置为“完成”。 {% ifversion projects-v2-auto-archive %}还可以配置内置工作流，以自动存档满足特定条件的项。{% endif %}
...
- 有关内置工作流的详细信息，请参阅“[使用内置自动化](/issues/planning-and-tracking-with-projects/automating-your-project/using-the-built-in-automations)”。{% ifversion projects-v2-auto-archive %}
- 有关自动存档项目的详细信息，请参阅“[自动存档项目](/issues/planning-and-tracking-with-projects/automating-your-project/archiving-items-automatically)”。{% endif %}
