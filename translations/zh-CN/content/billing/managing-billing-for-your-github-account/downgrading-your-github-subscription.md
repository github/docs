---
title: 降级 GitHub 订阅
intro: '可以随时降级 {% data variables.location.product_location %} 上任何类型的帐户的订阅。'
redirect_from:
...
**注意：** 
  - 如果贵组织由企业帐户拥有，则无法在组织级别管理账单。 若要降级，必须先从企业帐户中删除组织。 有关详细信息，请参阅“[从企业中删除组织](/enterprise-cloud@latest/admin/user-management/managing-organizations-in-your-enterprise/removing-organizations-from-your-enterprise)”。
  - 如果你目前正在试用 {% data variables.product.prodname_ghe_cloud %}，并且在试用结束前没有购买 {% data variables.product.prodname_enterprise %}，贵组织将自动降级为 {% data variables.product.prodname_free_team %} 或 {% data variables.product.prodname_team %}。 有关详细信息，请参阅“[设置试用版 {% data variables.product.prodname_ghe_cloud %}](/get-started/signing-up-for-github/setting-up-a-trial-of-github-enterprise-cloud#finishing-your-trial)”。
