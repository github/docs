...
印度用户可在[此处](https://support.github.com/contact/india-grievance-officer)联系印度的 GitHub 申诉专员。

## 举报用户

{% data reusables.profile.user_profile_page_navigation %} {% data reusables.profile.user_profile_page_block_or_report %}
3. 单击“举报滥用行为”。
  ![包含阻止用户或举报滥用选项的模态框](/assets/images/help/profile/profile-report-abuse.png)
4. 填写联系表单以告知 {% data variables.contact.contact_support %} 用户行为，然后单击“发送请求”。

## 举报议题或拉取请求

1. 导航到您想要举报的议题或拉取请求。
2. 在问题或拉取请求的右上角，单击 {% octicon "kebab-horizontal" aria-label="The horizontal kebab octicon" %}，然后单击“举报内容”。
  ![用于举报评论的按钮](/assets/images/help/repository/menu-report-issue-or-pr.png) {% data reusables.community.report-content %}

## 举报评论

1. 导航到您要举报的评论。
2. 在评论的右上角，单击 {% octicon "kebab-horizontal" aria-label="The horizontal kebab octicon" %}，然后单击“举报内容”。
![带有举报评论选项的 Kebab 菜单](/assets/images/help/repository/menu-report-comment.png) {% data reusables.community.report-content %}

## BackHub 可在 {% data variables.product.prodname_marketplace %} 中找到。

{% data reusables.marketplace.visit-marketplace %}
2. 浏览到您要举报的应用程序。
3. 在左侧边栏中的“开发人员链接”部分下，单击“{% octicon "report" aria-label="The report symbol" %} 举报滥用行为”。
  ![举报 {% data variables.product.prodname_marketplace %} 中的应用的按钮](/assets/images/help/marketplace/marketplace-report-app.png)
4. 填写联系表单以告知 {% data variables.contact.contact_support %} 应用行为，然后单击“发送请求”。

## 举报模板选择器中的联系链接滥用

1. 导航到包含要举报的联系链接的仓库。
2. 在存储库名称下，单击“{% octicon "issue-opened" aria-label="The issues icon" %} 问题”。
3. 在模板选择器的右下角单击“举报滥用行为”。
  ![举报滥用行为的链接](/assets/images/help/repository/template-chooser-report-abuse.png)
4. 填写联系表单以告知 {% data variables.contact.contact_support %} 联系链接的行为，然后单击“发送请求”。
