---
title: 管理破坏性评论
intro: '您可以{% ifversion fpt %}隐藏、编辑、{% else %}编辑{% endif %}或删除对议题、拉取请求和提交的评论。'
redirect_from:
...
编辑评论和删除无助于促进对话以及违反社区行为准则{% ifversion fpt %}或 GitHub [社区指导方针](/articles/github-community-guidelines){% endif %}的内容是明智之举。
...
删除评论是调解员最后的选择。 如果整个评论没有给对话带来建设性的内容，或者违反社区的行为准则{% ifversion fpt %}或 GitHub [社区指导方针](/articles/github-community-guidelines){% endif %}，删除评论是明智之举。
