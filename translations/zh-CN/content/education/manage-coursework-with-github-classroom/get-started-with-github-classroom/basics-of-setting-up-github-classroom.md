...
1. <a href="https://youtu.be/xVVeqIDgCvM" target="_blank">入门</a> {% octicon "link-external" aria-label="The external link icon" %}
2. <a href="https://youtu.be/DTzrKduaHj8" target="_blank">添加学生名册</a> {% octicon "link-external" aria-label="The external link icon" %}
3. 创建作业
    - <a href="https://youtu.be/6QzKZ63KLss" target="_blank">使用 {% data variables.product.prodname_dotcom %} 存储库创建作业</a> {% octicon "link-external" aria-label="The external link icon" %}
    - <a href="https://youtu.be/Qmwh6ijsQJU" target="_blank">使用 Microsoft MakeCode 作为联机 IDE 来创建作业</a> {% octicon "link-external" aria-label="The external link icon" %}
4. <a href="https://youtu.be/ObaFRGp_Eko" target="_blank">学生如何完成作业</a> {% octicon "link-external" aria-label="The external link icon" %}
5. <a href="https://youtu.be/g45OJn3UyCU" target="_blank">老师如何检查作业</a> {% octicon "link-external" aria-label="The external link icon" %}
6. <a href="https://youtu.be/QxrA3taZdNM" target="_blank">创建小组作业</a> {% octicon "link-external" aria-label="The external link icon" %}
7. <a href="https://youtu.be/tJK2cmoh1KM" target="_blank">入门的后续步骤</a> {% octicon "link-external" aria-label="The external link icon" %}
...
有关使用 {% data variables.product.prodname_classroom %} 进行教学的详细信息，请参阅“[使用 {% data variables.product.prodname_classroom %} 进行教学](/education/manage-coursework-with-github-classroom/teach-with-github-classroom)”。

## 延伸阅读

- [通过 {% data variables.product.prodname_education %} 探索教学和学习的好处](/education/teach-and-learn-with-github-education)
