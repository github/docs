...
- 用于掌握 Git 和 {% data variables.product.prodname_dotcom %} 的教师培训
...
若要了解教师如何使用 GitHub，请参阅 [GitHub Education 故事](https://education.github.com/stories)。

## {% data variables.product.prodname_campus_program %} terms and conditions

- 许可证免费一年，每两年自动续订一次。只要您继续在协议条款范围内运作，您就可以继续使用免费许可证。欢迎任何同意[该计划条款](https://education.github.com/schools/terms)的学校加入。
...
- 企业中的新组织将自动添加到您的企业帐户。若要添加在你的学校加入 {% data variables.product.prodname_campus_program %} 之前就存在的组织，请联系 [GitHub Education 支持](https://support.github.com/contact/education)。有关管理企业的详细信息，请参阅[企业管理员文档](/admin)。企业中的新组织将自动添加到您的企业帐户。要添加在您的学校加入 {% data variables.product.prodname_campus_program %} 之前就存在的组织，请联系 GitHub Education 支持。 


若要详细了解 {% data variables.product.prodname_dotcom %} 的隐私做法，请参阅“[全球隐私做法](/github/site-policy/global-privacy-practices)”。
...
有关详细信息，请参阅[官方 {% data variables.product.prodname_campus_program %}](https://education.github.com/schools) 页面。

如果你是学生或教职员工，并且你的学校未作为 {% data variables.product.prodname_campus_program %} 学校与 {% data variables.product.prodname_dotcom %} 合作，你仍可以个人申请使用 {% data variables.product.prodname_dotcom %} 的折扣。若要申请学生开发人员包，[请参阅申请表单](https://education.github.com/pack/join)。
