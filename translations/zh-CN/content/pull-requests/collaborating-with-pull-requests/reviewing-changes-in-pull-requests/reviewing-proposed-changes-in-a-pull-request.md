...
有关在 {% data variables.product.prodname_codespaces %} 中查看拉取请求的详细信息，请参阅“[将 {% data variables.product.prodname_github_codespaces %} 用于拉取请求](/codespaces/developing-in-codespaces/using-github-codespaces-for-pull-requests)”。
