...
3. 在“比较”页面上，单击“跨复刻比较”。
  ![跨复刻比较链接](/assets/images/help/pull_requests/compare-across-forks-link.png)
4. 在“base branch（基础分支）”下拉菜单中，选择要向其合并更改的上游仓库分支。
  ![用于选择基本复刻和分支的下拉菜单](/assets/images/help/pull_requests/choose-base-fork-and-branch.png)
5. 在“head fork（头部复刻）”下拉菜单中选择您的复刻，然后使用“compare branch（比较分支）”下拉菜单选择进行了更改的分支。
  ![用于选择头部复刻和比较分支的下拉菜单](/assets/images/help/pull_requests/choose-head-fork-compare-branch.png) {% data reusables.repositories.pr-title-description %} {% data reusables.repositories.allow-maintainers-user-forks %}
