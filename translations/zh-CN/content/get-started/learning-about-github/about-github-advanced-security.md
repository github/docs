...
{%- ifversion ghes %}站点管理员必须为 {% data variables.location.product_location %} 启用 {% data variables.product.prodname_advanced_security %}，然后才能使用这些功能。 有关详细信息，请参阅“[配置高级安全功能](/admin/configuration/configuring-advanced-security-features)”。
