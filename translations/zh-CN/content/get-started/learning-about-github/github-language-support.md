...
无论您的代码是以何种语言编写的，大多数 {% data variables.product.prodname_dotcom %} 功能都有效。 您可以在 {% data variables.product.prodname_dotcom %} 已知任何语言的基础上搜索代码或启用语法高亮。 有关详细信息，请参阅“[搜索代码](/github/searching-for-information-on-github/searching-code#search-by-language)”或“[创建和突出显示代码块](/github/writing-on-github/creating-and-highlighting-code-blocks#syntax-highlighting)”。
