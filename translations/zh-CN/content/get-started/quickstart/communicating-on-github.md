...
若要了解一些有助于传达的高级格式设置功能，请参阅“[在 {% data variables.product.prodname_dotcom %} 上进行编写的快速入门](/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/quickstart-for-writing-on-github)”。
