...
可以使用命令面板在 {% data variables.location.product_location %} 上搜索任何内容。
...
|`Open in new codespace`|为此存储库创建并打开代码空间。 有关详细信息，请参阅“[为存储库创建 codespace](/codespaces/developing-in-codespaces/creating-a-codespace-for-a-repository)”。|
...
|`Open in new codespace`|为拉取请求的头部分支创建并打开代码空间。 有关详细信息，请参阅“[为存储库创建 codespace](/codespaces/developing-in-codespaces/creating-a-codespace-for-a-repository)”。
