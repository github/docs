...
**注：**{% data reusables.pre-release-program.suspend-installation-beta %}
...
安装 GitHub 应用程序的人（也称为安装设施所有者）只能通过其应用程序的安装设置来挂起或取消挂起 GitHub 应用程序。 安装设施所有者不能使用 API 来挂起或取消挂起其应用程序安装设施。 在用户可以挂起 GitHub 应用程序安装设施之前，GitHub 应用程序所有者必须选择加入测试版。 更多信息请参阅“[挂起 GitHub 应用程序安装](/apps/managing-github-apps/suspending-a-github-app-installation/)”。
