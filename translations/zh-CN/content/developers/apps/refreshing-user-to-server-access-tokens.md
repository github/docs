...
| 名称              | 类型    | 描述                                                                                                                                                                    |
| --------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `refresh_token` | `字符串` | **Required.** The token generated when the  {{ site.data.variables.product.prodname_github_app }} owner enables expiring tokens and issues a new user access token. |
| `grant_type`    | `字符串` | **Required.** Value must be `refresh_token` (required by the OAuth specification).                                                                                    |
| `client_id`     | `字符串` | **Required.** The  client ID for your {{ site.data.variables.product.prodname_github_app }}.                                                                        |
| `client_secret` | `字符串` | **Required.** The  client secret for your {{ site.data.variables.product.prodname_github_app }}.                                                                    |
