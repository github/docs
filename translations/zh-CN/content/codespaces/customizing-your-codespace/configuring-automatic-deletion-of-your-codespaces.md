...
intro: 未使用的 codespace 会自动删除。 你可以选择停止的 codespace 将保留多长时间，最长为 30 天。
...
ms.locfileid: '147110746'
---
默认情况下，{% data variables.product.prodname_codespaces %} 在停止且保持 30 天的非活动状态后会自动删除。

但是，由于 {% data variables.product.prodname_codespaces %} 会产生存储费用，因此，你可能希望通过在 {% data variables.product.prodname_github_codespaces %} 的个人设置中更改默认期限来减少保持期。 有关存储费用的详细信息，请参阅“[关于 {% data variables.product.prodname_github_codespaces %} 的计费](/billing/managing-billing-for-github-codespaces/about-billing-for-github-codespaces#codespaces-pricing)”。
