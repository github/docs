...
4. To rebuild your container and apply the devcontainer.json changes, access the command palette (`shift command P` / `shift control P`), then start typing "rebuild". 单击 **Codespaces: Rebuild Container（代码空间：重建容器）**。
