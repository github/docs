...
5. 在“存储库讨论”下，选择或取消选择“允许具有读取访问权限的用户创建讨论”。
  ![“允许具有读取访问权限的用户创建讨论”复选框](/assets/images/help/discussions/toggle-allow-users-with-read-access-checkbox.png)
6. 单击“ **保存**”。
  ![用于讨论设置的“保存”按钮](/assets/images/help/discussions/click-save.png)
