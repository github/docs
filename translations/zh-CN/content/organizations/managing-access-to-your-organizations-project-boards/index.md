---
title: '管理对组织的 {% data variables.product.prodname_projects_v1 %} 的访问权限'
intro: '作为组织所有者或 {% data variables.projects.projects_v1_board %} 管理员，你可以为组织成员、团队和外部协作者提供对组织拥有的 {% data variables.projects.projects_v1_boards %} 的不同级别的访问权限。'
redirect_from:
