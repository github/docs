...
ms.locfileid: '145130342'
---
{% data reusables.profile.access_org %} {% data reusables.profile.org_settings %} {% data reusables.organizations.oauth_app_access %}
5. 在要禁用的应用程序旁边，单击 {% octicon "pencil" aria-label="The edit icon" %}。
  ![“编辑”图标](/assets/images/help/settings/settings-third-party-deny-edit.png)
6. 单击“拒绝访问”。
  ![“拒绝确认”按钮](/assets/images/help/settings/settings-third-party-deny-confirm.png)
