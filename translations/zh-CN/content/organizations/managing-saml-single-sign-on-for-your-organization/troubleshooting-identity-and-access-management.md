...
ms.locfileid: "145101333"
---
## <a name="some-users-are-not-provisioned-or-deprovisioned-by-scim"></a>某些用户未由 SCIM 预配或取消预配
...
### <a name="auditing-users-for-missing-scim-metadata"></a>审核用户是否缺少 SCIM 元数据
...
#### <a name="auditing-organization-members-on--data-variablesproductprodname_dotcom-"></a>审核 {% data variables.product.prodname_dotcom %} 上的组织成员
...
#### <a name="auditing-organization-members-through-the--data-variablesproductprodname_dotcom--api"></a>通过 {% data variables.product.prodname_dotcom %} API 审核组织成员
...
#### <a name="using-graphql"></a>使用 GraphQL
...
### <a name="re-provisioning-scim-for-users-through-your-identity-provider"></a>通过身份提供商为用户重新预配 SCIM
