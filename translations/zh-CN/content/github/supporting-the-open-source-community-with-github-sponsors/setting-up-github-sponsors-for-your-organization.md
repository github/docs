...
intro: '您的组织可以加入 {{ site.data.variables.product.prodname_sponsors }} 以接受对您工作的付款。'
redirect_from:
  - /articles/setting-up-github-sponsorship-for-your-organization
  - /articles/receiving-sponsorships-as-a-sponsored-organization
permissions: '组织所有者可以为组织设置 {{ site.data.variables.product.prodname_sponsors }}。'
versions:
  free-pro-team: '*'
---
...
收到邀请您的组织加入 {{ site.data.variables.product.prodname_sponsors }} 的邀请后，您可以完成以下步骤以成为被赞助的组织。
...
作为被赞助组织，您必须在受支持的区域接收支付到组织专用银行帐户的赞助款。 您可以通过如 [Open Collective](https://opencollective.com/) 和 [Stripe Atlas](https://stripe.com/atlas) 之类的服务获得企业银行帐户。 {{ site.data.reusables.sponsors.stripe-supported-regions }}
...
有关使用 Open Collective 设置 Stripe Connect 的更多信息，请参阅 Open Collective 文档中的[设置 {{ site.data.variables.product.prodname_sponsors }}](https://docs.opencollective.com/help/collectives/github-sponsors)。
...
Before your organization can become a sponsored organization, you must enable 2FA on your {{ site.data.variables.product.product_name }} account. 更多信息请参阅“[配置双重身份验证](/articles/configuring-two-factor-authentication)”。
