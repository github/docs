...
4. 在“Write（撰写 ）”字段中，添加要用于已保存回复的内容。 有关在 {{ site.data.variables.product.product_name }} 上撰写的更多信息，请参阅“[基本撰写和格式语法](/articles/basic-writing-and-formatting-syntax)”。 ![撰写已保存回复](/assets/images/help/settings/saved-replies-settings-adding.png)
