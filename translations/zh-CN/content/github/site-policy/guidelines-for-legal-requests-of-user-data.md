...
**私人帐户数据** — GitHub 也收集和维护我们[隐私政策](/articles/github-privacy-statement)中概述的用户相关特定私密信息。 可能包括：
  ...
  要了解 GitHub 收集的私人帐户信息类型， 可以访问您的 {{ site.data.reusables.user_settings.personal_dashboard }} 并浏览左侧菜单栏中的区域。
...
您是否有其他问题、评论或建议？ 请联系 {{ site.data.variables.contact.contact_support }}。
