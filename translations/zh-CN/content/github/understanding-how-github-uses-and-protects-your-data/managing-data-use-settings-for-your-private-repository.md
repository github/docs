---
title: 管理私有仓库的数据使用设置
intro: '为帮助 {{ site.data.variables.product.product_name }} 连接到相关的工具、人员、项目和信息，您可以配置私有仓库的数据使用。'
redirect_from:
