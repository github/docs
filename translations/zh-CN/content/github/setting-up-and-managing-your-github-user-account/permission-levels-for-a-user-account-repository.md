...
| 限制与仓库的交互                                                                                                                                                                                    | “[限制仓库中的交互](/github/building-a-strong-community/limiting-interactions-in-your-repository)”|{% endif %}{% if currentVersion == "free-pro-team@latest" or currentVersion ver_gt "enterprise-server@3.0" %}
...
| 操作                          | 更多信息                                                                                                                                                                                                                                                                  |
|:--------------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 复刻仓库                        | “[关于复刻](/github/collaborating-with-issues-and-pull-requests/about-forks)”|{% if currentVersion == "free-pro-team@latest" or currentVersion ver_gt "enterprise-server@3.0" %}
