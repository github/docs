...
3. 在左侧边栏中，单击 **{{ site.data.variables.product.prodname_oauth_app }}**。 ![左侧边栏中的 { site.data.variables.product.prodname_oauth_app }} 选项卡](/assets/images/help/settings/developer-settings-oauth-apps.png)
