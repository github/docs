...
组织拥有的仓库可授予更细致的访问权限。 更多信息请参阅“[{{ site.data.variables.product.product_name }} 上的访问权限](/articles/access-permissions-on-github)”。
...
**注：** {{ site.data.variables.product.company_short }} 会限制在 24 小时内可受邀参加仓库的人数。 如果您超过此限制，请等待 24 小时后再邀请，或者创建一个组织以与更多的人协作。
...
{% if currentVersion == "free-pro-team@latest" %} 如果他们还没有用户名，他们可以注册 {{ site.data.variables.product.prodname_dotcom }} 更多信息请参阅“[注册新 {{ site.data.variables.product.prodname_dotcom }} 帐户](/articles/signing-up-for-a-new-github-account)”。{% endif %}
