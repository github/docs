...
如果您无法管理您的用户拥有的仓库，建议邀请其他 {{ site.data.variables.product.company_short }} 用户作为继承者管理。 作为继承者，他们拥有以下权限：
...
指定的继承者在提交死亡证明并等待 7 天或者提交讣告并等待 21 天后，便可管理您的公共仓库。 更多信息请参阅“[{{ site.data.variables.product.company_short }} 已故用户政策](/github/site-policy/github-deceased-user-policy)”。

要请求作为继承者管理仓库，请联系 [GitHub 支持](https://support.github.com/contact)。

### 邀请继承者
您邀请作为继承者的人必须拥有 {{ site.data.variables.product.company_short }} 帐户。
