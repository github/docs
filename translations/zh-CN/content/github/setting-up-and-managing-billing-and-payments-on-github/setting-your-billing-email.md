---
title: 设置帐单邮箱
intro: '您帐户的帐单邮箱是 {{ site.data.variables.product.product_name }} 发送收据及其他计费相关通信的地方。'
redirect_from:
...
您个人帐户的主邮箱是 {{ site.data.variables.product.product_name }} 发送收据及其他计费相关通信的地方。
...
您组织的帐单邮箱是 {{ site.data.variables.product.product_name }} 发送收据及其他计费相关通信的地方。
