---
title: 在组织中安装应用程序
intro: '您可以从 {{ site.data.variables.product.prodname_marketplace }} 安装要在组织中使用的应用程序。'
redirect_from:
...
### 在组织中安装 {{ site.data.variables.product.prodname_github_app }}
...
### 在组织中安装 {{ site.data.variables.product.prodname_oauth_app }}
