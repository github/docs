...
**提示**：您可以使用 {% data variables.product.prodname_cli %} 创建拉取请求。 更多信息请参阅 {% data variables.product.prodname_cli %} 文档中的“[`gh pr 创建`](https://cli.github.com/manual/gh_pr_create)”。
