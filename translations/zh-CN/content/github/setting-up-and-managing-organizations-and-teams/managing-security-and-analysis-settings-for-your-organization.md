---
title: 管理组织的安全性和分析设置
intro: '您可以控制功能以保护组织在 {{ site.data.variables.product.prodname_dotcom }} 上项目的安全并分析其中的代码。'
...
{{ site.data.variables.product.prodname_dotcom }} 可帮助保护组织中的仓库。 您可以管理成员在组织中创建的所有现有或新仓库的安全性和分析功能。
