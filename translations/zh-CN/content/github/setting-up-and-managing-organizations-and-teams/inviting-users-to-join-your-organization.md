---
title: 邀请用户参加您的组织
intro: '您可以使用任何人的 {{ site.data.variables.product.product_name }} 用户名或电子邮件地址邀请其成为组织的成员。'
redirect_from:
...
- 如果您的组织采用付费的每用户订阅，则必须有未使用的许可才可邀请新成员加入组织或恢复前组织成员。 更多信息请参阅“[关于每用户定价](/articles/about-per-user-pricing)”。 {{ site.data.reusables.organizations.org-invite-expiration }}
