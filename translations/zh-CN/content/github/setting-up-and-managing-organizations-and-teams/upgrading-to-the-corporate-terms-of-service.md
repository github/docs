...
标准服务条款是 {{ site.data.variables.product.prodname_dotcom }} 与您个人之间的协议。 要代表实体（例如公司、非营利性组织或团体）与 {{ site.data.variables.product.prodname_dotcom }} 签订协议，组织所有者可升级到公司服务条款。

1. 联系 {{ site.data.variables.contact.contact_support }}以请求升级到公司服务条款。 他们将在组织的仪表板上启用横幅，从而允许您接受公司服务条款。
...
5. 输入拥有该组织帐户的公司、非营利性组织或团体的名称。 这是将与 {{ site.data.variables.product.prodname_dotcom }} 签订协议的实体。 ![企业名称字段](/assets/images/help/organizations/business-name-field.png)
