...
双重身份验证 (2FA) 为组织成员提供基本验证。 通过启用 2FA，组织管理员可降低成员的 {{ site.data.variables.product.product_name }} 帐户被盗的可能性。 有关 2FA 的更多信息，请参阅“[关于双重身份验证](/articles/about-two-factor-authentication)”。
...
- 使用 2FA 登录其 {{ site.data.variables.product.product_name }} 帐户
- 使用单点登录访问组织
