---
title: 搜索包
intro: '您可以在 {{ site.data.variables.product.product_name }} 上搜索包，并使用搜索限定符缩小结果范围。'
...
您可以在所有 {{ site.data.variables.product.product_name }} 中全局搜索包，也可以在特定组织内搜索包。 更多信息请参阅“[关于在 {{ site.data.variables.product.prodname_dotcom }} 上搜索](/articles/about-searching-on-github)”。
...
| <code>org:<em>ORGNAME</em></code> | [**org:github**](https://github.com/search?q=org%3Agithub&type=RegistryPackages) 匹配 {{ site.data.variables.product.prodname_dotcom }} 组织拥有的包 |
