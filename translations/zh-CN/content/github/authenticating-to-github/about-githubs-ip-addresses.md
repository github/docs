...
intro: '{{ site.data.variables.product.product_name }} 可服务于多个 IP 地址范围的应用程序，使用 API 可获取地址。'
redirect_from:
...
您可以从 [meta](https://api.github.com/meta) API 端点检索 {{ site.data.variables.product.prodname_dotcom }} 的 IP 地址列表。 更多信息请参阅“[元数据](/v3/meta/)”。
