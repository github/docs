---
title: 编辑仓库中的文件
intro: '您可以使用文件编辑器，在任何仓库中的 {{ site.data.variables.product.product_name }} 上直接编辑文件。'
redirect_from:
...
**提示**：{{ site.data.reusables.repositories.protected-branches-block-web-edits-uploads }}

{% endtip %}

{% note %}

**注意：** {{ site.data.variables.product.product_name }} 的文件编辑器使用 [CodeMirror](https://codemirror.net/)。
