...
intro: '当您在 {{ site.data.variables.product.product_location }} 上添加具有 *.ipynb* 扩展名的 Jupyter Notebook 或 IPython Notebook 文件时，它们将在您的仓库中呈现为静态 HTML 文件。'
redirect_from:
...
笔记本的交互式功能（例如自定义的 JavaScript 图）在 {{ site.data.variables.product.product_location }} 上的仓库中不起作用。 有关示例，请参阅 [*Linking and Interactions.ipynb*](https://github.com/bokeh/bokeh-notebooks/blob/master/tutorial/06%20-%20Linking%20and%20Interactions.ipynb)。
