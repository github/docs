---
title: 申请学生开发包
intro: '作为学生，可以申请 {{ site.data.variables.product.prodname_student_pack }}，其中包括 {{ site.data.variables.product.prodname_dotcom }} 合作伙伴的特惠和福利。'
redirect_from:
...
要获得申请 {{ site.data.variables.product.prodname_student_pack }} 的资格，必须：
...
有关续订 {{ site.data.variables.product.prodname_student_pack }} 的信息，请参阅“[到期和续订](/articles/applying-for-a-student-developer-pack/#expiration-and-renewals)”。

### 申请 {{ site.data.variables.product.prodname_student_pack }}
...
在您的 {{ site.data.variables.product.prodname_student_pack }} 访问权限到期后，如果您仍有资格，您可以重新申请，但有些合作伙伴可能不提供续订服务。 合作伙伴的大多数计时特惠在您设置后便开始。 更多信息请参阅 [{{ site.data.variables.product.prodname_student_pack }}](https://education.github.com/pack) 页面。

要查看您对 {{ site.data.variables.product.prodname_student_pack }} 的免费访问何时到期，请访问您帐户的[帐单设置](https://github.com/settings/billing)。

### 延伸阅读

- "[我的 {{ site.data.variables.product.prodname_student_pack }} 申请为什么未获得批准？](/articles/why-wasn-t-my-application-for-a-student-developer-pack-approved)"
- "[注册新 {{ site.data.variables.product.prodname_dotcom }} 帐户](/articles/signing-up-for-a-new-github-account)"
