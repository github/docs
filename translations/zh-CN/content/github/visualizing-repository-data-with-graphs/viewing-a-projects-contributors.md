...
- 您并非前 100 名贡献者之一。
- 您的提交尚未合并到默认分支。
- 您用于创作提交的电子邮件地址尚未添加到您的 {{ site.data.variables.product.product_name }} 帐户。
...
如果您用于创作提交的电子邮件地址尚未添加到您的 {{ site.data.variables.product.product_name }} 帐户，则提交不会链接到您的帐户，并且您不会在贡献者图中显示。 更多信息请参阅“[设置提交电子邮件地址](/articles/setting-your-commit-email-address)”和“[添加电子邮件地址到 {{ site.data.variables.product.product_name }} 帐户](/articles/adding-an-email-address-to-your-github-account)”。
