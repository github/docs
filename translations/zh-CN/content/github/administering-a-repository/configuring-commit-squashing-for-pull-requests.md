---
title: 为拉取请求配置提交压缩
intro: '对于仓库中 {{ site.data.variables.product.product_location }} 上的所有拉取请求合并，您可以实施、允许或禁用提交压缩。'
redirect_from:
...
4. 在“Merge（合并）”按钮下，选择 **Allow squash merging（允许压缩合并）**。 这将允许贡献者通过将所有提交压缩到单个提交中来合并拉取请求。 如果除了 **Allow squash merging（允许压缩合并）**之外，您还选择了另一种合并方法，则贡献者在合并拉取请求时能够选择合并提交的类型。 {{ site.data.reusables.repositories.squash-and-rebase-linear-commit-hisitory }} ![拉取请求压缩提交](/assets/images/help/repository/pr-merge-squash.png)
