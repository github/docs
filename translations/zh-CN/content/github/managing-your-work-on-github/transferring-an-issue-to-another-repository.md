...
转让议题时，评论和受理人将保留。 议题的标签{% if currentVersion ver_lt "enterprise-server@2.19" %}、项目{% endif %} 和里程碑不予保留。{% if currentVersion == "free-pro-team@latest" or currentVersion ver_gt "enterprise-server@2.18" %} 此议题将保留在任何用户拥有或组织范围的项目板上，并从任何仓库项目板中删除。 更多信息请参阅“[关于项目板](/articles/about-project-boards)”。{% endif %}
