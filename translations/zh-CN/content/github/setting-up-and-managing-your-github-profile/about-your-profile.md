...
- 为您参与 {{ site.data.variables.product.prodname_arctic_vault }}、{{ site.data.variables.product.prodname_sponsors }} 或 {{ site.data.variables.product.company_short }} 开发者计划等计划做宣传的徽章。
- 您是否在使用 {{ site.data.variables.product.prodname_pro }}。 更多信息请参阅“[个性化您的个人资料](/articles/personalizing-your-profile)”。{% endif %}
