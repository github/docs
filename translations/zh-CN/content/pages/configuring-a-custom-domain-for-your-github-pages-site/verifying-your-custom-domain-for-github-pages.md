...
1. 在左侧边栏中，单击 **Pages（页面）**。 ![Pages option in the settings menu](/assets/images/help/settings/user-settings-pages.png)
...
1. 在左侧边栏中，单击 **Pages（页面）**。 ![Pages option in the settings menu](/assets/images/help/settings/org-settings-pages.png)
{% data reusables.pages.settings-verify-domain-setup %}
