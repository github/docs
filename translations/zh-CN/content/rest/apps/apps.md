...
验证为 GitHub 应用程序后，您可以访问 REST API 端点。 这些端点包含显示为 “使用 GitHub App”的文字。 验证为用户后也可以访问这些端点。

某些 REST API 端点需要验证为 GitHub 应用程序安装设施。 有关这些端点的列表，请参阅[安装设施](/rest/reference/apps#installations)。
