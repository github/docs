...
2. 在“常用存储库”或“已固定”部分，单击“自定义固定”。
    ![“自定义固定”按钮](/assets/images/help/profile/customize-pinned-repositories.png)
3. 要显示要固定项目的可搜索列表，请选择“Repositories（仓库）”、"Gists" 或两者。
    ![用于选择要显示的项类型的复选框](/assets/images/help/profile/pinned-repo-picker.png)
4. （可选）为便于查找特定项目，在过滤器字段中输入用户、组织、仓库或 gist 的名称。
    ![筛选项](/assets/images/help/profile/pinned-repo-search.png)
5. 选择最多六个仓库和/或 gist 的组合以显示。
    ![选择项](/assets/images/help/profile/select-items-to-pin.png)
6. 单击“保存固定”。
    ![“保存固定”按钮](/assets/images/help/profile/save-pinned-repositories.png)
