...
{% data reusables.repositories.request-security-advisory-cve-id %} 有关详细信息，请参阅“[关于存储库的 {% data variables.product.prodname_security_advisories %}](/code-security/repository-security-advisories/about-github-security-advisories-for-repositories#cve-identification-numbers)”。
