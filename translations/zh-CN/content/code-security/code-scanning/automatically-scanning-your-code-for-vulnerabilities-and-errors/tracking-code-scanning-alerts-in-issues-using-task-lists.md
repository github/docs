...
您还可以创建新议题来跟踪警报：
- 从 {% data variables.product.prodname_code_scanning %} 警报创建，这会自动将代码扫描警报添加到新议题的任务列表中。 更多信息请参阅下面的“[从 {% data variables.product.prodname_code_scanning %} 警报创建跟踪议题](#creating-a-tracking-issue-from-a-code-scanning-alert)”。
