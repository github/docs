...
如果您使用的是 {% data variables.product.prodname_codeql_cli %}，则可以指定要使用的 SARIF 版本。 更多信息请参阅“[在 CI 系统中运行 {% data variables.product.prodname_codeql_cli %}](/code-security/secure-coding/running-codeql-cli-in-your-ci-system#uploading-results-to-github)”。{% endif %}
