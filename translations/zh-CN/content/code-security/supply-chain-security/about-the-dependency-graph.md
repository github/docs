...
- 查看和更新仓库中有漏洞的依赖项。 更多信息请参阅“[关于有漏洞依赖项的警报](/code-security/supply-chain-security/about-alerts-for-vulnerable-dependencies)”。{% if currentVersion == "free-pro-team@latest" %}
