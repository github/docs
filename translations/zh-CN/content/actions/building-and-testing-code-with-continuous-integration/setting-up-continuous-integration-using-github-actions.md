...
对仓库具有写入权限的任何人都可以使用 {{ site.data.variables.product.prodname_actions }} 设置持续集成 (CI)。
...
在推送到仓库后，您可以在 {{ site.data.variables.product.prodname_dotcom }} 上跟踪持续集成工作流程运行的状态和详细日志，并接收自定义的通知。 更多信息请参阅“[配置通知](/github/managing-subscriptions-and-notifications-on-github/configuring-notifications#github-actions-notification-options)”和“[管理工作流程运行](/articles/managing-a-workflow-run)”。
