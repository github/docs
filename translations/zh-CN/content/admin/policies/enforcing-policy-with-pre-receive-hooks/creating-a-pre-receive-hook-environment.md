...
2. 创建包含此信息的文件 `Dockerfile.alpine-3.3`：
   ...
   ```
3. 从包含 `Dockerfile.alpine-3.3` 的工作目录中生成映像：
...
有关创建 chroot 环境的更多信息，请参阅 Debian Wiki 中的“[Chroot](https://wiki.debian.org/chroot)”、Ubuntu 社区帮助 Wiki 中的“[BasicChroot](https://help.ubuntu.com/community/BasicChroot)”，或 Alpine Linux Wiki 中的“[在 chroot 中安装 Alpine Linux](http://wiki.alpinelinux.org/wiki/Installing_Alpine_Linux_in_a_chroot)”  。
...
5. 单击“管理环境”。
![管理环境](/assets/images/enterprise/site-admin-settings/manage-pre-receive-environments.png)
6. 单击“添加环境”。
![添加环境](/assets/images/enterprise/site-admin-settings/add-pre-receive-environment.png)
7. 在“环境名称”字段中输入所需名称。
![环境名称](/assets/images/enterprise/site-admin-settings/pre-receive-environment-name.png)
8. 输入包含你的环境的 `*.tar.gz` 文件的 URL。
![从 URL 上传环境](/assets/images/enterprise/site-admin-settings/upload-environment-from-url.png)
9. 单击“添加环境”。
