...
1. SSH into any passive node in the secondary datacenter for your cluster. 更多信息请参阅“[访问管理 shell (SSH)](/enterprise/admin/configuration/accessing-the-administrative-shell-ssh#enabling-access-to-the-administrative-shell-via-ssh)。”
...
3. Update the DNS record to point to the IP address of the load balancer for your passive cluster. 流量会在经过 TTL 周期后定向到副本。
