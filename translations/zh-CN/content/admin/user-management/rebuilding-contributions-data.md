...
将提交推送到 {{ site.data.variables.product.prodname_enterprise }} 时，如果新提交和现有提交关联到同一个电子邮件地址，此提交会链接到用户帐户。 不过，在用户注册新电子邮件地址或创建新帐户时，*不会*追溯地链接现有提交。
...
{{ site.data.variables.product.prodname_enterprise }} 现在会开始后台作业，将提交与用户帐户重新关联。 ![已排队的重构作业](/assets/images/enterprise/site-admin-settings/rebuild-jobs.png)
