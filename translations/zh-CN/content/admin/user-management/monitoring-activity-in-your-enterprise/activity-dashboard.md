...
为获取基于 {% data variables.product.product_name %} 中数据的更多分析，可以购买 {% data variables.product.prodname_insights %}。 更多信息请参阅“[关于 {% data variables.product.prodname_insights %}](/insights/installing-and-configuring-github-insights/about-github-insights)”。
{% endif %}
