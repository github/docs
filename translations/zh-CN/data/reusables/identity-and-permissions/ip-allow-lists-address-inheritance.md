...
您可以通过查看描述字段来识别从 {% data variables.product.prodname_github_apps %} 自动添加的 IP 地址。这些 IP 地址的描述是：“由 NAME GitHub App 管理”。与手动添加的地址不同，您无法编辑、删除或禁用从 {% data variables.product.prodname_github_apps %} 自动添加的 IP 地址。
