{{ site.data.variables.product.prodname_dotcom }} 团队连接到 IdP 组后，您的 IdP 管理员必须通过身份提供程序进行团队成员资格更改。 如果团队连接至 IdP 组，则无法在 {{ site.data.variables.product.product_name }} 上或使用 API 管理团队成员。
