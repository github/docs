{% ifversion ghes < 3.1 %}
1. 在左侧边栏中，单击 **{% data variables.product.prodname_github_connect %}**。 ![GitHub Connect tab in the business account settings sidebar](/assets/images/enterprise/business-accounts/settings-github-connect-tab.png){% else %}
