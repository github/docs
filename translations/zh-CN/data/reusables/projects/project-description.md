...
1. 若要保存对自述文件所做的更改，请单击“保存”。
  ![显示项目自述文件“保存”按钮的屏幕截图](/assets/images/help/projects-v2/save-readme-button.png)

可以通过导航到项目并单击右上角的 {% octicon "sidebar-expand" aria-label="The sidebar icon" %} 来查看和快速更改项目说明和自述文件。
