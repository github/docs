...
根据组织的需要，可以需要修改此方法并更改或删除某些阶段或步骤。

![图表显示了 GitHub 高级安全推出和部署的三个阶段，包括第 0 阶段：规划和启动，第 1 阶段：试点项目，第 2 阶段：面向早期采用者的组织购买和推出，以及第 3 阶段：完整的组织推出和变更管理](/assets/images/enterprise/security/advanced-security-phased-approach-diagram.png)
