...
1. 单击**Open in Desktop（在 Desktop 中打开）**以克隆仓库并在 {{ site.data.variables.product.prodname_desktop }} 中打开。 ![“在 Desktop 中打开”按钮](/assets/images/help/desktop/open-in-desktop-button.png)
{% else %}
