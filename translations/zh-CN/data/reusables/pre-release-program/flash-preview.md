...
**Note:** New features in the Deployments API on {{ site.data.variables.product.product_name }} are currently available during a public beta. 有关完整详情，请参阅[博客文章](https://developer.github.com/changes/2018-10-16-deployments-environments-states-and-auto-inactive-updates/)。
