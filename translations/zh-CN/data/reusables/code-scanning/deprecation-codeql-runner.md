...
注意：{% data variables.product.prodname_codeql_runner %} 将被弃用。对于 {% data variables.product.prodname_ghe_server %} 3.0 及更高版本，可以安装 [{% data variables.product.prodname_codeql_cli %}](https://github.com/github/codeql-action/releases) 版本 2.6.3 来替换 {% data variables.product.prodname_codeql_runner %}。 
