1. Para ver tu sitio publicado, debajo de "{{ site.data.variables.product.prodname_pages }}", da clic en la URL del mismo. ![URL de tu sitio publicado](/assets/images/help/pages/click-pages-url-to-preview.png)
