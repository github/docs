{% if currentVersion == "free-pro-team@latest" %}1. En la esquina superior derecha de {{site.data.variables.product.product_name}}, da clic en tu foto de perfil, posteriormente, da clic en **Tu perfil**.
