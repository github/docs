1. On {{ site.data.variables.product.prodname_dotcom }}, navigate to the main page of your user account.
2. En la esquina superior derecha de {{site.data.variables.product.product_name}}, da clic en tu foto de perfil, posteriormente, da clic en **Tu perfil**. ![Foto de perfil](/assets/images/help/profile/top_right_avatar.png)
