Un ejecutor auto-hospedado puede ubicarse ya sea en tu organización o en tus ajustes de repositorio en {{ site.data.variables.product.prodname_dotcom }}. Para administrar un ejecutor auto-hospedado, debes tener los siguientes permisos, dependiendo de donde se agregó éste:
