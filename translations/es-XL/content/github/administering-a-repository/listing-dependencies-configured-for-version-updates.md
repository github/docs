...
intro: 'Puedes ver las dependencias que monitorea el {{ site.data.variables.product.prodname_dependabot }} pára encontrar actualizaciones.'
versions:
  free-pro-team: '*'
---
...
### Visualizar los archivos de bitácora del {{ site.data.variables.product.prodname_dependabot }}

1. En la **pestaña de {{ site.data.variables.product.prodname_dependabot_short }}**, da clic en **Revisado por última vez hace *TIME*** para ver el archivo de bitácora que generó el {{ site.data.variables.product.prodname_dependabot }} durante su última verificación de actualizaciones de versión. ![Ver el archivo de bitácora](/assets/images/help/dependabot/last-checked-link.png)
