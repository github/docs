...
intro: 'Puedes hacer cumplir, permitir o inhabilitar rebases de confirmación para todas las fusiones de las solicitudes de extracción en {{ site.data.variables.product.product_location }} en tu repositorio.'
redirect_from:
