...
{% if currentVersion == "free-pro-team@latest" %}Si transfieres un repositorio privado a una cuenta de usuario u organización de {{ site.data.variables.product.prodname_free_user }}, éste perderá acceso a características como ramas protegidas y {{ site.data.variables.product.prodname_pages }}. {{ site.data.reusables.gated-features.more-info }}{% endif %}
...
- Si el repositorio transferido utiliza {{ site.data.variables.large_files.product_name_long }}, todos {{ site.data.variables.large_files.product_name_short }} los objetos se mueven automáticamente. Esta transferencia ocurre en segundo plano; por lo tanto, si tienes una gran cantidad de {{ site.data.variables.large_files.product_name_short }} objetos o si los {{ site.data.variables.large_files.product_name_short }} objetos en sí mismos son grandes, puede llevar algún tiempo que se complete la transferencia.{% if currentVersion == "free-pro-team@latest" %} Antes de transferir un repositorio que utilice {{ site.data.variables.large_files.product_name_short }}, asegúrate de que la cuenta receptora tenga suficientes paquetes de datos para almacenar los {{ site.data.variables.large_files.product_name_short }} objetos que moverás. Para obtener más información acerca de agregar almacenamiento para las cuentas de usuario, consulta "[Subir de categoría {{ site.data.variables.large_files.product_name_long }}](/articles/upgrading-git-large-file-storage)".{% endif %}
...
- Si el repositorio transferido contiene un {{ site.data.variables.product.prodname_pages }} sitio, se redirigen los enlaces al repositorio de Git en la web y a través de la actividad de Git. Sin embargo, no redirigimos {{ site.data.variables.product.prodname_pages }} asociadas al repositorio.
...
{% if currentVersion == "free-pro-team@latest" %}Si publicaste un {{ site.data.variables.product.prodname_pages }} sitio en un repositorio privado y agregaste un dominio personalizado, antes de transferir el repositorio, puede que quieras eliminar o actualizar tus registros DNS para evitar un riesgo de adquisición del dominio. Para obtener más información, consulta "[Administrar un dominio personalizado para tu sitio de {{ site.data.variables.product.prodname_pages }}](/articles/managing-a-custom-domain-for-your-github-pages-site)".{% endif %}
