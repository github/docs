...
intro: 'Puedes comprobar el estado de verificación de las firmas de tu confirmación y de la etiqueta en {{ site.data.variables.product.product_name }}.'
redirect_from:
...
1. En {{ site.data.variables.product.product_name }}, desplázate hasta la solicitud de extracción.
