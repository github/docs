...
intro: 'Para configurar tu cuenta de {{ site.data.variables.product.product_name }} a fin de usar una llave GPG nueva (o existente), también deberás agregarla a tu cuenta de {{ site.data.variables.product.product_name }}.'
redirect_from:
...
Antes de agregar una nueva llave GPG a tu cuenta de {{ site.data.variables.product.product_name }}, cerciórate de haber:
...
Al verificar una firma, extraemos la firma e intentamos analizar sus id de llave. Complementamos los id de llave con las llaves cargadas a {{ site.data.variables.product.product_name }}. Hasta que cargues tu llave de GPG a {{ site.data.variables.product.product_name }}, no podemos verificar tus firmas.
...
6. Para confirmar la acción, escribe tu contraseña de {{ site.data.variables.product.product_name }}.
