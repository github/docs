...
intro: 'Puedes controlar las características que dan seguridad y analizan tu código en tus proyectos dentro de {{ site.data.variables.product.prodname_dotcom }}.'
versions:
  free-pro-team: '*'
---
...
{{ site.data.variables.product.prodname_dotcom }} puede ayudarte a asegurar tus repositorios. Este tema te muestra cómo puedes administrar las características de seguridad y análisis para todos tus repositorios existentes o nuevos.
