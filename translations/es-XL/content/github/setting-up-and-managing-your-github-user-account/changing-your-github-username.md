...
intro: 'Puedes cambiar tu nombre de usuario de {{ site.data.variables.product.product_name }} en cualquier momento.'
redirect_from:
...
{{ site.data.variables.product.product_name }} no puede configurar redirecciones para:
...
Después de cambiar tu nombre de usuario, {{ site.data.variables.product.product_name }} automáticamente redirigirá las referencias a tus repositorios.
...
- "[{{ site.data.variables.product.prodname_dotcom }} Política de nombre de usuario](/articles/github-username-policy)"{% endif %}
