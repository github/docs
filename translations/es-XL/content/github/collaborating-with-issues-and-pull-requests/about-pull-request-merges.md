...
Cuando combinas y fusionas, {{ site.data.variables.product.prodname_dotcom }} genera un mensaje de confirmación que puedes cambiar si así lo deseas. El mensaje predeterminado depende de si la solicitud de extracción contiene varias confirmaciones o solo una.
...
Cuando creas una solicitud de extracción, {{ site.data.variables.product.prodname_dotcom }} identifica la confirmación más reciente que se encuentre tanto en la rama principal como en la [rama base](/github/getting-started-with-github/github-glossary#base-branch): la confirmación del ancestro común. Cuando combinas y fusionas la solicitud de extracción, {{ site.data.variables.product.prodname_dotcom }} crea una confirmación en la rama base que contiene todos los cambios que realizaste en la rama principal desde la confirmación del ancestro común.
...
No es posible cambiar de base y fusionar automáticamente en {{ site.data.variables.product.product_location }} cuando:
...
Si aún quieres cambiar de base las confirmaciones, pero no puedes cambiar de base y fusionar automáticamente en {{ site.data.variables.product.product_location }}, debes hacer lo siguiente:
...
Cualquiera con permisos de escritura en el repositorio, entonces puede [fusionar los cambios](/articles/merging-a-pull-request/) usando el botón Cambiar de base y fusionar en {{ site.data.variables.product.product_location }}.
