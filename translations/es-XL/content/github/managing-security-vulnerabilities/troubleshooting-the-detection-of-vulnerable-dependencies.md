...
![Vulnerabilidades múltiples para una alerta de {{ site.data.variables.product.prodname_dependabot_short }}](/assets/images/help/repository/dependabot-vulnerabilities-number.png)
