...
Clonar un repositorio extrae una copia integral de todos los datos del mismo que {{ site.data.variables.product.product_location }} tiene en ese momento, incluyendo todas las versiones para cada archivo y carpeta para el proyecto. You can push your changes to the remote repository on {{ site.data.variables.product.product_location }}, or pull other people's changes from {{ site.data.variables.product.product_location }}. Para obtener más información, consulta la sección "[Utilizar los comandos comunes de Git](/github/using-git/using-common-git-commands)".
...
### Clonar un repositorio a {{ site.data.variables.product.prodname_desktop }}

{{ site.data.reusables.repositories.navigate-to-repo }}
{{ site.data.reusables.repositories.open-with-github-desktop }}
4. Sigue las indicaciones en {{ site.data.variables.product.prodname_desktop }} para completar la clonación.

Para obtener más información, consulta "[Clonar un repositorio de {{ site.data.variables.product.prodname_dotcom }} a {{ site.data.variables.product.prodname_desktop }}](/desktop/guides/contributing-to-projects/cloning-a-repository-from-github-to-github-desktop/)".
