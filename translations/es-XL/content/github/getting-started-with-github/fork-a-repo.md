...
**Nota**: {{ site.data.reusables.repositories.desktop-fork }}
...
1. En {{ site.data.variables.product.product_location }}, dirígete al repositorio [octocat/Spoon-Knife](https://github.com/octocat/Spoon-Knife).
...
Si todavía no lo has hecho, primero debes [configurar Git](/articles/set-up-git). No olvides [configurar la autenticación a {{ site.data.variables.product.product_location }} desde Git](/articles/set-up-git#next-steps-authenticating-with-github-from-git).
...
1. En {{ site.data.variables.product.product_name }}, dirígete a **tu bifurcación** del repositorio Spoon-Knife.
...
4. Escribe `git clone`, y luego pega la URL que copiaste antes. Se verá así, con tu nombre de usuario de {{ site.data.variables.product.product_name }} en lugar de `YOUR-USERNAME`:
  ```shell
...
1. En {{ site.data.variables.product.product_name }}, dirígete al repositorio [octocat/Spoon-Knife](https://github.com/octocat/Spoon-Knife).
{{ site.data.reusables.repositories.copy-clone-url }}
{{ site.data.reusables.command_line.open_the_multi_os_terminal }}
...
Bifurca un repositorio para comenzar a colaborar con un proyecto. {{ site.data.reusables.repositories.you-can-fork }}
