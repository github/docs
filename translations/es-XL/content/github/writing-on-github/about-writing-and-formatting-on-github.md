...
Le hemos agregado alguna funcionalidad personalizada para crear el formato Markdown de {{ site.data.variables.product.prodname_dotcom }}, usado para dar formato a la prosa y al código en todo nuestro sitio.
...
Cada campo de comentario en {{ site.data.variables.product.product_name }} contiene una barra de herramientas de formato de texto, lo que te permite dar formato a tu texto sin tener que aprender la sintáxis de Markdown. Además del formato de Markdown como la negrita y la cursiva y crear encabezados, enlaces y listados, la barra de herramientas incluye características específicas de {{ site.data.variables.product.product_name }}, como las @menciones, los listados de tareas y los enlaces a propuestas y solicitudes de extracción.
