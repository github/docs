...
intro: 'Los propietarios de la organización pueden inhabilitar las restricciones de las {{ site.data.variables.product.prodname_oauth_app }} que tienen acceso a los recursos de la organización.'
redirect_from:
