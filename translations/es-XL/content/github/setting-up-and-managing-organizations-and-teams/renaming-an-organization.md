...
**Sugerencia:** Solo los propietarios de la organización pueden renombrar una organización. {{ site.data.reusables.organizations.new-org-permissions-more-info }}
...
- {{ site.data.variables.product.prodname_dotcom }} redirige automáticamente las referencias a tus repositorios.  Los enlaces web a los **repositorios** existentes de tu organización seguirán funcionando. Puede tomar algunos minutos para que se complete luego de que inicies el cambio.
