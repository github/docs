...
intro: 'Si una organización ya no requiere una {{ site.data.variables.product.prodname_oauth_app }} previamente autorizada, los propietarios pueden eliminar el acceso de la aplicación a los recursos de la organización.'
redirect_from:
