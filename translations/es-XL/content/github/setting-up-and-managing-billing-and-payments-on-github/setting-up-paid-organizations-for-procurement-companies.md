...
intro: 'Si pagas por {{ site.data.variables.product.product_name }} en nombre de un cliente, puedes configurar sus parámetros de organización y pago para optimizar la conveniencia y la seguridad.'
redirect_from:
