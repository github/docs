...
intro: 'Si tienes un cupón, puedes canjearlo por una suscripción {{ site.data.variables.product.prodname_dotcom }} paga.'
redirect_from:
...
{{ site.data.variables.product.product_name }} no puede emitir un reembolso si pagas una cuenta antes de aplicar un cupón. Tampoco podemos transferir un cupón canjeado o entregarte un cupón nuevo si lo aplicas a la cuenta equivocada. Confirma que estás aplicando el cupón a la cuenta correcta antes de canjear un cupón.

No puedes aplicar cupones a planes pagos de {{ site.data.variables.product.prodname_marketplace }} apps.
