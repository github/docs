...
intro: 'Puedes instalar apps desde {{ site.data.variables.product.prodname_marketplace }} para utilizar en tu cuenta personal.'
redirect_from:
...
### Instalar una {{ site.data.variables.product.prodname_github_app }} en tu cuenta personal
...
### Instalar una {{ site.data.variables.product.prodname_oauth_app }} en tu cuenta personal
