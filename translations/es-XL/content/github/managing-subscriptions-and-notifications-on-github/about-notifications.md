...
intro: 'Las notificaciones proporcionan actualizaciones sobre las actividades de {{ site.data.variables.product.product_name }} a las que te hayas suscrito. Puedes utilizar la bandeja de notificaciones para personalizar, clasificar y administrar tus actualizaciones.'
redirect_from:
...
Puedes elegir recibir actualizaciones continuas sobre actividades específicas en {{ site.data.variables.product.product_name }} mediante una suscripción. Las notificaciones son actualizaciones que recibes por alguna actividad específica a la que te hayas suscrito.
...
- Actividades de CI, tales como el estado de los flujos de trabajo en los repositorios configurados con {{ site.data.variables.product.prodname_actions }}.
...
Para darte de baja de las conversaciones a las cuales estás suscrito automáticamente, puedes cambiar tu configuración de notificaciones o darte de baja directamente o dejar de seguir la actividad de {{ site.data.variables.product.product_name }}. Para obtener más información, consulta la opción "[Administrar tus suscripciones](/github/managing-subscriptions-and-notifications-on-github/managing-your-subscriptions)".

### Personalizar notificaciones y suscripciones

Puedes elegir ver tus notificaciones a través de la bandeja de entrada de notificaciones en [https://github.com/notifications](https://github.com/notifications){% if currentVersion == "free-pro-team@latest" %} y en la app de {{ site.data.variables.product.prodname_mobile }}{% endif %}, a través de tu correo electrónico, o en alguna combinación de estas opciones.
...
Puedes habilitar las notificaciones de subida de información en la app de {{ site.data.variables.product.prodname_mobile }}. Para obtener más información, consulta la sección "[Configurar las notificaciones](/github/managing-subscriptions-and-notifications-on-github/configuring-notifications#enabling-push-notifications-with-github-for-mobile)".
{% endif %}
