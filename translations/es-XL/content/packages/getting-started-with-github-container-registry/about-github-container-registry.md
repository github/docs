...
### Acerca de la facturación para {{ site.data.variables.product.prodname_github_container_registry }}
...
Contacta el {{ site.data.variables.contact.github_support }} sobre {{ site.data.variables.product.prodname_github_container_registry }} usando [nuestro formulario de contacto](https://support.github.com/contact?form%5Bsubject%5D=Re:%20GitHub%20Packages) si:
