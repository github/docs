...
intro: 'Puedes usar las {{ site.data.variables.product.prodname_actions }} para crear flujos de trabajo personalizados de integración continua (CI) y de implementación continua (CD) en tu repositorio.'
redirect_from:
