...
shortTitle: Empezar
intro: '{{ site.data.variables.product.prodname_actions }} presenta un poderoso entorno de ejecución integrado en todos los pasos de tu flujo de trabajo. Puedes descubrir, crear y compartir {{ site.data.variables.product.prodname_actions }} para realizar todos los trabajos que desees.'
redirect_from:
