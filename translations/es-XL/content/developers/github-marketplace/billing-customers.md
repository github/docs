...
intro: 'Las apps en {{ site.data.variables.product.prodname_marketplace }} deben apegarse a los lineamientos de facturación de GitHub y apoyar a los servicios recomendados. El seguir nuestros lineamientos ayuda a los clientes a navegar en el proceso de facturación sin ninguna sorpresa.'
redirect_from:
...
- Los clientes deben poder modificar o cancelar sus planes de {{ site.data.variables.product.prodname_marketplace }} para las cuentas de organización y personales por separado.
...
Sigue estos lineamientos para las mejoras, decrementos y cancelaciones para mantener un proceso de facturación limpio y consistente. Para obtener instrucciones más detalladas acerca de los eventos de compra de {{ site.data.variables.product.prodname_marketplace }}, consulta la sección "[Flujos de facturación](/marketplace/integrating-with-the-github-marketplace-api/#billing-flows)".
