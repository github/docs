...
| **`site_admin`**         | Otorga a los administradores de sitio acceso a las [Terminales de la API para la Administración de {{ site.data.variables.product.prodname_ghe_server }}](/v3/enterprise-admin).{% endif %}
...
| &emsp;`security_events`  | Otorga acceso de lectura y escritura a los eventos de seguridad en la [API de {{ site.data.variables.product.prodname_code_scanning }}](/v3/code-scanning).{% endif %}
...
| **`write:packages`**     | Otorga acceso para cargar o publicar un paquete en el {{ site.data.variables.product.prodname_registry }}. Para obtener más información, consulta la sección "[Publicar un paquete](/github/managing-packages-with-github-packages/publishing-a-package)".                                                                                                                                                                                           |
| **`read:packages`**      | Otorga acceso para descargar o instalar paquetes desde el {{ site.data.variables.product.prodname_registry }}. Para obtener más información, consulta la sección "[Instalar un paquete](/github/managing-packages-with-github-packages/installing-a-package)".                                                                                                                                                                                       |
| **`delete:packages`**    | Otorga acceso para borrar paquetes del {{ site.data.variables.product.prodname_registry }}. Para obtener más información, consulta la sección "[Borrar paquetes](/github/managing-packages-with-github-packages/deleting-a-package)".{% endif %}
