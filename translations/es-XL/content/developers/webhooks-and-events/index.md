...
intro: 'Puedes configurar, probar y asegurar los webhooks para que tus integraciones puedan suscribirse y reaccionar a los eventos en {{ site.data.variables.product.prodname_dotcom }}.'
versions:
  free-pro-team: '*'
  enterprise-server: '*'
---
