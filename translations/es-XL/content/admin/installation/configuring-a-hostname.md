...
4. Escribe el nombre del host que quieres establecer para {{ site.data.variables.product.product_location_enterprise }}. ![Campo para establecer un nombre del host](/assets/images/enterprise/management-console/hostname-field.png)
...
Después de configurar un nombre del host, recomendamos que habilites el aislamiento de subdominio para {{ site.data.variables.product.product_location_enterprise }}. Para obtener más información, consulta "[Habilitar el aislamiento de subdominio](/enterprise/{{ currentVersion }}/admin/guides/installation/enabling-subdomain-isolation/)."
