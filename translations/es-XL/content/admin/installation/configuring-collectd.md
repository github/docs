...
{% data variables.product.prodname_enterprise %} se envía con `collectd` versión 5.x `collectd` 5.x no es compatible hacia atrás con la serie del lanzamiento 4.x. Tu servidor `collectd` central debe tener al menos la versión 5.x para aceptar los datos que se envían desde {% data variables.product.product_location_enterprise %}.
