...
intro: 'Puedes solicitar que las personas resuelvan los conflictos de fusión en forma local inhabilitando el editor de conflicto de fusión en {{ site.data.variables.product.prodname_ghe_server }} para las solicitudes de extracción en las que la rama base y la rama de encabezado estén en repositorios diferentes.'
redirect_from:
