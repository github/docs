...
**Nota:** únicamente los archivos mayores a {{ site.data.variables.large_files.warning_size }} se revisarán frente al límite de subida de Git. Si debes establecer un límite de subida menor, contacta a {{ site.data.variables.contact.contact_ent_support }} para obtener ayuda.
