...
intro: 'Asegúrate de que tus parámetros de dominio estén configurados adecuadamente antes de arrancar {{ site.data.variables.product.product_location_enterprise }} por primera vez.'
redirect_from:
