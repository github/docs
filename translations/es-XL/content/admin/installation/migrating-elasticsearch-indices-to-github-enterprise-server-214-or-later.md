...
El {{ site.data.variables.product.prodname_ghe_server }} 2.14 incluye una actualización a Elasticsearch 5.6. Antes de actualizar a {{ site.data.variables.product.prodname_ghe_server }} 2.14 o superior desde 2.12 o 2.13, te recomendamos que descargues, instales y ejecutes las herramientas de migración de Elasticsearch, así tus índices más grandes se migran en línea mientras tu aplicación todavía tiene acceso en línea.
