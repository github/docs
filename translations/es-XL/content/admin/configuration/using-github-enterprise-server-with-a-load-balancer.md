...
intro: 'Utiliza un balanceador de carga frente a un aparato único del {{ site.data.variables.product.prodname_ghe_server }} o un par de aparatos en una configuración de alta disponibilidad.'
redirect_from:
...
Debido a que las conexiones de cliente al {{ site.data.variables.product.prodname_ghe_server }} provienen del balanceador de carga, se puede perder la dirección IP del cliente.
...
#### Habilitar soporte para protocolo de PROXY en {{ site.data.variables.product.product_location_enterprise }}
...
#### Habilitar soporte para X-Forwarded-For en {{ site.data.variables.product.product_location_enterprise }}
