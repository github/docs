...
2. En la parte superior de la {{ site.data.variables.enterprise.management_console }}, haz clic en **Mantenimiento**. ![Pestaña de mantenimiento](/assets/images/enterprise/management-console/maintenance-tab.png)
