...
Los servidores de nombres que especifiques deben resolver el nombre del host de {{ site.data.variables.product.product_location_enterprise }}.
...
5. Para agregar tus entradas nuevas de servidores de nombres en {{ site.data.variables.product.product_location_enterprise }}, ingresa lo siguiente:
  ```shell
