...
intro: 'Usando el conjunto de herramientas git-import, puedes importar desde Subversion, Mercurial y Team Foundation Version Control a los repositorios Git en {{ site.data.variables.product.prodname_ghe_server }}.'
redirect_from:
...
4. Reescribe los autores y las ramas utilizando el archivo CSV:
  ...
  ```
5. Si aún no lo has hecho, [ crea un nuevo repositorio vacío en {{ site.data.variables.product.prodname_ghe_server }}](/enterprise/{{ currentVersion }}/user/articles/creating-a-new-repository).
{{ site.data.reusables.command_line.switching_directories_procedural }}
7. Sube el repositorio importado a {{ site.data.variables.product.prodname_ghe_server }}:
  ```shell
