...
intro: 'Puedes habilitar comprobaciones de actualización automáticas para que {{ site.data.variables.product.product_location_enterprise }} busque y descargue el último lanzamiento del {{ site.data.variables.product.prodname_ghe_server }}.'
redirect_from:
...
Cuando un paquete de actualizaciones se descarga automáticamente para {{ site.data.variables.product.product_location_enterprise }}, recibirás un mensaje informándote que puedes actualizar el {{ site.data.variables.product.prodname_ghe_server }}. Descarga de paquetes para el directorio `/var/lib/ghe-updates` en {{ site.data.variables.product.product_location_enterprise }}. Para obtener más información, consulta "[Actualizar {{ site.data.variables.product.prodname_ghe_server }}](/enterprise/{{ currentVersion }}/admin/guides/installation/upgrading-github-enterprise-server)."
...
**Consejo:** Para habilitar comprobaciones de actualización automáticas, {{ site.data.variables.product.product_location_enterprise }} se debe poder conectar a `https://github-enterprise.s3.amazonaws.com`.
