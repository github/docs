...
intro: 'Usa el shell administrativo (SSH) para actualizar una agrupación de {{ site.data.variables.product.prodname_ghe_server }} a la última versión.'
redirect_from:
...
{{ site.data.reusables.enterprise_installation.hotpatching-explanation }}El script de instalación de hotpatch instala el hotpatch en cada nodo de la agrupación y reinicia los servicios en su secuencia adecuada para evitar el tiempo de inactividad.

1. Realiza una copia de seguridad de tus datos con [{{ site.data.variables.product.prodname_enterprise_backup_utilities }}](https://github.com/github/backup-utils#readme).
...
Usa un paquete de actualización para actualizar una agrupación de {{ site.data.variables.product.prodname_ghe_server }} a la última característica de lanzamiento. Por ejemplo, puedes actualizar desde `2.11` hasta `2.13`.
...
2. Realiza una copia de seguridad de tus datos con [{{ site.data.variables.product.prodname_enterprise_backup_utilities }}](https://github.com/github/backup-utils#readme).
...
4. En [{{ site.data.variables.product.prodname_ghe_server }} Descargar página](https://enterprise.github.com/download), copia la URL para el archivo de actualización *.pkg* en el portapapeles.
