...
{{ site.data.variables.product.prodname_enterprise }} ahora iniciará trabajos en segundo plano para volver a vincular las confirmaciones de cambios con esa cuenta de usuario.  ![Trabajos de reconstrucción en cola](/assets/images/enterprise/site-admin-settings/rebuild-jobs.png)
