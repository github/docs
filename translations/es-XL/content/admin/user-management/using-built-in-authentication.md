...
intro: 'Cuando usas el método de autenticación predeterminado, todos los detalles de autenticación se almacenan dentro de {{ site.data.variables.product.product_location_enterprise }}. La autenticación integrada es el método predeterminado, si ya no tienes un proveedor de autenticación establecido, como LDAP, SAML o CAS.'
redirect_from:
