...
intro: 'La agrupación {{ site.data.variables.product.prodname_ghe_server }} permite que los servicios que la componen {{ site.data.variables.product.prodname_ghe_server }} sean escalados a múltiples nodos.'
redirect_from:
...
{{ site.data.variables.product.prodname_ghe_server }} requiere una baja latencia entre los nodos y no está hecho para redundancia en todas las ubicaciones geográficas.
...
La agrupación está diseñada para situaciones de escalada específica y no pretende ser usada para cada organización. Si te gustaría considerar la agrupación, por favor contacta a tu representante dedicado o a {{ site.data.variables.contact.contact_enterprise_sales }}.
