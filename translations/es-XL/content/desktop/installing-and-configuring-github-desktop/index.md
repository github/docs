...
intro: 'Configura a {{ site.data.variables.product.prodname_desktop }} para que administre el trabajo de tu proyecto. Autentícate en {{ site.data.variables.product.prodname_dotcom_the_website }} o en {{ site.data.variables.product.prodname_enterprise }}, mantén la app actualizada y revisa tu configuración preferida.'
redirect_from:
