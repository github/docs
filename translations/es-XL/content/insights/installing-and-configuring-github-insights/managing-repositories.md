...
intro: 'Puedes administrar los repositorios conectados a {{ site.data.variables.product.prodname_insights }} y los datos incluidos en las métricas de cada repositorio.'
product: '{{ site.data.reusables.gated-features.github-insights }}'
redirect_from:
  - /github/installing-and-configuring-github-insights/managing-repositories
permissions: 'Las personas con permisos de administrador en {{ site.data.variables.product.prodname_insights }} puede administrar repositorios.'
...
Para que {{ site.data.variables.product.prodname_insights }} incluya datos de un repositorio en {{ site.data.variables.product.prodname_enterprise }}, debes agregar la organización a la que pertenece el repositorio a {{ site.data.variables.product.prodname_insights }}. Para obtener más información, consulta "[Administrar organizaciones](/github/installing-and-configuring-github-insights/managing-organizations)."

Después de agregar una organización a {{ site.data.variables.product.prodname_insights }}, cada repositorio que le pertenece a la organización se importa automáticamente si el repositorio:
...
Para reducir los tiempos de importación, puedes excluir cualquier biblioteca de terceros en carpetas no estándar desde {{ site.data.variables.product.prodname_insights }} antes de la importación. Para obtener más información, consulta "[Administrar filtros de exclusión](#managing-exclusion-filters)."
