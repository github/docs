...
permissions: 'Las personas con permisos de administrador en {{ site.data.variables.product.prodname_insights }} pueden administrar colaboradores y equipos.'
miniTocMaxHeadingLevel: 4
versions:
  enterprise-server: '*'
---

### Acerca de los colaboradores y los equipos en {{ site.data.variables.product.prodname_insights }}

Un colaborador en {{ site.data.variables.product.prodname_insights }} es una entidad asociada con los datos de {{ site.data.variables.product.prodname_enterprise }}. Puedes editar y ocultar los colaboradores.

A veces, la misma persona puede aparecer como más de un colaborador. Por ejemplo, si una persona ha usado múltiples direcciones de correo electrónico de confirmación en Git, habrá un colaborador único para cada dirección de correo electrónico en {{ site.data.variables.product.prodname_insights }}. Puedes fusionar múltiples colaboradores para combinar todos los datos de una persona.
...
Puedes editar el nombre para mostrar de un colaborador en {{ site.data.variables.product.prodname_insights }}.
...
Cuando fusionas dos o más colaboradores, los datos {{ site.data.variables.product.prodname_insights }} para esos colaboradores se asocian con un colaborador principal. Todos los datos del colaborador fusionado pertenecen al colaborador principal en las métricas.

Puedes fusionar colaboradores de manera manual o automática, según los colaboradores que {{ site.data.variables.product.prodname_insights }} ha detectado con nombres coincidentes.
...
### Administrar equipos en {{ site.data.variables.product.prodname_insights }}

Existen dos tipos de equipos en {{ site.data.variables.product.prodname_insights }}: equipos importados desde {{ site.data.variables.product.product_name }} y equipos personalizados.

Cuando se agrega una organización a {{ site.data.variables.product.prodname_insights }}, todos los equipos de éstas se importan desde {{ site.data.variables.product.product_name }}. Puedes buscar y filtrar por estos equipos en {{ site.data.variables.product.prodname_insights }}. Puedes administrar equipos en {{ site.data.variables.product.product_name }}.

Puedes crear y administrar equipos personalizados en {{ site.data.variables.product.prodname_insights }}. Los equipos personalizados podrían incluir miembros de organizaciones múltiples en {{ site.data.variables.product.product_name }}.
