...
- Eliminar el acceso del equipo a los repositorios {% ifversion fpt or ghes or ghae %}
- [Administrar una tarea de revisión de código para el equipo](/organizations/organizing-members-into-teams/managing-code-review-assignment-for-your-team){% endif %}{% ifversion fpt %}
