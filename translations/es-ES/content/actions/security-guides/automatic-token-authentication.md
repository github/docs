...
{%- ifversion fpt or ghec or ghes > 3.2 or ghae-issue-6187 %} | páginas         | lectura/escritura  | ninguno | lectura | {%- endif %} | solicitudes de incorporación de cambios | lectura/escritura  | ninguno | lectura | | proyectos de repositorio | lectura/escritura | ninguno | lectura | | eventos de seguridad     | lectura/escritura | ninguno | lectura | | estados      | lectura/escritura  | ninguno | lectura |
...
Si necesita un token que requiere permisos que no están disponibles en `GITHUB_TOKEN`, puede crear un token de acceso personal y establecerlo como un secreto en el repositorio:

1. Usa o crea un token con los permisos adecuados para ese repositorio. Para más información, vea "[Creación de un token de acceso personal](/github/authenticating-to-github/creating-a-personal-access-token)".
