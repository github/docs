...
Toda variable de entorno nueva que configure y que apunte a una ubicación en el sistema de archivos debe tener un sufijo `_PATH`. Las variables de entorno predeterminadas `HOME`, `GITHUB_ENV` y `GITHUB_WORKSPACE` son excepciones a esta convención.
