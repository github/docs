...
ms.locfileid: '145140602'
---
{% data reusables.profile.access_org %} {% data reusables.profile.org_settings %} {% data reusables.organizations.oauth_app_access %}
5. Junto a la aplicación que desea inhabilitar, haga clic en {% octicon "pencil" aria-label="The edit icon" %}.
  ![Icono Editar](/assets/images/help/settings/settings-third-party-deny-edit.png)
6. Haga clic en **Denegar acceso**.
  ![Botón Denegar confirmación](/assets/images/help/settings/settings-third-party-deny-confirm.png)
