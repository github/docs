...
2. Abra su {% data reusables.user-settings.personal_dashboard %}.
3. Haz clic en el cambiador de contexto de la cuenta en la esquina superior izquierda de la página.
  ![Botón cambiador de contexto en Enterprise](/assets/images/help/organizations/account_context_switcher.png)
