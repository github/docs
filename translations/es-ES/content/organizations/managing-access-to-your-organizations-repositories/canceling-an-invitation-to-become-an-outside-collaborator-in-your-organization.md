...
5. Haga clic en **X colaboradores pendientes**.
  ![Botón "Colaboradores pendientes"](/assets/images/help/organizations/pending-collaborator-list.png)
6. A la derecha de la persona para la que quiera cancelar las invitaciones, haga clic en **Cancelar invitaciones**.
  ![Botón "Cancelar invitación"](/assets/images/help/organizations/cancel-pending-collaborators.png)
7. Haga clic en **Cancelar invitaciones para colaboradores pendientes**.
  ![Botón para confirmar la cancelación](/assets/images/help/organizations/confirm-cancelation-of-pending-collaborators.png)
