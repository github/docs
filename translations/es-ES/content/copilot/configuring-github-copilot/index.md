---
title: Configuración de GitHub Copilot
shortTitle: Configure GitHub Copilot
intro: 'Puedes habilitar, configurar o deshabilitar {% data variables.product.prodname_copilot %} en un IDE compatible.'
versions:
  feature: copilot
topics:
  - Copilot
