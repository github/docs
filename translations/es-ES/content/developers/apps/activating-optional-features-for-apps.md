...
3. Selecciona la
{% data variables.product.prodname_github_app %} para la cual quieras habilitar una característica {% if currentVersion ver_lt "enterprise-server@3.1" %} beta {% else %} opcional {% endif %}.
