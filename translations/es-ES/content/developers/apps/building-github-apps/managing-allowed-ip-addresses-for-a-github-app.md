...
* El propietario de la organización eligió permitir que las direcciones en la lista de direcciones permitidas de la {% data variables.product.prodname_github_app %} se agreguen a su propia lista de direcciones permitidas. Para obtener más información, consulta "[Administración de direcciones IP permitidas para la organización](/{% ifversion fpt %}enterprise-cloud@latest/{% endif %}organizations/keeping-your-organization-secure/managing-allowed-ip-addresses-for-your-organization#using-github-actions-with-an-ip-allow-list){% ifversion fpt %}" en la documentación de {% data variables.product.prodname_ghe_cloud %}.{% else %}".{% endif %}
...
1. Desplázate hacia abajo para encontrar la sección de "lista de direcciones IP permitidas".
![Sección de información básica de la aplicación de GitHub](/assets/images/github-apps/github-apps-allow-list-empty.png) {% data reusables.identity-and-permissions.ip-allow-lists-add-ip %} {% data reusables.identity-and-permissions.ip-allow-lists-add-description %} La descripción se ofrece a modo de referencia y no se utiliza en la lista de permitidos de las organizaciones en las que {% data variables.product.prodname_github_app %} está instalado. En vez de esto, las listas de direcciones permitidas de la organización incluirán "Managed by the NAME GitHub App" como descripción.
