...
intro: 'Saca más provecho de {% data variables.product.prodname_dotcom %} integrándote con nuestras API y webhooks, personalizando tu flujo de trabajo de {% data variables.product.prodname_dotcom %}, y creando y compartiendo apps con la comunidad.'
introLinks:
