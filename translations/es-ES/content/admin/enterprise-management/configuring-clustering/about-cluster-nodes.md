...
intro: 'Los *nodos* son instancias de {% data variables.product.prodname_ghe_server %} que operan en un clúster. Cada nodo ejecuta un conjunto de servicios que se suministra a la agrupación y; por último, a los usuarios.'
redirect_from:
...
**Nota: Esto es solo un ejemplo.** El diseño óptimo del clúster de la organización dependerá de sus necesidades únicas. Habla con tu representante dedicado o con {% data variables.contact.contact_enterprise_sales %} para que te podamos ayudar a determinar la mejor configuración del clúster.
