...
Los recursos de memoria y CPU que {% data variables.product.product_location %} tiene disponibles determinan la cantidad de ejecutores que se pueden configurar sin pérdida de rendimiento. {% data reusables.actions.minimum-hardware %}
...
* [Habilitación de Acciones de GitHub con Azure Blob Storage](/admin/github-actions/enabling-github-actions-with-azure-blob-storage)
* [Habilitación de Acciones de GitHub con almacenamiento de Amazon S3](/admin/github-actions/enabling-github-actions-with-amazon-s3-storage)
