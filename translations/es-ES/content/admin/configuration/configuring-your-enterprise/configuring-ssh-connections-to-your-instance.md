...
intro: 'Puedes aumentar la seguridad de {% data variables.product.product_location %} configurando los algoritmos SSH que los clientes pueden usar para establecer una conexión.'
