...
| `config_entry.destroy` | A configuration setting was deleted. These events are only visible in the site admin audit log. El tipo de eventos registrado se relaciona con:</br>- Políticas y ajustes de empresa</br>- Permisos y ajustes de repositorio y organización</br>- Git, LFS de Git, {% data variables.product.prodname_github_connect %}, {% data variables.product.prodname_registry %}, proyecto, y ajustes de seguridad de código. |
| `config_entry.update`  | A configuration setting was edited. These events are only visible in the site admin audit log. El tipo de eventos registrado se relaciona con:</br>- Políticas y ajustes de empresa</br>- Permisos y ajustes de repositorio y organización</br>- Git, LFS de Git, {% data variables.product.prodname_github_connect %}, {% data variables.product.prodname_registry %}, proyecto, y ajustes de seguridad de código.  |
{%- endif %}
