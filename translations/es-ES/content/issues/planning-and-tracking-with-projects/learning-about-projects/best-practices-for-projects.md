...
{% data variables.product.prodname_projects_v2 %} ofrece flujos de trabajo integrados. Por ejemplo, cuando se cierra una propuesta, puedes configurar el estado automáticamente a "Hecho".
