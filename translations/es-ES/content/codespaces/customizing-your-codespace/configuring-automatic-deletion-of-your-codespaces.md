...
intro: "Los codespaces sin usar se eliminan automáticamente. Puedes elegir cuánto tiempo se conservan los codespaces detenidos, hasta un máximo de 30\_días."
...
Sin embargo, dado que {% data variables.product.prodname_codespaces %} incurren en cargos de almacenamiento, es posible que prefieras reducir el período de retención cambiando el período predeterminado en la configuración personal para {% data variables.product.prodname_github_codespaces %}. Para obtener más información sobre los cargos de almacenamiento, consulta "[Acerca de la facturación de {% data variables.product.prodname_github_codespaces %}](/billing/managing-billing-for-github-codespaces/about-billing-for-github-codespaces#codespaces-pricing)".
