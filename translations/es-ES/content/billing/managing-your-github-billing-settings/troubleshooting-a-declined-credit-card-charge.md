...
Si tu tarjeta está vencida, tendrás que actualizar la información de pago de tu cuenta. Para más información, vea "[Adición o edición de un método de pago](/articles/adding-or-editing-a-payment-method)".
...
También admitimos pagos por PayPal. Para más información, vea "[Adición o edición de un método de pago](/articles/adding-or-editing-a-payment-method)".
...
- **La cantidad que se le va a cobrar.** El importe de la suscripción aparece en los recibos de la cuenta. Para más información, vea "[Visualización del historial de pagos y los recibos](/articles/viewing-your-payment-history-and-receipts)".
- **Fecha de facturación de {% data variables.product.product_name %}.** La fecha de facturación de la cuenta aparece en los recibos.
- **Número de identificador de la transacción.** El identificador de transacción de la cuenta aparece en los recibos.
- **Nombre del comerciante.** El nombre del comerciante es {% data variables.product.prodname_dotcom %}.
- **Mensaje de error enviado por el banco con el cargo rechazado.** Puede encontrar el mensaje de error del banco en el correo electrónico que le enviamos cuando se rechaza un cargo.
