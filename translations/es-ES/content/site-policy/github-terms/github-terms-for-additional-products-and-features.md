...
- usar programas de ejecución alojados en GitHub o realizar cualquier otra actividad no relacionada con la producción, prueba, implementación o publicación del proyecto de software asociado con el repositorio donde se usa GitHub Actions.
...
Solo puede acceder a GitHub Actions y utilizarlo para desarrollar y probar sus aplicaciones. Solo un usuario con licencia puede acceder a una máquina virtual proporcionada por Actions en cualquier momento.

*Desarrollador Autorizado*

Usted designa a GitHub como desarrollador autorizado con respecto al software de Apple incluido en Actions. GitHub es responsable de cumplir los términos de cualquier software incluido en Actions y mantendrá la confidencialidad de cualquier información confidencial de Apple a la que se acceda como parte de Actions.
...
GitHub Pages está sujeto a algunos límites de uso y ancho de banda específicos, y es posible que no sea apropiado para usos en los que el ancho de banda es alto. Consulte nuestros [Límites de GitHub Pages](/github/working-with-github-pages/about-github-pages) para obtener más información. 
