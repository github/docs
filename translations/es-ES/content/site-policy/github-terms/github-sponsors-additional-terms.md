...
* Debes tener una cuenta de GitHub, ser aceptado en el programa como un individuo, y contribuir activamente al OSS. Toma en cuenta que GitHub no permite operar más de una cuenta personal gratuita. De esta manera, la elegibilidad está disponible de manera individual y no se aprobará en cuentas múltiples de la misma persona.
