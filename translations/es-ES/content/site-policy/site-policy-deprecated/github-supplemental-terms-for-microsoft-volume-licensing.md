...
##  <a name="section-1-github-enterprise-server-license-terms"></a>SECCIÓN 1: TÉRMINOS DE LA LICENCIA DE GITHUB ENTERPRISE SERVER

La presente Sección 1 detalla los términos aplicables al uso del Software por parte del Cliente.

### <a name="11-license-grant"></a>1.1 Concesión de licencias.
...
### <a name="12-restrictions"></a>1.2 Restricciones.
...
### <a name="14-verification"></a>1.4 Comprobación.
...
### <a name="15-support"></a>1.5 Soporte
...
### <a name="16-updates-releases"></a>1.6 Actualizaciones; Versiones.

#### <a name="161-generally"></a>1.6.1 Regla general.
...
#### <a name="162-supported-releases"></a>1.6.2 Versiones compatibles.
...
### <a name="17-add-on-software"></a>1.7 Software complementario.
...
### <a name="18-data-protection-considerations-for-use-of-github-insights-and-learning-lab-for-enterprise-server"></a>1.8 Consideraciones sobre la protección de datos para el uso de GitHub Insights and Learning Lab for Enterprise Server.
...
### <a name="19-limited-software-warranty"></a>1.9 Garantía de software limitada.
...
## <a name="section-2-github-enterprise-cloud-terms-of-service"></a>SECCIÓN 2: TÉRMINOS DEL SERVICIO DE GITHUB ENTERPRISE CLOUD
...
### <a name="21-account-terms"></a>2.1 Términos de la cuenta.

#### <a name="211-account-controls"></a>2.1.1 Controles de la cuenta.
...
#### <a name="212-account-requirements"></a>2.1.2 Requisitos de la cuenta.
...
#### <a name="213-account-security"></a>2.1.3 Seguridad de la cuenta.
...
#### <a name="214-additional-terms"></a>2.1.4 Términos adicionales.
...
#### <a name="215-us-federal-government-terms"></a>2.1.5. Términos del Gobierno Federal de EE. UU.
...
### <a name="22-compliance-with-laws-acceptable-use-privacy"></a>2.2 Cumplimiento de las leyes; Uso aceptable; Privacidad.

#### <a name="221-compliance-with-laws-and-regulations"></a>2.2.1. Cumplimiento de las leyes y normativas.
...
#### <a name="222-acceptable-use"></a>2.2.2 Uso aceptable.
...
#### <a name="223-privacy"></a>2.2.3 Privacidad.
...
### <a name="23-content-responsibility-ownership-license-rights"></a>2.3 Responsabilidad respecto al Contenido; Propiedad; Derechos de licencia.

#### <a name="231-responsibility-for-user-generated-content"></a>2.3.1 Responsabilidad respecto al Contenido generado por el usuario.
...
#### <a name="232-ownership-of-content-right-to-post-and-license-grants"></a>2.3.2 Propiedad del contenido, Derecho de publicación y Concesión de licencias.
...
#### <a name="233-license-grant-to-github"></a>2.3.3 Concesión de licencias a GitHub.
...
#### <a name="234-license-grant-to-external-users"></a>2.3.4. Concesión de licencias a Usuarios externos.
...
#### <a name="235-contributions-under-repository-license"></a>2.3.5. Contribuciones en virtud de una Licencia de repositorio.
...
#### <a name="236-moral-rights"></a>2.3.6 Derechos morales.
...
### <a name="24-private-repositories"></a>2.4 Repositorios privados.

#### <a name="241-control"></a>2.4.1 Control.
...
#### <a name="242-confidentiality"></a>2.4.2 Confidencialidad.
...
#### <a name="243-access"></a>2.4.3 Acceso.
...
#### <a name="244-exclusions"></a>2.4.4 Exclusiones.
...
### <a name="25-intellectual-property-notices"></a>2.5. Avisos de propiedad intelectual e industrial.

#### <a name="251-githubs-rights-to-content"></a>2.5.1. Derechos de GitHub sobre el Contenido.
...
#### <a name="252-copyright-infringement-and-dmca-policy"></a>2.5.2 Infracción de derechos de propiedad intelectual y Directiva de DMCA.
...
#### <a name="253-github-trademarks-and-logos"></a>2.5.3 Marcas comerciales y logotipos de GitHub.
...
### <a name="26-suspension"></a>2.6 Suspensión.
...
### <a name="27-communications-with-github"></a>2.7 Comunicaciones con GitHub.
...
### <a name="28-service-level-agreement"></a>2.8 Acuerdo de Nivel de Servicio.
...
### <a name="29-service-changes"></a>2.9 Cambios en el servicio.
...
### <a name="210-additional-service-features"></a>2.10 Características adicionales del servicio.
...
## <a name="section-3-general-provisions"></a>SECCIÓN 3: DISPOSICIONES GENERALES.
...
### <a name="31-term-termination-effect-of-termination"></a>3.1 Periodo; Terminación; Efecto de la terminación.

#### <a name="311-term"></a>3.1.1 Vigencia.
...
#### <a name="312-termination-for-convenience-account-cancellation"></a>3.1.2 Terminación por conveniencia; Cancelación de la cuenta.
...
#### <a name="313-termination-for-material-breach"></a>3.1.3. Terminación por incumplimiento sustancial.
...
#### <a name="314-effect-of-termination"></a>3.1.4 Efecto de la terminación.
...
### <a name="32-feedback"></a>3.2 Comentarios.
...
### <a name="33-compliance-with-laws-and-regulations"></a>3.3. Cumplimiento de las leyes y normativas.
...
### <a name="34-order-of-precedence"></a>3.4 Orden de precedencia
