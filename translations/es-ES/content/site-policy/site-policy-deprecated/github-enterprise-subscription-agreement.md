...
## <a name="section-1-general-terms-and-conditions"></a>SECCIÓN 1: TÉRMINOS Y CONDICIONES GENERALES
...
### <a name="11-term-and-termination"></a>1.1 Periodo y terminación.

#### <a name="111-term"></a>1.1.1 Periodo.
...
#### <a name="112-termination-for-convenience-account-cancellation"></a>1.1.2 Terminación por conveniencia. Cancelación de la cuenta.
...
#### <a name="113-termination-for-material-breach"></a>1.1.3. Terminación por incumplimiento sustancial.
...
#### <a name="114-effect-of-termination-survival"></a>1.1.4 Efecto de la terminación; Subsistencia.
...
### <a name="12-payment"></a>1.2 Pago.

#### <a name="121-fees"></a>1.2.1 Tarifas.
...
#### <a name="122-purchasing-additional-subscription-licenses"></a>1.2.2. Compra de licencias de suscripción adicionales.
...
#### <a name="123-add-on-software"></a>1.2.3 Software complementario.
...
### <a name="13-professional-services"></a>1.3 Servicios profesionales.
...
### <a name="14-confidentiality"></a>1.4 Confidencialidad.
...
### <a name="15-defense-of-claims"></a>1.5 Defensa frente a reclamaciones.
...
### <a name="16-representations-and-warranties-disclaimer-limitations-of-liability"></a>1.6 Representaciones y Garantías; Descargo de responsabilidades; Limitaciones de responsabilidad.

#### <a name="161-general-warranty"></a>1.6.1 Garantía general.
...
#### <a name="162-limited-warranties"></a>1.6.2 Garantías limitadas.
...
#### <a name="163--disclaimer"></a>1.6.3 Descargo de responsabilidades.
...
#### <a name="164-limitations-of-liability"></a>1.6.4 Limitación de responsabilidad.
...
### <a name="17-subscription-licenses"></a>1.7 Licencias de suscripción.
...
### <a name="18-affiliates"></a>1.8 Filiales.
...
#### <a name="192-enhanced-support-offerings"></a>1.9.2 Ofertas de soporte optimizado.
...
#### <a name="193-exclusions"></a>1.9.3 Exclusiones.
...
### <a name="110-intellectual-property-rights"></a>1.10 Derechos de propiedad intelectual.
...
### <a name="111-feedback"></a>1.11 Comentarios.
...
### <a name="112-compliance-with-laws-and-regulations"></a>1.12. Cumplimiento de leyes y normativas.
...
### <a name="113-general-provisions"></a>1.13 Disposiciones generales.

#### <a name="1131-governing-law-venue"></a>1.13.1 Legislación aplicable; Jurisdicción.
...
#### <a name="1132-us-government-users"></a>1.13.2 Usuarios del Gobierno de los EE. UU.
...
#### <a name="1133-export"></a>1.13.3 Exportación.
...
#### <a name="1134-no-publicity-without-permission"></a>1.13.4 Prohibición de hacer publicidad sin permiso.
...
#### <a name="1135-assignment"></a>1.13.5 Cesión.
...
#### <a name="1136-notices"></a>1.13.6. Notificaciones.
...
#### <a name="1137-force-majeure"></a>1.13.7 Fuerza Mayor.
...
#### <a name="1138-independent-contractors"></a>1.13.8 Contratistas independientes.
...
#### <a name="1139-waiver"></a>1.13.9 Renuncia.
...
#### <a name="11310-entire-agreement"></a>1.13.10 Contrato completo.
...
#### <a name="11311-amendments-order-of-precedence"></a>1.13.11 Modificaciones; Orden de precedencia.
...
#### <a name="11312-severability"></a>1.13.12 Divisibilidad.
...
## <a name="section-2-github-enterprise-server-license-terms"></a>SECCIÓN 2: TÉRMINOS DE LA LICENCIA DE GITHUB ENTERPRISE SERVER

La presente Sección 2 detalla los términos aplicables al uso del Software por parte del Cliente.

### <a name="21-license-grant"></a>2.1 Concesión de licencias.
...
### <a name="22-license-restrictions"></a>2.2 Restricciones de la licencia.
...
### <a name="24-verification"></a>2.4 Comprobación.
...
### <a name="25-updates-releases"></a>2.5 Actualizaciones; Versiones.

#### <a name="251-generally"></a>2.5.1 Regla general.
...
#### <a name="252-supported-releases"></a>2.5.2 Versiones compatibles.
...
### <a name="26-data-protection-considerations-for-use-of-github-insights-and-learning-lab-for-enterprise-server"></a>2.6 Consideraciones sobre la protección de datos para el uso de GitHub Insights and Learning Lab for Enterprise Server.
...
### <a name="section-3-github-enterprise-cloud-terms-of-service"></a>SECCIÓN 3: TÉRMINOS DEL SERVICIO DE GITHUB ENTERPRISE CLOUD
...
### <a name="31-account-terms"></a>3.1 Términos de la cuenta.

#### <a name="311-account-controls"></a>3.1.1 Controles de la cuenta.
...
#### <a name="312-account-requirements"></a>3.1.2 Requisitos de la cuenta.
...
#### <a name="313-account-security"></a>3.1.3 Seguridad de la cuenta.
...
#### <a name="314-additional-terms"></a>3.1.4 Términos adicionales.
...
#### <a name="315-us-federal-government-terms"></a>3.1.5. Términos del Gobierno Federal de EE. UU.
...
### <a name="32-compliance-with-laws-acceptable-use-privacy"></a>3.2 Cumplimiento de las leyes; Uso aceptable; Privacidad.

#### <a name="321-compliance-with-laws-and-regulations"></a>3.2.1. Cumplimiento de las leyes y normativas.
...
#### <a name="322-acceptable-use"></a>3.2.2 Uso aceptable.
...
#### <a name="323-privacy"></a>3.2.3 Privacidad.
...
### <a name="33-content-responsibility-ownership-license-rights"></a>3.3 Responsabilidad respecto al Contenido; Propiedad; Derechos de Licencia.

#### <a name="331-responsibility-for-user-generated-content"></a>3.3.1. Responsabilidad respecto al Contenido generado por el usuario.
...
#### <a name="332-ownership-of-content-right-to-post-and-license-grants"></a>3.3.2. Propiedad del Contenido, Derecho de publicación y Concesión de licencias.
...
#### <a name="333-license-grant-to-github"></a>3.3.3 Concesión de licencias a GitHub.
...
#### <a name="334-license-grant-to-external-users"></a>3.3.4. Concesión de licencias a Usuarios externos.
...
#### <a name="335-contributions-under-repository-license"></a>3.3.5. Contribuciones en virtud de una Licencia de repositorio.
...
#### <a name="336-moral-rights"></a>3.3.6 Derechos morales.
...
### <a name="34-private-repositories"></a>3.4. Repositorios privados.

#### <a name="341-control"></a>3.4.1 Control.
...
#### <a name="342-confidentiality"></a>3.4.2 Confidencialidad.
...
#### <a name="343-access"></a>3.4.3 Acceso.
...
### <a name="35-intellectual-property-notices"></a>3.5. Avisos de propiedad intelectual e industrial.

#### <a name="351-githubs-rights-to-content"></a>3.5.1. Derechos de GitHub sobre el Contenido.
...
#### <a name="352-copyright-infringement-and-dmca-policy"></a>3.5.2 Infracción de derechos de propiedad intelectual y Directiva de DMCA.
...
#### <a name="353-github-trademarks-and-logos"></a>3.5.3 Marcas comerciales y logotipos de GitHub.
...
### <a name="36-suspension"></a>3.6 Suspensión.
...
### <a name="37-service-level-agreement"></a>3.7 Acuerdo de Nivel de Servicio.
...
### <a name="38-service-changes"></a>3.8 Cambios en el servicio.
...
### <a name="39-additional-service-features"></a>3.9 Características adicionales del servicio.
...
## <a name="exhibit-a-definitions"></a>ANEXO A: DEFINICIONES
