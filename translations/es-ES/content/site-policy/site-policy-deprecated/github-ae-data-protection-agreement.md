...
## <a name="github-data-protection-agreement"></a>ACUERDO DE PROTECCIÓN DE DATOS DE GITHUB
...
## <a name="2-status-and-compliance"></a>2. Estado y cumplimiento.

#### <a name="21-data-processing"></a>2.1 Procesamiento de Datos.
...
#### <a name="22-data-controllers"></a>2.2 Controladores de Datos.
...
#### <a name="23-github-compliance-data-transfers"></a>2.3 Cumplimiento de GitHub; Transferencias de Datos.
...
#### <a name="24-data-subject-rights-assistance-with-requests"></a>2.4 Derechos del Interesado; Asistencia con las Solicitudes.
...
### <a name="3-data-protection"></a>3. Protección de Datos.

#### <a name="31-purpose-limitation"></a>3.1 Limitación de Finalidad.
...
#### <a name="32-data-quality-and-proportionality"></a>3.2 Calidad y Proporcionalidad de los Datos.
...
#### <a name="33-data-retention-and-deletion"></a>3.3 Retención y Eliminación de Datos.
...
#### <a name="34-data-processing"></a>3.4 Procesamiento de Datos.
...
### <a name="4-security-and-audit-obligations"></a>4. Seguridad y obligaciones de auditoría.

#### <a name="41-technical-and-organizational-security-measures"></a>4.1 Medidas de Seguridad Técnicas y Organizativas.
...
#### <a name="42-incident-response-and-breach-notification"></a>4.2 Respuesta a Incidentes y Notificación de Filtración.
...
#### <a name="43-github-personnel"></a>4.3 Personal de GitHub.
...
#### <a name="45-compliance-reporting"></a>4.5 Informes de Cumplimiento.
...
#### <a name="46-assistance"></a>4.6 Asistencia.
...
### <a name="5-use-and-disclosure-of-protected-data"></a>5. Uso y divulgación de Datos Protegidos.
...
### <a name="6-subprocessing-and-onward-transfer"></a>6. Subprocesamiento y Transferencia Posterior.

#### <a name="61-protection-of-data"></a>6.1 Protección de los Datos.
...
#### <a name="62-acceptance-of-github-subprocessors"></a>6.2 Aceptación de los Subprocesadores de GitHub.
...
#### <a name="63-general-consent-for-onward-subprocessing"></a>6.3 Consentimiento General para el Subprocesamiento Posterior.
...
#### <a name="64-disclosure-of-subprocessor-agreements"></a>6.4 Divulgación de los Acuerdos de los Subprocesadores.
...
#### <a name="65-objection-to-subprocessors"></a>6.5 Objeción a los Subprocesadores.
...
### <a name="7-termination"></a>7. Terminación.

#### <a name="71-suspension"></a>7.1 Suspensión.
...
#### <a name="72-termination-with-cause"></a>7.2 Terminación con Causa.
...
#### <a name="75-notification"></a>7.5 Notificación.
...
#### <a name="76-modifications"></a>7.6 Modificaciones.
...
#### <a name="77-termination-requirements"></a>7.7 Requisitos de la Terminación.
...
### <a name="8-liability-for-data-processing"></a>8. Responsabilidad por el Procesamiento de Datos.

#### <a name="81-limitations"></a>8.1 Limitaciones.
...
## <a name="attachment-1--the-standard-contractual-clauses-processors"></a>Adjunto 1 – Cláusulas Contractuales Tipo (Procesadores)
...
### <a name="appendix-1-to-the-standard-contractual-clauses"></a>Apéndice 1 para las Cláusulas Contractuales Tipo
...
### <a name="appendix-2-to-the-standard-contractual-clauses"></a>Apéndice 2 para las Cláusulas Contractuales Tipo
...
## <a name="security-exhibit"></a>ANEXO DE SEGURIDAD

### <a name="1-information-security-program"></a>1. Programa de seguridad de la información.

#### <a name="11-security-management"></a>1.1 Administración de la seguridad.
...
#### <a name="12-security-incident-management"></a>1.2 Administración de Incidentes de Seguridad.
...
#### <a name="13-due-diligence-over-subcontractors-and-vendors"></a>1.3 Cuidado Adecuado sobre los Subcontratistas y Proveedores.
...
#### <a name="14-physical-and-environmental-safeguards"></a>1.4 Salvaguardas Físicas y Ambientales.
...
#### <a name="2-requests-for-information"></a>2 Solicitudes de Información.
...
#### <a name="3-cooperation-with-regulatory-audits"></a>3. Cooperación con las Auditorías Reglamentarias.
