...
1. Haga clic en **New repository secret** (Nuevo secreto de repositorio).
...
1. Haga clic en **New organization secret** (Nuevo secreto de organización).
1. Escriba un nombre para su secreto en el cuadro de entrada **Name**.
