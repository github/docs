...
{% data reusables.security-advisory.disclosing-vulnerabilities %} Para obtener más información, consulta la sección "[Acerca de la divulgación coordinada de las vulnerabilidades de seguridad](/code-security/repository-security-advisories/about-coordinated-disclosure-of-security-vulnerabilities)".
