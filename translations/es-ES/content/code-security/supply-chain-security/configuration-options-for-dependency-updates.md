...
Utiliza la opción `allow` para personalizar qué dependencias se actualizan. This applies to both version and security updates. Puedes utilizar las siguientes opciones:
