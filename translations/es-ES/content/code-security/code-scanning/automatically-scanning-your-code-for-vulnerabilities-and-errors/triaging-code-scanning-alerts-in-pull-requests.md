...
{% ifversion fpt or ghec or ghes > 3.4 or ghae-issue-6249 %} ![ Descripción y vínculo de la alerta para mostrar más información](/assets/images/help/repository/code-scanning-pr-alert.png) {% else %} ![Descripción y vínculo de la alerta para mostrar más información](/assets/images/enterprise/3.4/repository/code-scanning-pr-alert.png) {% endif %}
