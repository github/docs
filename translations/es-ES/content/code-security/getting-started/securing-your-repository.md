...
- Para cambiar quién puede ver el repositorio, haga clic en **Change visibility**. Para obtener más información, consulte "[Configuración de la visibilidad del repositorio](/github/administering-a-repository/setting-repository-visibility)".{% ifversion fpt or ghec or ghes > 3.3 or ghae-issue-5974 %}
