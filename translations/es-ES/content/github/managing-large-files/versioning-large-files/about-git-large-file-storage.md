...
| {% data variables.product.prodname_ghe_cloud %} | 5 GB |{% else %}
 Al utilizar {% data variables.large_files.product_name_short %}, puedes almacenar los archivos de hasta {% if currentVersion ver_lt "enterprise-server@2.21" %}{% data variables.large_files.max_lfs_size %}{% else %}5 GB{% endif %} en tu repositorio.
{% endif %}
