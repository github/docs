...
8. Da clic en
{% octicon "clippy" aria-label="The copy to clipboard icon" %} para copiar el token a tu portapapeles. Por razones de seguridad, después de navegar fuera de la págna, no podrás ver el token nuevamente.
