...
- Repositorio {% data reusables.notifications-v2.custom-notification-types %} (en caso de que estén habilitadas). {% elsif currentVersion == "github-ae@latest" or currentVersion ver_gt "enterprise-server@2.20" %}
