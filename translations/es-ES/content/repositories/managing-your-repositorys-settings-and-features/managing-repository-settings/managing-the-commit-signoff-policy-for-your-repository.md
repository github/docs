...
topics:
  - Repositories
shortTitle: Administrar la política de cierre de sesión en confirmaciones
---

## Acerca de los cierres de sesión en confirmaciones
...
1. Select **Require contributors to sign off on web-based commits**. ![Captura de requerir que los contribuyentes cierren sesión en las confirmaciones basadas en web](/assets/images/help/repository/require-signoffs.png)
