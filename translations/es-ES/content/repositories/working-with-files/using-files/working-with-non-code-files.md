...
Cuando se visualiza, cualquier archivo _.csv_ o _.tsv_ confirmado en un repositorio de {% ifversion ghae %}{% data variables.product.product_name %}{% else %}{% data variables.product.product_location %}{% endif %} se representa automáticamente como una tabla interactiva completa con encabezados y números de fila. Por defecto, siempre asumimos que la primera fila es tu fila de encabezados.
...
Al agregar archivos de cuaderno de Jupyter Notebook o IPython con una extensión *.ipynb* en {% data variables.product.product_location %}, se representarán como archivos HTML estáticos en el repositorio.
