...
intro: 'Puedes borrar un archivo individual{% ifversion fpt or ghes > 3.0 %} o un directorio completo{% endif %} en tu repositorio de {% data variables.product.product_name %}.'
redirect_from:
