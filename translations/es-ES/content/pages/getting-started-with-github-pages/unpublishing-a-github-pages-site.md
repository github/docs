...
3. Si tu fuente de publicación fue la rama `gh-pages`, {% if currentVersion == "free-pro-team@latest" %}pasa al paso 6{% else %}tu sitio ahora se dejó de publicar y puedes saltar al resto de los pasos{% endif %}.
