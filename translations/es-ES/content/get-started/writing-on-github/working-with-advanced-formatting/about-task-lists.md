...
ms.locfileid: '148159995'
---
{% ifversion projects-v2-tasklists %} {% note %}

**Nota:** Para obtener más información sobre la nueva iteración de listas de tareas, que se encuentra actualmente en una versión beta privada, consulta "[Acerca de las listas de tareas](/issues/tracking-your-work-with-issues/about-tasklists)".
