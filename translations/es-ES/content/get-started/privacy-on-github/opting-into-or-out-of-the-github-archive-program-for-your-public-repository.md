...
3. En "Características", seleccione o anule la selección de **Conservar este repositorio**.
    ![Casilla para permitir que {% data variables.product.prodname_dotcom %} incluya el código en {% data variables.product.prodname_archive %}](/assets/images/help/repository/github-archive-program-checkbox.png)

## Información adicional
- [Preguntas más frecuentes de {% data variables.product.prodname_archive %}](https://archiveprogram.github.com/faq/)
