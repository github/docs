...
| <kbd>control k</kbd> o <kbd>comando k</kbd>                                    | Inserta el formato Markdown para crear un enlace                                                                                                                                                                                                                                      |
| <kbd>control shift p</kbd> o <kbd>comando shift p</kbd>                        | Alterna entre las pestañas de comentarios de **Escritura** y **Vista previa **{% ifversion fpt or ghae-next or ghes > 3.2 %}
...
| <kbd>control shift .</kbd> o <kbd>command shift.</kbd>                         | Inserta formato de lenguaje de marcado para una cita{% endif %}{% ifversion fpt %}
