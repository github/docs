...
Puedes utilizar la paleta de comandos para buscar lo que sea en {% data variables.product.product_location %}.
...
|`Open in new codespace`|Crea y abre un codespace para este repositorio. Para más información, vea "[Creación de un codespace](/codespaces/developing-in-codespaces/creating-a-codespace)".|
...
|`Open in new codespace`|Crea y abre un codespace par ala rama de encabezado de la solicitud de cambios. Para más información, vea "[Creación de un codespace](/codespaces/developing-in-codespaces/creating-a-codespace)".
