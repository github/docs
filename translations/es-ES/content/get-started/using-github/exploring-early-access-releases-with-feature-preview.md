...
intro: 'Puedes usar la vista previa de las características para ver los productos o las características que están disponibles en beta, y para habilitar o deshabilitar cada característica de tu cuenta personal.'
redirect_from:
...
2. Opcionalmente, a la derecha de una característica, haz clic en **Habilitar** o **Deshabilitar**.
  ![Botón para habilitar la versión preliminar de característica](/assets/images/help/settings/enable-feature-button.png)
