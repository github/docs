...
Para obtener información sobre algunas características de formato avanzadas que te ayudarán a comunicarte, consulta "[Inicio rápido para escribir en {% data variables.product.prodname_dotcom %}](/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/quickstart-for-writing-on-github)".
