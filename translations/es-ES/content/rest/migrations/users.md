...
The Users migrations API is only available to authenticated account owners. Para obtener más información, consulta la sección "[Otros métodos de autenticación](/rest/overview/other-authentication-methods)".
