...
Al usar `GITHUB_TOKEN`, el límite de frecuencia es de 1000 solicitudes por hora y repositorio.{% ifversion fpt or ghec %} Para las solicitudes a recursos que pertenecen a una cuenta de empresa de {% data variables.product.product_location %}, se aplica el límite de frecuencia de {% data variables.product.prodname_ghe_cloud %} y es de 15 000 solicitudes por hora y repositorio.{% endif %}
