...
1. Dans la barre latérale gauche, cliquez sur {% ifversion fpt or ghec or ghes > 3.4 or ghae-issue-5658 %}{% octicon "play" aria-label="The {% data variables.product.prodname_actions %} icon" %} **Actions**, puis sur **Exécuteurs**.{% else %}**Actions**.{% ifversion ghes or ghae %}
