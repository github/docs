...
{% data reusables.repositories.request-security-advisory-cve-id %} Pour plus d’informations, consultez « [À propos des {% data variables.product.prodname_security_advisories %} pour les dépôts](/code-security/repository-security-advisories/about-github-security-advisories-for-repositories#cve-identification-numbers) ».
