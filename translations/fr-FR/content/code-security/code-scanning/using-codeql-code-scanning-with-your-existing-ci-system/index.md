---
title: Utilisation de l’analyse du code CodeQL avec votre système CI existant
shortTitle: Use CodeQL in CI system
intro: "Vous pouvez exécuter une analyse {% data variables.product.prodname_codeql %} dans votre système\_CI existant et charger les résultats sur {% data variables.product.product_name %} pour les afficher sous la forme d’alertes d’{% data variables.product.prodname_code_scanning %}."
