---
title: Utilisation des avis de sécurité globaux de la base de données GitHub Advisory
shortTitle: Global security advisories
intro: 'Parcourez la {% data variables.product.prodname_advisory_database %} et envoyez des améliorations à n’importe quel avis de sécurité global.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
