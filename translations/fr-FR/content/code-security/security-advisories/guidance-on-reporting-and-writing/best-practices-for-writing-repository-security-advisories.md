...
{% data reusables.security-advisory.security-advisory-overview %} Pour plus d’informations, consultez « [À propos des avis de sécurité des référentiels](/code-security/repository-security-advisories/about-github-security-advisories-for-repositories). »
