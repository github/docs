...
intro: 'Intégrez la sécurité dans votre workflow {% data variables.product.prodname_dotcom %} avec des fonctionnalités permettant de conserver les secrets et les vulnérabilités hors de votre codebase{% ifversion not ghae %}, et de gérer votre chaîne d’approvisionnement logicielle{% endif %}.'
introLinks:
