...
intro: 'Vous pouvez changer le nom d’utilisateur de votre compte sur {% ifversion fpt or ghec %}{% data variables.product.prodname_dotcom_the_website %}{% elsif ghes %}{% data variables.product.product_location %} si votre instance utilise l’authentification intégrée{% endif %}.'
redirect_from:
...
## À propos des changements de nom d’utilisateur
