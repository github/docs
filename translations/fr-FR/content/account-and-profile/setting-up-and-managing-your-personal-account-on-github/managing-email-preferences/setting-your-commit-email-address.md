...
intro: 'Vous pouvez définir l’adresse e-mail qui est utilisée pour rédiger les validations sur {% data variables.product.product_location %} et sur votre ordinateur.'
redirect_from:
