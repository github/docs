...
**Avertissement** : Avant de convertir un utilisateur en organisation, gardez à l’esprit les points suivants :
...
3. [Transférez vos dépôts](/articles/transferring-a-repository) vers votre nouveau compte d’organisation.
