---
title: Votre compte et votre profil sur GitHub
shortTitle: Account and profile
intro: 'Optimiser {% data variables.product.product_name %} pour votre utilisation en ajustant les paramètres pour votre compte personnel, en personnalisant votre page de profil et en gérant les notifications que vous recevez pour l’activité sur {% data variables.product.prodname_dotcom %}.'
introLinks:
