---
title: Revue des modifications apportées dans les demandes de tirage
redirect_from:
...
intro: 'Une fois qu’une demande de tirage (pull request) a été ouverte, vous pouvez examiner l’ensemble des modifications proposées et en discuter.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
