---
title: Utilisation des duplications
intro: 'Les duplications (fork) sont souvent utilisées dans le développement open source sur {% data variables.product.product_name %}.'
redirect_from:
