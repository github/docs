---
title: Schéma public
intro: 'Téléchargez le schéma public pour l’API GraphQL {% data variables.product.prodname_dotcom %}.'
redirect_from:
  - /v4/public_schema
versions:
  fpt: '*'
...
ms.locfileid: '145066625'
---
Vous pouvez [effectuer une introspection](/graphql/guides/introduction-to-graphql#discovering-the-graphql-api) directement sur l’API GraphQL.

Vous pouvez également télécharger la dernière version du schéma public ici :
