---
title: Gestion de votre licence pour GitHub Enterprise
shortTitle: GitHub Enterprise license
intro: "{% data variables.product.prodname_enterprise %} comprend les deux options de déploiement\_: hébergé dans le cloud et auto-hébergé. Si vous hébergez une instance de {% data variables.product.prodname_ghe_server %}, vous devez déverrouiller l’instance avec un fichier de licence. Vous pouvez afficher, gérer et mettre à jour le fichier de licence."
redirect_from:
