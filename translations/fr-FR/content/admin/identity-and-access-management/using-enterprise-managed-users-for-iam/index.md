---
title: Utilisation d’Enterprise Managed Users pour IAM
shortTitle: Enterprise Managed Users
product: '{% data reusables.gated-features.emus %}'
intro: 'Vous pouvez gérer les identités et les accès avec votre fournisseur d’identité, et provisionner les comptes qui peuvent uniquement contribuer à votre entreprise.'
redirect_from:
