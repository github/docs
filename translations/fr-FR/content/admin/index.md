---
title: Documentation pour les administrateurs d’entreprise
shortTitle: Enterprise administrators
intro: 'Documentation et guides pour les administrateurs d’entreprise{% ifversion ghes %}, les administrateurs système,{% endif %} et les spécialistes de la sécurité qui {% ifversion ghes %}déploient, {% endif %}configurent{% ifversion ghes %}{% endif %} et gèrent {% data variables.product.product_name %}.'
redirect_from:
