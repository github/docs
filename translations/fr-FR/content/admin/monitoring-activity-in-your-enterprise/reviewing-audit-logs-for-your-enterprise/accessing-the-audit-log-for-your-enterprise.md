---
title: Accès au journal d’audit de votre entreprise
intro: Vous pouvez visualiser les actions agrégées de toutes les organisations dont est propriétaire un compte d’entreprise dans le journal d’audit de l’entreprise.
