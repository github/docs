---
title: Gestion de l’accès aux actions de GitHub.com
intro: 'Contrôle des actions sur {% data variables.product.prodname_dotcom_the_website %} et {% data variables.product.prodname_marketplace %} qui peuvent être utilisées dans votre entreprise.'
redirect_from:
