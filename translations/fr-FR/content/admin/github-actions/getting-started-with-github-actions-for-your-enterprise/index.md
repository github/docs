---
title: Bien démarrer avec GitHub Actions pour votre entreprise
intro: 'Découvrez comment adopter {% data variables.product.prodname_actions %} pour votre entreprise.'
versions:
  ghec: '*'
  ghes: '*'
  ghae: '*'
