---
title: Gestion de GitHub Packages pour votre entreprise
intro: 'Vous pouvez activer {% data variables.product.prodname_registry %} pour votre entreprise et gérer les paramètres de {% data variables.product.prodname_registry %} et les types empaquetés autorisés.'
redirect_from:
