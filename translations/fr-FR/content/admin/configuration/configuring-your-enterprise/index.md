...
intro: 'Une fois que {% data variables.product.product_name %} est opérationnel, vous pouvez configurer votre entreprise pour l’adapter aux besoins de votre organisation.'
redirect_from:
