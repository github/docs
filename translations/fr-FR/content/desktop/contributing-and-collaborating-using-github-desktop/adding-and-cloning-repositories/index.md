---
title: Ajout et clonage de dépôts
intro: 'Ajoutez des dépôts existants de votre ordinateur local dans {% data variables.product.prodname_desktop %}, ou clonez des dépôts depuis {% data variables.product.product_name %}.'
redirect_from:
