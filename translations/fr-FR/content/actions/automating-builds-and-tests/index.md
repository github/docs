---
title: Automatisation des builds et des tests
shortTitle: Build and test
intro: 'Vous pouvez générer et tester automatiquement vos projets avec {% data variables.product.prodname_actions %}.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
