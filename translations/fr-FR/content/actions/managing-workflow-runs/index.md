---
title: Gestion des exécutions de workflow
shortTitle: Manage workflow runs
intro: 'Vous pouvez réexécuter ou annuler un workflow, {% ifversion fpt or ghes or ghae %}passer en revue des déploiements, {% endif %}voir les minutes d’exécution de travaux facturables et télécharger des artefacts.'
redirect_from:
