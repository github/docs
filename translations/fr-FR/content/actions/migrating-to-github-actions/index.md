---
title: Migration vers GitHub Actions
shortTitle: Migrate to GitHub Actions
intro: 'Découvrez comment faire migrer vos workflows CI/CD existants vers {% data variables.product.prodname_actions %}.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
