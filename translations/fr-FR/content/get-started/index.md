---
title: Bien démarrer avec GitHub
shortTitle: Get started
intro: 'Découvrez comment commencer à créer, à livrer et à gérer des logiciels avec {% data variables.product.prodname_dotcom %}. Explorez nos produits, inscrivez-vous pour obtenir un compte et connectez-vous à la plus grande communauté de développement du monde.'
redirect_from:
