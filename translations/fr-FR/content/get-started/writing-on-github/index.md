...
intro: 'Vous pouvez structurer les informations partagées sur {% data variables.product.product_name %} avec différentes options de mise en forme.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
