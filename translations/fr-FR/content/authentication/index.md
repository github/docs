...
intro: "Préservez la sécurité de votre compte et de vos données avec des fonctionnalités comme {% ifversion not ghae %}l’authentification à 2\_facteurs, {% endif %}SSH{% ifversion not ghae %}{% endif %} et la vérification des signatures de commit."
redirect_from:
