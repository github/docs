---
title: Référencer une application dans GitHub Marketplace
intro: 'Découvrez les conditions et les bonnes pratiques de référencement de votre application sur {% data variables.product.prodname_marketplace %}.'
redirect_from:
