---
title: Documentation GitHub Discussions
shortTitle: GitHub Discussions
intro: '{% data variables.product.prodname_discussions %} est un forum de communication collaboratif pour la communauté autour d’un projet{% ifversion fpt or ghec %} open source ou{% endif %} interne. Les membres de la communauté peuvent poser des questions et y répondre, partager des nouveautés, avoir des conversations ouvertes et suivre les décisions qui affectent le mode de travail de la communauté.'
introLinks:
