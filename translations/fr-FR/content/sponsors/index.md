---
title: Documentation sur les sponsors GitHub
shortTitle: GitHub Sponsors
intro: 'Investissez dans les projets open source dont vous dépendez, soutenez l’infrastructure numérique et rendez les carrières open source possibles en parrainant des contributeurs open source et leurs projets. Générez un profil {% data variables.product.prodname_sponsors %} et recevez une compensation pour votre travail open source.'
introLinks:
