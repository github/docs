...
ms.locfileid: '147064297'
---
## À propos de l’API Feeds

Pour voir les flux qui sont disponibles, utilisez l’opération [Get feeds](#get-feeds). Vous pouvez ensuite obtenir un flux en envoyant une demande à l’une des URL de flux.

### Exemple d’obtention d’un flux Atom

Pour obtenir un flux au format Atom, vous devez spécifier le type `application/atom+xml` dans l’en-tête `Accept`. Par exemple, pour obtenir le flux Atom des avis de sécurité GitHub :
