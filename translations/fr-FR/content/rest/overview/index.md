...
shortTitle: Overview
intro: 'Découvrez les ressources, les bibliothèques, les préversions et la résolution des problèmes pour l’API REST de {% data variables.product.prodname_dotcom %}.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
