---
title: Points de terminaison disponibles pour les jetons d’accès personnels affinés
intro: 'Votre {% data variables.product.pat_v2 %} peut envoyer des requêtes aux points de terminaison REST suivants.'
versions:
  feature: pat-v2
