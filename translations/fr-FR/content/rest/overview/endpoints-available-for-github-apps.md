---
title: Points de terminaison disponibles pour les applications GitHub
intro: Votre application peut effectuer des requêtes vers les points d’accès REST suivants.
