---
title: Webhooks de dépôt
intro: Utilisez l’API REST pour créer et gérer des webhooks pour vos dépôts.
...
Si vous souhaitez configurer un seul webhook pour recevoir des événements de tous les dépôts de votre organisation, consultez la documentation de notre API REST pour les [Webhooks d’organisation](/rest/reference/orgs#webhooks).
