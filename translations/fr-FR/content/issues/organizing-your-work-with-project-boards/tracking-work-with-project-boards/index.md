---
title: 'Suivi de la progression dans vos {% data variables.product.prodname_projects_v1 %}'
shortTitle: 'Tracking {% data variables.product.prodname_projects_v1 %}'
intro: 'Découvrez comment suivre votre travail dans un {% data variables.projects.projects_v1_board %}'
versions:
  feature: projects-v1
topics:
  - Issues
