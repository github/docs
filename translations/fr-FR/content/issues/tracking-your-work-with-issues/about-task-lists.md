...
ms.locfileid: "146179510"
---
{% ifversion fpt or ghec %} {% note %}

**Remarque :** les listes de tâches améliorées sont actuellement en version bêta et sujettes à modification.
...
* « [Syntaxe de base pour l’écriture et la mise en forme](/articles/basic-writing-and-formatting-syntax) »{% ifversion code-scanning-task-lists %}
