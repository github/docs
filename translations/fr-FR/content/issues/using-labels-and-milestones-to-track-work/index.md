---
title: Utilisation d’étiquettes et de jalons pour le suivi du travail
shortTitle: Labels and milestones
intro: 'Utilisez des étiquettes et des jalons pour catégoriser et suivre le travail sur {% data variables.product.prodname_dotcom %}.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
...
ms.openlocfilehash: 5da559e68d6ed61d7ec6d9c82039a86ffd47d4f2
ms.sourcegitcommit: 5b1461b419dbef60ae9dbdf8e905a4df30fc91b7
ms.translationtype: HT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/10/2022
ms.locfileid: '147876995'
---
