...
If you live in a supported region, you can follow these instructions to submit your bank information by creating a Stripe Connect account. {% data reusables.sponsors.stripe-supported-regions %}
