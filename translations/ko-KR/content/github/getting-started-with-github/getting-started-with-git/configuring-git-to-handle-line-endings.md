...
On macOS, you simply pass `input` to the configuration. 예시:
...
On Windows, you simply pass `true` to the configuration. 예시:
...
On Linux, you simply pass `input` to the configuration. 예시:
