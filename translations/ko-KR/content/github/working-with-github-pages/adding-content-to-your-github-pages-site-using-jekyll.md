...
intro: 'You can add a new page or post to your Jekyll site on {{ site.data.variables.product.prodname_pages }}.'
...
Before you can add content to a Jekyll site on {{ site.data.variables.product.prodname_pages }}, you must create a Jekyll site. For more information, see "[Creating a {{ site.data.variables.product.prodname_pages }} site with Jekyll](/articles/creating-a-github-pages-site-with-jekyll)."
...
Your theme includes default layouts, includes, and stylesheets that will automatically be applied to new pages and posts on your site, but you can override any of these defaults. For more information, see "[About {{ site.data.variables.product.prodname_pages }} and Jekyll](/articles/about-github-pages-and-jekyll#themes)."
