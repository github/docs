...
Comparing release tags will show you changes to your repository since the last release. {% ifversion fpt or ghae or ghes %} For more information, see "[Comparing releases](/github/administering-a-repository/comparing-releases)."{% endif %}
