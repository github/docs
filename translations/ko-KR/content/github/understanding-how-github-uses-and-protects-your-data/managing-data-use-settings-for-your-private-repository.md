...
intro: 'To help {{ site.data.variables.product.product_name }} connect you to relevant tools, people, projects, and information, you can configure data use for your private repository.'
redirect_from:
...
- "[About {{ site.data.variables.product.prodname_dotcom }}'s use of your data](/articles/about-github-s-use-of-your-data)"
