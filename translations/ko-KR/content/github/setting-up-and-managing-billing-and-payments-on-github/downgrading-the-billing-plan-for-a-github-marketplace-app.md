...
intro: 'If you''d like to use a different billing plan, you can downgrade your {{ site.data.variables.product.prodname_marketplace }} app at any time.'
redirect_from:
...
When you downgrade an app, your subscription remains active until the end of your current billing cycle. The downgrade takes effect on your next billing date. For more information, see "[About billing for {{ site.data.variables.product.prodname_marketplace }}](/articles/about-billing-for-github-marketplace)."
...
- "[Canceling a {{ site.data.variables.product.prodname_marketplace }} app](/articles/canceling-a-github-marketplace-app/)"
