...
intro: '{{ site.data.variables.product.product_name }} offers free and paid products for every account. You can upgrade, downgrade, and view pending changes to your account''s subscription at any time.'
redirect_from:
