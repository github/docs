...
You aren't able to automatically rebase and merge on {{ site.data.variables.product.product_location }} when:
...
If you still want to rebase the commits but can't rebase and merge automatically on {{ site.data.variables.product.product_location }} you must:
...
Anyone with write permissions in the repository, can then [merge the changes](/articles/merging-a-pull-request/) using the rebase and merge button on {{ site.data.variables.product.product_location }}.
