...
#### GitHub App Manifest parameters
 ...
 | `redirect_url`        | `문자열`              | The full URL to redirect to after a user initiates the creation of a GitHub App from a manifest.{% ifversion fpt or ghae-next or ghes > 3.0 or ghec %}
