...
| 이름             | 유형    | 설명                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| -------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `client_id`    | `문자열` | **Required**. The client ID you received from GitHub when you {% if currentVersion == "free-pro-team@latest" %}[registered](https://github.com/settings/applications/new){% else %}registered{% endif %}.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `state`        | `문자열` | {{ site.data.reusables.apps.state_description }}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| 이름              | 유형    | 설명                                                                                                                                                                 |
| --------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `client_id`     | `문자열` | **Required.** The client ID you received from {{ site.data.variables.product.product_name }} for your {{ site.data.variables.product.prodname_github_app }}.     |
| `client_secret` | `문자열` | **Required.** The client secret you received from {{ site.data.variables.product.product_name }} for your {{ site.data.variables.product.prodname_github_app }}. |
...
| 이름          | 유형    | 설명                                                                                                         |
| ----------- | ----- | ---------------------------------------------------------------------------------------------------------- |
| `client_id` | `문자열` | **Required.** The client ID you received from {{ site.data.variables.product.product_name }} for your app. |
...
| `verification_uri` | `문자열`     | The verification URL where users need to enter the `user_code`: {{ site.data.variables.product.device_authorization_url }}.                                                                                                                                                                                                                                                                                                         |
...
| 이름            | 유형    | 설명                                                                                                                                                            |
| ------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `client_id`   | `문자열` | **Required.** The client ID you received from {{ site.data.variables.product.product_name }} for your {{ site.data.variables.product.prodname_oauth_app }}. |
| `device_code` | `문자열` | **Required.** The device verification code you received from the `POST {{ site.data.variables.product.oauth_host_code }}/login/device/code` request.          |
