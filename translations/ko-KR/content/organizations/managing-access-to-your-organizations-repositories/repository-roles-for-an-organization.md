...
{% elsif ghec or ghes > 3.4 or ghae-issue-6271 %} 사용자 지정 리포지토리 역할을 만들 수 있습니다. 자세한 내용은 “[조직의 사용자 지정 리포지토리 역할 관리](/organizations/managing-peoples-access-to-your-organization-with-roles/managing-custom-repository-roles-for-an-organization)”를 참조하세요.
{% endif %}
...
| 끌어오기 요청의 병합 가능성에 영향을 주는 검토 제출 | | | **✔️** | **✔️** | **✔️** |
...
| 승인 검토가 없는 경우에도 보호된 분기에서 끌어오기 요청 병합 | | | | | **✔️** |{% ifversion fpt or ghes > 3.4 or ghae-issue-6337 or ghec %}
...
| [리포지토리에서 {% data variables.product.prodname_secret_scanning %} 경고 보기](/github/administering-a-repository/managing-alerts-from-secret-scanning) | | | **✔️**{% ifversion not ghae %}<sup>[1]</sup>{% endif %} | **✔️**{% ifversion not ghae %}<sup>[1]</sup>{% endif %} | **✔️** |{% ifversion ghes or ghae or ghec %}<!--Not available for FPT-->
