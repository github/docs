---
title: Managing access to your organization's repositories(조직의 리포지토리에 대한 액세스 권한 관리)
intro: 조직 소유자는 조직의 리포지토리에 대한 개인 및 팀 액세스를 관리할 수 있습니다. 팀 유지 관리자도 팀의 리포지토리 액세스를 관리할 수 있습니다.
redirect_from:
