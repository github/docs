---
title: Audit logging
intro: '{{ site.data.variables.product.prodname_enterprise }} keeps logs of audited user, organization, repository, and system events. Logs are useful for debugging and internal and external compliance.'
redirect_from:
...
The support bundle includes system logs. For more information, see "[Providing data to {{ site.data.variables.product.prodname_dotcom }} Support](/enterprise/{{ currentVersion }}/admin/guides/enterprise-support/providing-data-to-github-support)."
