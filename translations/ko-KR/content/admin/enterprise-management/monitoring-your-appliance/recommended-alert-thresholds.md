...
| 심각도          | Threshold                               |
| ------------ | --------------------------------------- |
| **경고**       | Disk use exceeds 70% of total available |
...
| 심각도          | Threshold                                        |
| ------------ | ------------------------------------------------ |
| **경고**       | Fifteen minute load average exceeds 1x CPU cores |
...
| 심각도          | Threshold                                                 |
| ------------ | --------------------------------------------------------- |
| **경고**       | Sustained RSS usage exceeds 50% of total available memory |
