...
|             `이메일` | Account's primary email address                              |
|              `역할` | Whether the account is an admin or an ordinary user          |
...
|           `이메일` | Organization's primary email address                        |
...
|           `가시성` | Whether the repository is public or private                  |
