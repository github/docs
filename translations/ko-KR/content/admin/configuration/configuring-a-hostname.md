...
4. Type the hostname you'd like to set for {% data variables.product.product_location_enterprise %}. ![Field for setting a hostname](/assets/images/enterprise/management-console/hostname-field.png)
