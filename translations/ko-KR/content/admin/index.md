---
title: 엔터프라이즈 관리자 설명서
shortTitle: Enterprise administrators
intro: '{% ifversion ghes %}배포, {% endif %}구성{% ifversion ghes %},{% endif %}, 관리하는{% data variables.product.product_name %} 엔터프라이즈 관리자{% ifversion ghes %}, 시스템 관리자,{% endif %} 보안 전문가를 위한 설명서 및 가이드입니다.'
redirect_from:
