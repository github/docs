---
title: 개인 계정의 프로젝트 보드에 대한 액세스 관리
intro: 프로젝트 보드 소유자는 협력자를 추가 또는 제거하고 프로젝트 보드에 대한 사용 권한을 사용자 지정할 수 있습니다.
redirect_from:
