---
title: 개인 계정 리포지토리의 소유권 연속성 유지 관리
intro: 사용자 소유 리포지토리를 관리할 수 없는 경우 다른 사용자를 초대하여 관리할 수 있습니다.
versions:
  fpt: '*'
  ghec: '*'
topics:
...
6. 초대를 받은 사용자는 후속 사용자가 되기로 동의할 때까지 “보류 중”으로 나열됩니다.
