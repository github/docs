---
title: 프로필에서 기여 보기
intro: '{% data variables.product.product_name %} 프로필은 {% ifversion fpt or ghes or ghec %}고정된 리포지토리, 도전 과제 및{% endif %} 지난 1년 동안의 리포지토리 기여도 그래프를 표시합니다.'
redirect_from:
...
ms.locfileid: '148099197'
---
{% ifversion fpt or ghes or ghec %}기여 그래프 및 도전 과제는 퍼블릭 리포지토리의 작업을 보여 줍니다. {% endif %}익명화된 프라이빗 리포지토리의 작업에 대한 특정 세부 정보와 함께 {% ifversion fpt or ghes or ghec %}퍼블릭 및 {% endif %}프라이빗 리포지토리 둘 다의 작업을 표시하도록 선택할 수 있습니다. 자세한 내용은 “[프로필에서 개인 기여 공개 또는 숨기기](/articles/publicizing-or-hiding-your-private-contributions-on-your-profile)”를 참조하세요.
...
## {% data variables.product.prodname_dotcom_the_website %}에서 {% data variables.product.prodname_enterprise %}의 기여 보기

{% ifversion fpt 또는 ghec %}{% data variables.product.prodname_ghe_server %}{% ifversion ghae %} 또는 {% data variables.product.prodname_ghe_managed %}{% endif %}{% else %}{% data variables.product.product_name %}{% endif %}을(를) 사용하고 엔터프라이즈 소유자가 {% 데이터 variables.enterprise.prodname_unified_contributions %}을(를) 사용하도록 설정하면 엔터프라이즈 기여 횟수를 {% 데이터 variables.product.prodname_dotcom_the_website %} 프로필로 보낼 수 있습니다. 자세한 내용은 “[{% data variables.product.prodname_dotcom_the_website %} 프로필에 엔터프라이즈 기여 보내기](/account-and-profile/setting-up-and-managing-your-github-profile/managing-contribution-graphs-on-your-profile/sending-enterprise-contributions-to-your-githubcom-profile)”를 참조하세요.
