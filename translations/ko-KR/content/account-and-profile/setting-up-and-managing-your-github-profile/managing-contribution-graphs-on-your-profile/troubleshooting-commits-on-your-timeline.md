...
ms.locfileid: "145090026"
---
## <a name="expected-behavior-to-view-commit-details"></a>커밋 세부 정보를 볼 수 있는 예상 동작
...
## <a name="missing-commit-details-from-commits-in-your-timeline"></a>타임라인의 커밋에서 커밋 세부 정보가 누락됨
...
## <a name="how-github-uses-the-git-author-date-and-commit-date"></a>GitHub에서 Git 작성자 날짜 및 커밋 날짜를 사용하는 방법
...
## <a name="viewing-missing-commit-details-from-commits-in-your-timeline"></a>타임라인의 커밋에서 누락된 커밋 세부 정보 보기
...
## <a name="expected-commits-missing-in-your-timeline"></a>기대한 커밋이 타임라인에 없음
