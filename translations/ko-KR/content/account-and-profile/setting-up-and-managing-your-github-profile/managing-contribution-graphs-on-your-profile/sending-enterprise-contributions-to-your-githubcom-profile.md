...
ms.locfileid: "145090035"
---
## <a name="about-enterprise-contributions-on-your--data-variablesproductprodname_dotcom_the_website--profile"></a>{% data variables.product.prodname_dotcom_the_website %} 프로필의 엔터프라이즈 기여 정보
...
## <a name="sending-your-enterprise-contributions-to-your--data-variablesproductprodname_dotcom_the_website--profile"></a>{% data variables.product.prodname_dotcom_the_website %} 프로필에 엔터프라이즈 기여 보내기
