...
**참고**: 
  ...
  -  {% data variables.product.prodname_emu_enterprise %}의 구성원인 경우 {% data variables.product.prodname_dotcom_the_website %}에서 메일 주소를 변경할 수 없습니다. {% data reusables.enterprise-accounts.emu-more-info-account %}
