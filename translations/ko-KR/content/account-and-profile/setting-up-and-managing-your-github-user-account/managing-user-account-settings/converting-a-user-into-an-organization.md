...
## <a name="keep-your-personal-account-and-create-a-new-organization-manually"></a>개인 계정 유지 및 새 조직 수동으로 만들기
...
3. 새 조직 계정으로 [리포지토리를 전송](/articles/transferring-a-repository)합니다.

## <a name="convert-your-personal-account-into-an-organization-automatically"></a>개인 계정을 조직으로 자동 변환
