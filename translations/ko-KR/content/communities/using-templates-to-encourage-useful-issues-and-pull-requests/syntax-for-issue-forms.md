...
| 키           | 설명                                                                                                         | 필수 사항 | 유형                              |
|:----------- |:---------------------------------------------------------------------------------------------------------- |:----- |:------------------------------- |
| `name`      | A name for the issue form template. Must be unique from all other templates, including Markdown templates. | 필수 사항 | 문자열                             |
| `설명`        | A description for the issue form template, which appears in the template chooser interface.                | 필수 사항 | 문자열                             |
| `본문`        | Definition of the input types in the form.                                                                 | 필수 사항 | Array                           |
| `assignees` | People who will be automatically assigned to issues created with this template.                            | 선택 사항 | Array or comma-delimited string |
| `labels`    | Labels that will automatically be added to issues created with this template.                              | 선택 사항 | 문자열                             |
| `title`     | A default title that will be pre-populated in the issue submission form.                                   | 선택 사항 | 문자열                             |
