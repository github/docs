...
| `저자`               | You created the thread.                                                                                                                                                                                    |
| `의견`               | You commented on the thread.                                                                                                                                                                               |
| `초대`               | You accepted an invitation to contribute to the repository.                                                                                                                                                |
| `manual`           | You subscribed to the thread (via an issue or pull request).                                                                                                                                               |
| `멘션`               | You were specifically **@mentioned** in the content.                                                                                                                                                       |
