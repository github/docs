...
ms.locfileid: '147064300'
---
## 피드 API 정보

사용할 수 있는 피드를 보려면 [피드 가져오기](#get-feeds) 작업을 사용합니다. 그런 다음 피드 URL 중 하나에 요청을 전송하면 피드를 가져올 수 있습니다.

### Atom 피드를 가져오는 예제

Atom 형식의 피드를 가져오려면 `Accept` 머리글에 `application/atom+xml` 형식을 지정해야 합니다. 예를 들어 GitHub 보안 권고에 대한 Atom 피드를 가져오려면 다음을 수행합니다.
