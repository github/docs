...
For more information about the tools and packages available on {% data variables.product.prodname_dotcom %}-hosted virtual environments, see "[Software installed on GitHub-hosted runners](/actions/reference/software-installed-on-github-hosted-runners)."
