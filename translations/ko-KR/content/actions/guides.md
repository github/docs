---
title: GitHub Actions에 대한 가이드
intro: '{% data variables.product.prodname_actions %}에 대한 이러한 가이드에는 워크플로를 구성하는 데 도움이 되는 특정 사용 사례 및 예제가 포함되어 있습니다.'
