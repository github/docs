---
title: Jekyll을 사용하여 GitHub Pages 사이트 설정
intro: '인기 있는 정적 사이트 생성기인 Jekyll을 사용하여 {% data variables.product.prodname_pages %} 사이트를 추가로 사용자 지정할 수 있습니다.'
redirect_from:
