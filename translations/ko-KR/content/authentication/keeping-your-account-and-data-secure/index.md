---
title: 계정 및 데이터 보안 유지
intro: '개인 정보를 보호하려면 {% ifversion ghae %}{% data variables.product.product_name %}{% else %}{% data variables.location.product_location %}{% endif %} 및 연결된 모든 데이터를 안전하게 유지해야 합니다.'
redirect_from:
