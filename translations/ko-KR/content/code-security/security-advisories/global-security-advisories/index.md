---
title: GitHub Advisory Database의 글로벌 보안 권고 작업
shortTitle: Global security advisories
intro: '{% data variables.product.prodname_advisory_database %}을(를) 찾아보고 모든 글로벌 보안 권고에 개선 사항을 제출합니다.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
