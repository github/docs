...
{% data reusables.repositories.request-security-advisory-cve-id %} 자세한 내용은 "[리포지토리 보안 권고 정보](/code-security/repository-security-advisories/about-github-security-advisories-for-repositories#cve-identification-numbers)"를 참조하세요.
