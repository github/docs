...
컴파일된 언어 C/C++, C#,{% ifversion codeql-go-autobuild %} Go,{% endif %}{% ifversion codeql-kotlin-beta %} Kotlin, {% endif %} 및 Java의 경우 이 데이터베이스를 채우는 프로세스에는 코드 빌드 및 데이터 추출이 포함됩니다. {% data reusables.code-scanning.analyze-go %}
...
### Java {% ifversion codeql-kotlin-beta %} 및 Kotlin {% endif %}
