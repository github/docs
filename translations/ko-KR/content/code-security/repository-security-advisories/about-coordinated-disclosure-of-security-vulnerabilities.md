...
{% endnote %}
 ...
 유지 관리자로서 코드의 취약성을 공개하려면 먼저 {% data variables.product.prodname_dotcom %}의 패키지 리포지토리에 보안 공지 초안을 만듭니다. {% data reusables.security-advisory.security-advisory-overview %} 자세한 내용은 “[리포지토리에 대한 {% data variables.product.prodname_security_advisories %} 정보](/code-security/repository-security-advisories/about-github-security-advisories-for-repositories)”를 참조하세요.
