...
intro: '코드베이스에서 비밀 및 취약성을 배제하고 {% ifversion not ghae %}소프트웨어 공급망을 유지관리하기 위한{% endif %} 기능을 사용하여 {% data variables.product.prodname_dotcom %} 워크플로에 보안을 구축합니다.'
introLinks:
