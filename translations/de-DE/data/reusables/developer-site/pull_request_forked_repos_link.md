...
Wenn Du einen Pull Request an das Basis-Repository aus einem geforkten Repository heraus erstellst, sendet {{ site.data.variables.product.prodname_dotcom }} das Ereignis `pull_request` an das Basis-Repository, und im geforkten Repository treten keine Pull-Request-Ereignisse ein.
