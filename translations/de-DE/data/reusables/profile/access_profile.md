{% if currentVersion == "free-pro-team@latest" %}1. In der oberen rechten Ecke von {{site.data.variables.product.product_name}} klicke auf Dein Profilfoto und dann auf **your profile** (Dein Profil).
