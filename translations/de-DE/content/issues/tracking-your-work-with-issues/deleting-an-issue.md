...
Um einen Issue in einem Repository einer Organisation zu löschen, muss der Organisationsinhaber das Löschen von Issues für die Repositorys der Organisation aktivieren. Zusätzlich benötigst Du Administrator- oder Inhaberberechtigungen für das Repository. For more information, see "[Allowing people to delete issues in your organization](/articles/allowing-people-to-delete-issues-in-your-organization)" and "[Repository roles for an organization](/organizations/managing-access-to-your-organizations-repositories/repository-roles-for-an-organization)."
...
2. On the right side bar, under "Notifications", click **Delete issue**. !["Delete issue" text highlighted on bottom of the issue page's right side bar](/assets/images/help/issues/delete-issue.png)
