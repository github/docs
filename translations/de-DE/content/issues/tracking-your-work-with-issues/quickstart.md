...
You can add a milestone to track the issue as part of a date based target. A milestone will show the progress of the issues as the target date approaches. Weitere Informationen findest Du unter „[Informationen zu Meilensteinen](/issues/using-labels-and-milestones-to-track-work/about-milestones).“
...
You can use issues for a wide range of purposes. Ein Beispiel:
