...
### Schritt 1. Start a new Smee channel
...
### Schritt 2. Register a new GitHub App
...
* For the "Homepage URL", use the domain issued by Smee. Ein Beispiel:

    ![Form with Smee domain filled in for homepage URL](/assets/images/homepage-url.png)

* For the "Webhook URL", again use the domain issued by Smee. Ein Beispiel:
...
### Schritt 3. Save your private key and App ID
...
### Schritt 4. Prepare the runtime environment
...
### Schritt 5. Review the GitHub App template code
...
### Schritt 7. Install the app on your account
