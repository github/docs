...
intro: 'Du kannst dich mit SAML Single Sign-On (SSO){% ifversion ghec %} bei {% data variables.product.product_name %} authentifizieren und deine aktiven Sitzungen anzeigen.{% endif %}'
redirect_from:
