...
| [`repo`](#repo-category-actions)                                                                                                 | Umfasst alle Aktivitäten in Verbindung mit den Repositorys, deren Inhaber Sie sind.{% ifversion fpt or ghec %}
...
| `deaktivieren`                        | Wird ausgelöst, wenn ein Repository deaktiviert wird (zum Beispiel aufgrund [unzureichender Deckung](/articles/unlocking-a-locked-account)).{% endif %}{% ifversion fpt or ghec %}
