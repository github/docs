...
**Note:** When a personal access token or OAuth token expires or is revoked, you may see an `oauth_authorization.destroy` action in your security log. Weitere Informationen finden Sie unter „[Sicherheitsprotokoll überprüfen](/github/authenticating-to-github/keeping-your-account-and-data-secure/reviewing-your-security-log)“.
