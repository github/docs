...
Du kannst Organisationsmitglieder wiederherstellen, sobald sie sich erfolgreich mit Single Sign-On angemeldet haben. Removed users' access privileges and settings are saved for three months and can be restored during this time frame. Weitere Informationen findest Du unter „[Ehemaliges Mitglied Deiner Organisation wieder einsetzen](/articles/reinstating-a-former-member-of-your-organization).“
...
1. Enable and test SAML SSO for your organization, then authenticate with your IdP at least once. Weitere Informationen findest Du unter „[SAML Single Sign-On für Deine Organisation aktivieren und testen](/articles/enabling-and-testing-saml-single-sign-on-for-your-organization).“
1. Prepare to enforce SAML SSO for your organization. Weitere Informationen findest Du unter „[Auf die Erzwingung von SAML Single Sign-On in Deiner Organisation vorbereiten](/organizations/managing-saml-single-sign-on-for-your-organization/preparing-to-enforce-saml-single-sign-on-in-your-organization).“
