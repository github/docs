---
title: Arbeiten mit globalen Sicherheitsempfehlungen aus GitHub Advisory Database
shortTitle: Global security advisories
intro: 'Du kannst {% data variables.product.prodname_advisory_database %} durchsuchen und Verbesserungen für jede globale Sicherheitsempfehlung vorschlagen.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
