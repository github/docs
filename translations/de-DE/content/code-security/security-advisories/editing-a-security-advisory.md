...
12. Klicke auf **Update security advisory** (Aktualisiere Sicherheitshinweis). !["Update security advisory" button](/assets/images/help/security/update-advisory-button.png)
