...
Für {% data variables.product.prodname_dotcom %} stehen zwei Prozesse zur Verfügung:
...
{% data reusables.security-advisory.private-vulnerability-reporting-enable %}
 ...
 Die private Berichterstattung zu Sicherheitsrisiken bietet eine einfache Möglichkeit für Sicherheitsrisikoberichterstatter, Sicherheitsrisiken für Repositoryverwalter innerhalb von {% data variables.product.prodname_dotcom %} privat offenzulegen, und zwar auf eine Weise, die die Repositoryverwalter sofort über das Issue benachrichtigt. Weitere Informationen für Sicherheitsforscher und Repositoryverwalter findest du unter [Privates Melden eines Sicherheitsrisikos](/code-security/security-advisories/guidance-on-reporting-and-writing/privately-reporting-a-security-vulnerability) bzw [Verwalten privat gemeldeter Sicherheitsrisiken](/code-security/security-advisories/guidance-on-reporting-and-writing/managing-privately-reported-security-vulnerabilities).

{% note %}

**Hinweis**: Wenn für das Repository, das das Sicherheitsrisiko enthält, keine private Sicherheitsrisikoberichterstattung aktiviert ist, müssen sowohl Sicherheitsforscher als auch Repositoryverwalter die im Abschnitt „[Standardprozess](#standard-process)“ oben beschriebenen Anweisungen befolgen.
