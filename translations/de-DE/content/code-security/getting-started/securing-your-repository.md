...
3. Klicke auf **Start setup** (Einrichtung starten).
4. Add information about supported versions of your project and how to report vulnerabilities.

Weitere Informationen findest Du unter „[Eine Sicherheitsrichtlinie zum Repository hinzufügen](/code-security/getting-started/adding-a-security-policy-to-your-repository)“.
...
## {% data variables.product.prodname_code_scanning %} konfigurieren
...
## {% data variables.product.prodname_secret_scanning %} konfigurieren
