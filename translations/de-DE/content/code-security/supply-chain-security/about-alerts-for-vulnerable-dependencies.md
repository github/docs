...
{% if enterpriseServerVersions contains currentVersion and currentVersion ver_lt "enterprise-server@2.22" %}
Standardmäßig senden wir Sicherheitsmeldungen an Personen mit Administratorrechten in den betroffenen Repositorys. {% data variables.product.product_name %} never publicly discloses identified vulnerabilities for any repository.
{% endif %}
