---
title: Codesicherheit
shortTitle: Code security
intro: 'Integriere Sicherheit in deinen {% data variables.product.prodname_dotcom %}-Workflow mit Features, die Geheimnisse und Sicherheitsrisiken aus deiner Codebasis heraushalten{% ifversion not ghae %} und deine Softwarelieferkette aufrechterhalten{% endif %}.'
introLinks:
