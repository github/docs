...
intro: 'Learn best practices and considerations for migrating from {{ site.data.variables.product.prodname_dotcom }}''s REST API to {{ site.data.variables.product.prodname_dotcom }}''s GraphQL API.'
redirect_from:
