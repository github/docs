...
Du kannst neue Organisationen erstellen, um sie in Deinem Enterprise-Konto zu verwalten. For more information, see "[Adding organizations to your enterprise](/enterprise-cloud@latest/admin/user-management/managing-organizations-in-your-enterprise/adding-organizations-to-your-enterprise)."
...
{% data variables.product.prodname_ghe_cloud %} allows you to submit priority support requests with a target eight-hour response time. Weitere Informationen finden Sie unter „[{% data variables.product.prodname_ghe_cloud %}-Support](/github/working-with-github-support/github-enterprise-cloud-support)“.
