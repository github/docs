...
intro: 'Richte Git ein, ein verteiltes Versionskontrollsystem, um deine {% data variables.product.product_name %}-Repositorys von deinem Computer aus zu verwalten.'
redirect_from:
