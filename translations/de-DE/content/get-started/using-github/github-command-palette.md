...
## Informationen zu {% data variables.product.prodname_command_palette %}
...
| Command                              | Behavior                                                                                                                                                                                                                                                              |
|:------------------------------------ |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Clone repository: <URL type>` | Copy the URL needed to clone the repository using {% data variables.product.prodname_cli %}, HTTPS, or SSH to the clipboard. Weitere Informationen findest Du unter „[Ein Repository klonen](/repositories/creating-and-managing-repositories/cloning-a-repository).“ |
...
| `New file`                           | Create a new file from any page in the repository. Weitere Informationen findest Du unter „[Eine Datei zu einem Repository hinzufügen](/repositories/working-with-files/managing-files/adding-a-file-to-a-repository).“                                               |
...
| `Open in new codespace`              | Create and open a codespace for this repository. Weitere Informationen findest du unter „[Einen Codespace erstellen](/codespaces/developing-in-codespaces/creating-a-codespace)."                                                                                     |
...
| Command                     | Behavior                                                                                                                                                                                                                                                                                                       |
|:--------------------------- |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Copy permalink`            | Create a link to the file that includes the current commit SHA and copy the link to the clipboard. Weitere Informationen findest Du unter „[Permalinks zu Dateien abrufen](/repositories/working-with-files/using-files/getting-permanent-links-to-files#press-y-to-permalink-to-a-file-in-a-specific-commit)“ |
...
| `Subscribe`/`unsubscribe` | Opt in or out of notifications for additions to the discussion. Weitere Informationen findest Du unter „[Über Benachrichtigungen](/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/about-notifications)." |
...
| Command                          | Behavior                                                                                                                                                                                                                                                  |
|:-------------------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Close`/`reopen issue`           | Close or reopen the current issue. Weitere Informationen findest Du unter „[Informationen zu Issues](/issues/tracking-your-work-with-issues/about-issues).“                                                                                               |
...
| `Delete issue...`                | Delete the current issue. Weitere Informationen finden Sie unter „[Issue löschen](/issues/tracking-your-work-with-issues/deleting-an-issue)“.                                                                                                             |
...
| `Lock issue`                     | Limit new comments to users with write access to the repository. (siehe „[Unterhaltungen sperren](/communities/moderating-comments-and-conversations/locking-conversations)“)                                                                             |
| `Pin`/`unpin issue`              | Change whether or not the issue is shown in the pinned issues section for the repository. Weitere Informationen findest Du unter „[Einen Issue an Dein Repository anheften](/issues/tracking-your-work-with-issues/pinning-an-issue-to-your-repository).“ |
| `Subscribe`/`unscubscribe`       | Opt in or out of notifications for changes to this issue. Weitere Informationen findest Du unter „[Über Benachrichtigungen](/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/about-notifications)."       |
| `Transfer issue...`              | Transfer the issue to another repository. Weitere Informationen findest Du unter „[Issue in ein anderes Repository übertragen](/issues/tracking-your-work-with-issues/transferring-an-issue-to-another-repository),“                                      |
...
| Command                                                    | Behavior                                                                                                                                                                                                                                                                                                                                                  |
|:---------------------------------------------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Close`/`reopen pull request`                              | Close or reopen the current pull request. Weitere Informationen findest Du unter „[Informationen zu Pull Requests](/github/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests).“                                                                                                                      |
...
| `Open in new codespace`                                    | Create and open a codespace for the head branch of the pull request. Weitere Informationen findest du unter „[Einen Codespace erstellen](/codespaces/developing-in-codespaces/creating-a-codespace)."                                                                                                                                                     |
| `Subscribe`/`unscubscribe`                                 | Opt in or out of notifications for changes to this pull request. Weitere Informationen findest Du unter „[Über Benachrichtigungen](/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/about-notifications)."                                                                                                |
| `Update current branch`                                    | Update the head branch of the pull request with changes from the base branch. This is available only for pull requests that target the default branch of the repository. Weitere Informationen finden Sie unter „[Informationen zu Branches](/github/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-branches)“. |
