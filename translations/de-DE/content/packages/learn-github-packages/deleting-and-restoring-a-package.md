...
4. Under "Deleted Packages", next to the package you want to restore, click **Restore**. ![Schaltfläche „Restore" (Wiederherstellen)](/assets/images/help/package-registry/restore-option-for-deleted-package-in-an-org.png)
