...
intro: 'Sie können den Docker-Client für die Nutzung von {{ site.data.variables.product.prodname_registry }} zum Veröffentlichen und Abrufen von Docker-Images konfigurieren.'
...
{{ site.data.variables.product.prodname_registry }} unterstützt mehrere Top-Level-Docker-Images pro Repository. A repository can have any number of image tags. You may experience degraded service publishing or installing Docker images larger than 10GB, layers are capped at 5GB each. For more information, see "[Docker tag](https://docs.docker.com/engine/reference/commandline/tag/)" in the Docker documentation.
...
# Pusht das Image zu {{ site.data.variables.product.prodname_registry }}
$ docker push docker.pkg.github.com/octocat/octo-app/monalisa:1.0
```
