...
intro: 'You can delete a version of a private package using GraphQL or on {% data variables.product.prodname_dotcom %}.'
...
You can only delete a specified version of a private package on {% data variables.product.prodname_dotcom %} or with the GraphQL API. To remove an entire private package from appearing on {% data variables.product.prodname_dotcom %}, you must delete every version of the package first.
