...
intro: 'Von dem KI-Paarprogrammierer {% data variables.product.prodname_copilot %} kannst du während des Programmierens AutoVervollständigen-Vorschläge erhalten.'
redirect_from:
  - /github/copilot
changelog:
  label: copilot
