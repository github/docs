...
1. Klicke auf **Create** (Erstellen). !["Create" button for new category](/assets/images/help/discussions/new-category-click-create-button.png)
...
1. Klicke auf **Save changes** (Änderungen speichern). !["Save changes" button for existing category](/assets/images/help/discussions/existing-category-click-save-changes-button.png)
