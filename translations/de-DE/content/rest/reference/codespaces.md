...
The {% data variables.product.prodname_codespaces %} API enables you to manage {% data variables.product.prodname_codespaces %} using the REST API. This API is available for authenticated users and OAuth Apps, but not GitHub Apps. Weitere Informationen finden Sie unter „[{% data variables.product.prodname_codespaces %}](/codespaces)“.
