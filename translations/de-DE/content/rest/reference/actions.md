...
The Self-hosted Runners API allows you to register, view, and delete self-hosted runners. {{ site.data.reusables.actions.about-self-hosted-runners }} Weitere Informationenfindest Du unter „[Deinen eigenen Runner hosten](/actions/hosting-your-own-runners)“.
