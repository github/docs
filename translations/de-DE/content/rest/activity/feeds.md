...
ms.locfileid: '147064298'
---
## Informationen zur Feeds-API

Verwende den Vorgang [Feeds abrufen](#get-feeds), um zu sehen, welche Feeds für dich verfügbar sind. Du kannst anschließend einen Feed abrufen, indem du eine Anforderung an eine der Feed-URLs sendest.

### Beispiel für das Abrufen eines Atom-Feeds

Um einen Feed im Atom-Format abzurufen, musst du den `application/atom+xml`-Typ im `Accept`-Header angeben. Gehe beispielsweise folgendermaßen vor, um den Atom-Feed für GitHub-Sicherheitshinweise abzurufen:
