...
{{ site.data.reusables.desktop.confirm-merging-branch }}
   ...
   **Hinweis:** Bei Merge-Konflikten wirst Du oberhalb der Schaltfläche **Merge <em>BRANCH</em> into <em>BRANCH</em>** (BRANCH per Merge in BRANCH fusionieren) von {{ site.data.variables.product.prodname_desktop }} gewarnt. Sie können die Branches erst mergen, nachdem Sie alle Konflikte behoben haben.
