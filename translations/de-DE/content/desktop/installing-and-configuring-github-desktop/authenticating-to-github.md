...
3. To the right of "{{ site.data.variables.product.prodname_dotcom_the_website }}," click **Sign In**. ![Die Schaltfläche „Sign In“ (Anmelden) für GitHub](/assets/images/help/desktop/mac-sign-in-github.png)
4. In the "Sign in" pane, click **Sign in using your browser**. {{ site.data.variables.product.prodname_desktop }} will open your default browser. ![Der Link „Sign in using your browser“ (Mit Deinem Browser anmelden)](/assets/images/help/desktop/mac-sign-in-browser.png)
...
4. To add a {{ site.data.variables.product.prodname_enterprise }} account, type your credentials under "Enterprise server address," then click **Continue**. ![Die Schaltfläche „Sign In“ (Anmelden) für GitHub Enterprise](/assets/images/help/desktop/mac-sign-in-button-enterprise.png)
...
{{ site.data.reusables.desktop.windows-select-accounts }}
{{ site.data.reusables.desktop.choose-product-authenticate }}
4. To add a {{ site.data.variables.product.prodname_enterprise }} account, type your credentials under "Enterprise server address," then click **Continue**. ![Die Schaltfläche „Sign In“ (Anmelden) für GitHub Enterprise](/assets/images/help/desktop/windows-sign-in-button-enterprise.png)
{{ site.data.reusables.desktop.retrieve-2fa }}
