...
3. Optionally, to add a repository which has not been imported, to the right of the repository's name, click **Add**. ![Schaltfläche „Add“ (Hinzufügen)](/assets/images/help/insights/add-button.png)
