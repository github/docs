...
1. From your repository on {{ site.data.variables.product.prodname_dotcom }}, create a new file in the `.github/workflows` directory named `superlinter.yml`. Weitere Informationen finden Sie unter „[Neue Dateien erstellen](/github/managing-files-in-a-repository/creating-new-files)“.
...
1. From the list of workflow runs, click the name of the run you want to see. ![Name der Workflow-Ausführung](/assets/images/help/repository/superlinter-run-name.png)
