...
| Pull-based autoscaling support | Ja                                                                                 | Nein                                                                  |
...
To add an ephemeral runner to your environment, include the `--ephemeral` parameter when registering your runner using `config.sh`. Ein Beispiel:
