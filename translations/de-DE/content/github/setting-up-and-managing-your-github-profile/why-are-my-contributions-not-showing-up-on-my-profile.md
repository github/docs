...
intro: 'Beim Beteiligungsdiagramm für Dein Profil handelt es sich um eine Aufzeichnung Deiner Beiträge für {{ site.data.variables.product.product_name }}-Repositorys. Beiträge werden nicht entsprechend Deiner lokalen Zeitzone, sondern entsprechend der UTC-Zone (Coordinated Universal Time, koordinierte Weltzeit) mit Zeitstempeln versehen. Beiträge werden nur gezählt, falls sie bestimmte Kriterien erfüllen. In manchen Fällen muss Dein Diagramm allenfalls neu erstellt werden, damit die Beiträge angezeigt werden.'
redirect_from:
...
- Die für die Commits verwendete E-Mail-Adresse ist mit Deinem {{ site.data.variables.product.product_name }}-Konto verknüpft.
...
Weitere Informationen zu Projektwebsites findest Du unter „[Über {{ site.data.variables.product.prodname_pages }}](/github/working-with-github-pages/about-github-pages#types-of-github-pages-sites)."
...
Falls Deinem {{ site.data.variables.product.product_name }}-Profil die für den Commit verwendete E-Mail-Adresse nicht hinzugefügt wurde, musst Du Deinem {{ site.data.variables.product.product_name }}-Konto [die E-Mail-Adresse hinzufügen](/articles/adding-an-email-address-to-your-github-account). Beim Hinzufügen der neuen Adresse wird Dein Beteiligungsdiagramm automatisch neu erstellt.

{% warning %}

Es ist nicht möglich, {{ site.data.variables.product.product_name }}-Konten generische E-Mail-Adressen hinzuzufügen wie beispielsweise `jane@computer.local`. Falls Du eine solche E-Mail-Adresse für Deine Commits verwendest, werden die Links weder mit Deinem {{ site.data.variables.product.product_name }}-Profil verknüpft noch in Deinem Beteiligungsdiagramm angezeigt.

{% endwarning %}

#### Commit wurde weder auf dem Standard- noch auf dem `gh-pages`-Branch durchgeführt

Commits are only counted if they are made in the default branch or the `gh-pages` branch (for repositories with project sites). Weitere Informationen findest Du unter „[Über {{ site.data.variables.product.prodname_pages }}](/github/working-with-github-pages/about-github-pages#types-of-github-pages-sites)."
...
- Wende Dich an {{ site.data.variables.contact.contact_support }}, falls Du den Fork trennen und in ein eigenständiges Repository auf {{ site.data.variables.product.product_name }} umwandeln möchtest. Wenn der Fork eigene Forks hat, musst Du {{ site.data.variables.contact.github_support}} wissen lassen, ob die Forks mit Deinem Repository in ein neues Netzwerk verschoben werden sollen oder im aktuellen Netzwerk verbleiben sollen. Weitere Informationen findest Du unter „[Informationen zu Forks](/articles/about-forks/).“
