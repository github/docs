...
1. Navigieren Sie auf {% data variables.product.product_name %} zur Hauptseite des Forks (oder der Kopie Ihres Repositorys), auf dem der Pull-Request-Branch erstellt wurde.
