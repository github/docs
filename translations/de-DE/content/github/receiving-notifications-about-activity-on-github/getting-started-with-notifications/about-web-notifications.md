...
intro: 'Wenn Sie Webbenachrichtigungen erhalten, können Sie Ihre Teilnahme- und Beobachtungsbenachrichtigungen auf der Benachrichtigungsseite auf {% data variables.product.product_name %} anzeigen.'
versions:
  enterprise-server: <2.21
redirect_from:
  - /github/receiving-notifications-about-activity-on-github/about-web-notifications
---
