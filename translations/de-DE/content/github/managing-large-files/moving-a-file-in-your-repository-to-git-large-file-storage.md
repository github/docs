...
intro: 'Wenn Du {% data variables.large_files.product_name_short %} eingerichtet hast und eine vorhandene Datei in Deinem Repository in {% data variables.large_files.product_name_short %} nachverfolgt werden muss, musst Du sie zunächst aus Deinem Repository entfernen.'
redirect_from:
...
2. Konfiguriere die Nachverfolgung für die Datei, und übertrage sie zu {% data variables.large_files.product_name_short %}. Weitere Informationen zu diesem Vorgang findest Du unter „[{% data variables.large_files.product_name_long %} konfigurieren](/articles/configuring-git-large-file-storage).“
