...
intro: 'Falls Du einen Gutschein hast, kannst Du ihn für ein bezahltes {{ site.data.variables.product.prodname_dotcom }}-Abonnement einlösen.'
redirect_from:
...
{{ site.data.variables.product.product_name }} kann für eine Zahlung, die vor dem Einlösen eines Gutscheins erfolgt, keine Rückerstattung gewähren. Auch kann ein eingelöster Gutschein weder übertragen noch erneut ausgestellt werden, wenn Du ihn auf das falsche Konto anwendest. Vergewissere Dich daher vor dem Einlösen eines Gutscheins, dass Du ihn für das richtige Konto verwendest.

Gutscheine können nicht auf bezahlte Pläne für {{ site.data.variables.product.prodname_marketplace }}-Apps angewendet werden.
