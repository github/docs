...
Durch das Rückgängigmachen eines Pull Requests auf {{ site.data.variables.product.product_name }} wird ein neuer Pull Request erstellt, der ein „Revert“ des Merge-Commits des ursprünglich gemergten Pull Requests enthält.
