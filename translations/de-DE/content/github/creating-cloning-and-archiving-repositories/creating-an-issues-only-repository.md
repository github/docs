...
intro: '{{ site.data.variables.product.product_name }} bietet keine Berechtigungen für den Zugriff ausschließlich auf Issues. Du kannst zu diesem Zweck aber ein zweites Repository erstellen, das nur die Issues enthält.'
redirect_from:
