...
Du kannst zu den verweisenden Websites, mit Ausnahme der Suchmaschinen und {{ site.data.variables.product.product_name }} selbst, über die Links navigieren, von denen aus auf die spezifischen Pfade verwiesen wurde. Der beliebte Inhalt wird mit dem spezifischen Inhalt verknüpft, der Traffic generiert hat.
