...
**Hinweis:** {{ site.data.reusables.project-management.cascading-permissions }} Weitere Informationen findest Du unter „[Projektboardberechtigungen für eine Organisation](/articles/project-board-permissions-for-an-organization).“
