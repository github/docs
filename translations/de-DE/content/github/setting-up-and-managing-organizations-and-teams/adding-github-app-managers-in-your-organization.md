...
{% data reusables.organizations.org_settings %}
{% data reusables.organizations.github-apps-settings-sidebar %}
1. Klicke unter „{% data variables.product.prodname_github_app %}s“ auf den Avatar der App, zu der Du einen {% data variables.product.prodname_github_app %}-Manager hinzufügen möchten. ![{% data variables.product.prodname_github_app %} auswählen](/assets/images/help/organizations/select-github-app.png)
