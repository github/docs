...
intro: 'Organisationsinhaber können Beschränkungen für {{ site.data.variables.product.prodname_oauth_app }}s aufheben, die Zugriff auf die Ressourcen der Organisation haben.'
redirect_from:
