...
intro: '{{ site.data.variables.product.product_name }} dient Anwendungen aus mehreren IP-Adressbereichen, die über die API verfügbar sind.'
redirect_from:
...
Du kannst eine Liste der IP-Adressen von {{ site.data.variables.product.prodname_dotcom }} über den [meta](https://api.github.com/meta)-API-Endpunkt abrufen. For more information, see "[Meta](/v3/meta/)."
