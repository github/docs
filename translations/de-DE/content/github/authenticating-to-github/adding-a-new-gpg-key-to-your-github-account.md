...
intro: 'Um Ihr {{ site.data.variables.product.product_name }}-Konto für die Verwendung eines neuen (oder vorhandenen) GPG-Schlüssels zu konfigurieren, müssen Sie diesen Schlüssel auch zu Ihrem {{ site.data.variables.product.product_name }}-Konto hinzufügen.'
redirect_from:
...
Bevor Sie einen neuen GPG-Schlüssel zu Ihrem {{ site.data.variables.product.product_name }}-Konto hinzufügen, sollten Sie
...
Beim Überprüfen einer Signatur extrahieren wir die Signatur und versuchen, ihre Schlüssel-ID zu parsen. Wir gleichen die Schlüssel-ID mit den auf {{ site.data.variables.product.product_name }} hochgeladenen Schlüsseln ab. Wir können Ihre Signaturen erst überprüfen, wenn Sie Ihren GPG-Schlüssel auf {{ site.data.variables.product.product_name }} hochgeladen haben.
...
6. Um die Aktion zu bestätigen, geben Sie Ihr {{ site.data.variables.product.product_name }}-Passwort ein.
