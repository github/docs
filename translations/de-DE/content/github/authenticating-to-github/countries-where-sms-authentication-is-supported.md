...
intro: 'Wegen den Auslieferungs-Erfolgsquoten für SMS unterstützt {{ site.data.variables.product.product_name }} die Zwei-Faktor-Authentifizierung per SMS nur in bestimmten Ländern.'
redirect_from:
