...
intro: 'Wegen den Auslieferungs-Erfolgsquoten für SMS unterstützt {% data variables.product.product_name %} die Zwei-Faktor-Authentifizierung per SMS nur in bestimmten Ländern.'
redirect_from:
