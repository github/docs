...
intro: 'Bei der Verifizierung einer Signatur überprüft {{ site.data.variables.product.product_name }}, ob der Schlüssel widerrufen wurde oder abgelaufen ist. Bei Widerruf oder Ablauf Deines Signaturschlüssel kann {{ site.data.variables.product.product_name }} Deine Signaturen nicht verifizieren. Wenn Dein Schlüssel widerrufen wurde, verwende den primären Schlüssel oder einen anderen, nicht widerrufenen Schlüssel zum signieren Deiner Commits.'
redirect_from:
