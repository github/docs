...
Wir empfehlen, einen anderen {{ site.data.variables.product.company_short }}-Benutzer einzuladen, Dein Nachfolger zu werden, um Deine eigenen Repositories zu verwalten, wenn Du dies nicht kannst. Als Nachfolger wird dieser Benutzer folgende Berechtigungen haben:
...
Die Person, die Du als Deinen Nachfolger einlädst, muss ein {{ site.data.variables.product.company_short }}-Konto haben.
