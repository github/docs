...
intro: 'Du kannst auf {{ site.data.variables.product.product_name }} nach Paketen suchen und die Suchresultate mit Qualifizierern einschränken.'
...
Du kannst global über das gesamte {{ site.data.variables.product.product_name }} nach Paketen suchen, oder nur innerhalb einer bestimmten Organisation. Weitere Informationen findest Du unter „[Informationen zur Suche auf {{ site.data.variables.product.prodname_dotcom }}](/articles/about-searching-on-github).“
...
| <code>org:<em>ORGNAME</em></code> | [**org:github**](https://github.com/search?q=org%3Agithub&type=RegistryPackages) findet Pakete, die der {{ site.data.variables.product.prodname_dotcom }}-Organisation gehören |
