---
title: Sicherheit in GitHub Codespaces
intro: 'Übersicht über die {% data variables.product.prodname_github_codespaces %}-Sicherheitsarchitektur, mit Richtlinien, die dir helfen, die Sicherheit zu erhalten und das Risiko eines Angriffs zu minimieren.'
...
ms.locfileid: '147111549'
---
## Übersicht über die Sicherheit in Codespaces

{% data variables.product.prodname_github_codespaces %} verfügt standardmäßig über eine Sicherheitshärtung. Daher musst du sicherstellen, dass der Codespace-Sicherheitsstatus durch deine Softwareentwicklungspraktiken nicht gefährdet wird. 
...
{% data variables.product.prodname_github_codespaces %} ist so konzipiert, dass deine Codespaces voneinander getrennt sind. Für jeden einzelnen Codespace wird dabei ein eigener virtueller Computer und ein eigenes virtuelles Netzwerk verwendet.
...
Du kannst eine Verbindung mit deinem Codespace herstellen, indem du den mit TLS verschlüsselten Tunnel verwendest, der vom {% data variables.product.prodname_github_codespaces %}-Dienst bereitgestellt wird. Nur der Ersteller eines Codespaces kann eine Verbindung mit einem Codespace herstellen. Verbindungen werden mit {% data variables.product.product_name %} authentifiziert.
...
### Verwenden von Geheimnissen für den Zugriff auf vertrauliche Informationen 
