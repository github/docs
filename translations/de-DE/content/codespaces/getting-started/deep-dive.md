...
intro: 'Informationen zur Funktionsweise des {% data variables.product.prodname_codespaces %}s.'
...
Your codespace can be ephemeral if you need to test something or you can return to the same codespace to work on long-running feature work. Weitere Informationen findest du unter „[Einen Codespace erstellen](/codespaces/developing-in-codespaces/creating-a-codespace)."
...
![Schaltfläche „Open with Codespaces" (Eröffnen mit Codespaces)](/assets/images/help/codespaces/new-codespace-button.png)
...
You can create a codespace from any branch, commit, or pull request in your project, or you can switch to a new or existing branch from within your active codespace. Because {% data variables.product.prodname_codespaces %} is designed to be ephemeral, you can use it as an isolated environment to experiment, check a teammate's pull request, or fix merge conflicts. Du kannst pro Repository oder sogar pro Branch mehr als einen Codespace erstellen. However, each user account has a limit of 10 codespaces. Wenn Du das Limit erreicht hast und einen neuen Codespace erstellen möchtest, musst Du zuerst einen Codespace löschen.
