...
intro: 'Du kannst konfigurieren, wie der Zugriff auf {% ifversion ghec or ghae %}dein Unternehmen auf {% data variables.product.product_name %}{% elsif ghes %}{% data variables.product.product_location %}{% endif %} erfolgt.'
redirect_from:
