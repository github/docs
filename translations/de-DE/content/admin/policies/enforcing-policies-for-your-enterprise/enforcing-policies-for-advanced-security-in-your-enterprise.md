...
{% data reusables.advanced-security.ghas-helps-developers %} Weitere Informationen findest Du unter „[Über {% data variables.product.prodname_GH_advanced_security %}](/get-started/learning-about-github/about-github-advanced-security)."
