...
**Hinweis:** Nur Dateien, die größer sind als {{ site.data.variables.large_files.warning_size }}, werden mit der Git-Push-Begrenzung abgeglichen. Kontaktieren Sie {{ site.data.variables.contact.contact_ent_support }}, wenn Sie eine niedrigere Push-Begrenzung festlegen müssen.
...
5. Optional kannst Du **Für alle Repositorys erzwingen** auswählen, um ein maximales Upload-Limit für alle Repositorys auf {{ site.data.variables.product.product_location_enterprise }} zu erzwingen. ![Option zur zwangsweisen Begrenzung der Objektgröße für alle Repositorys](/assets/images/enterprise/site-admin-settings/all-repo-upload-limit-option.png)
