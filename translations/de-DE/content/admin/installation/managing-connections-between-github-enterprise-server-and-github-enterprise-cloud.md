...
intro: 'Mit {{ site.data.variables.product.prodname_github_connect }} können Sie bestimmte Features und Daten zwischen {{ site.data.variables.product.product_location_enterprise }} und Ihrer {{ site.data.variables.product.prodname_ghe_cloud }}-Organisation oder Ihrem -Enterprise-Konto auf {{ site.data.variables.product.prodname_dotcom_the_website }} freigeben.'
mapTopic: true
redirect_from:
