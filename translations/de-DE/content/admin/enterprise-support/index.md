---
title: 'Mit dem {{ site.data.variables.contact.github_support }} arbeiten'
intro: 'Erfahre, wie Du ein Ticket öffnen und das {{ site.data.variables.contact.enterprise_support }}-Team mit den Informationen versorgst, die es benötigt, um Deine Probleme zu beheben.'
redirect_from:
