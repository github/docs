...
intro: 'Mittels {{ site.data.variables.product.prodname_ghe_server }}-Clustering können Dienste, die den {{ site.data.variables.product.prodname_ghe_server }} bilden, knotenübergreifend per Scale-out erweitert werden.'
redirect_from:
...
{{ site.data.variables.product.prodname_ghe_server }} erfordert eine niedrige Latenz zwischen den Knoten und ist nicht für die Redundanz über geografische Standorte hinweg vorgesehen.
...
Clustering ist für bestimmte Skalierungssituationen vorgesehen, nicht aber für jede Organisation. Wenn Du Clustering in Betracht ziehen möchtest, wende Dich bitte an Deinen {{ site.data.variables.contact.contact_enterprise_sales }}.
