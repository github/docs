---
title: Dokumentation für Enterprise-Administratoren
shortTitle: Enterprise administrators
intro: 'Dokumentation und Anleitungen für Unternehmensadministratoren{% ifversion ghes %}, Systemadministratoren,{% endif %} und Sicherheitsexperten, die {% ifversion ghes %}bereitstellen, {% endif %}konfigurieren{% ifversion ghes %},{% endif %} und verwalten {% data variables.product.product_name %}.'
redirect_from:
