...
{% ifversion ghec %}To receive email notifications, the owner of the user account must verify the email address on {% data variables.product.product_name %}. Weitere Informationen finden Sie unter „[Eigene E-Mail-Adresse überprüfen](/github/getting-started-with-github/verifying-your-email-address)“.{% endif %}
