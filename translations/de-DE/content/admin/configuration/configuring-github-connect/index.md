---
title: Konfigurieren von GitHub Connect
intro: 'Mit {% data variables.product.prodname_github_connect %} kannst du auf zusätzliche Features und Workflows zugreifen, indem du {% data variables.product.product_location %} mit {% data variables.product.prodname_ghe_cloud %} verbindest.'
redirect_from:
