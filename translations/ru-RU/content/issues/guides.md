---
title: Руководства по проблемам
shortTitle: Guides
intro: 'Узнайте, как использовать {% data variables.product.prodname_github_issues %} для планирования и отслеживания работы.'
