---
title: Отслеживание результатов устранения неполадок
shortTitle: Issues
intro: 'Используйте {% data variables.product.prodname_github_issues %} для отслеживания идей и работы с {% data variables.product.prodname_dotcom %}'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
