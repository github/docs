---
title: Настройка GitHub Copilot
shortTitle: Configure GitHub Copilot
intro: 'Вы можете включить, настроить или отключить {% data variables.product.prodname_copilot %} в поддерживаемой интегрированной среде разработки.'
versions:
  feature: copilot
topics:
  - Copilot
