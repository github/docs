...
intro: 'Вы можете использовать {% data variables.product.prodname_copilot %} для получения предложений в стиле автозавершения от помощника на базе ИИ при написания кода.'
redirect_from:
  - /github/copilot
changelog:
  label: copilot
