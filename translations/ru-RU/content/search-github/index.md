---
title: Поиск информации в GitHub
intro: 'Узнайте, как использовать функции поиска, доступные на сайте GitHub, для поиска различных типов информации, таких как проекты, люди и код.'
introLinks:
