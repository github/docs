---
title: Настройка экземпляра GitHub Enterprise Server
intro: 'Вы можете установить {% data variables.product.prodname_ghe_server %} на выбранной поддерживаемой платформе виртуализации.'
redirect_from:
