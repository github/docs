---
title: Документация администратора предприятия
shortTitle: Enterprise administrators
intro: 'Документация и руководства для корпоративных администраторов{% ifversion ghes %}, системных администраторов,{% endif %} и специалистов по безопасности, которые {% ifversion ghes %}развертывают, {% endif %}настраивают{% ifversion ghes %},{% endif %} и управляют {% data variables.product.product_name %}.'
redirect_from:
