...
intro: '{% data variables.product.prodname_ghe_server %} поддерживает режим высокой доступности, который призван минимизировать нарушения работы службы в случае сбоя оборудования или серьезного сбоя сети, затрагивающего основное устройство.'
versions:
  ghes: '*'
topics:
  - Enterprise
