...
intro: 'You can increase the CPU or memory resources for a {{ site.data.variables.product.prodname_ghe_server }} instance.'
redirect_from:
...
2. Shut down {{ site.data.variables.product.product_location_enterprise }}.
