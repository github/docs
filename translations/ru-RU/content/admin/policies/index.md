---
title: Настройка политик для предприятия
intro: 'Политики можно задать в {% data variables.product.product_name %}, чтобы снизить риски и повысить качество.'
redirect_from:
