---
title: Начало работы с GitHub Actions для предприятия
intro: 'Узнайте, как внедрить {% data variables.product.prodname_actions %} на предприятии.'
versions:
  ghec: '*'
  ghes: '*'
  ghae: '*'
