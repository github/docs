---
title: Включение GitHub Actions для сервера GitHub Enterprise
intro: 'Сведения о настройке хранилища и включении {% data variables.product.prodname_actions %} для {% data variables.product.prodname_ghe_server %}.'
versions:
  ghes: '*'
topics:
  - Enterprise
