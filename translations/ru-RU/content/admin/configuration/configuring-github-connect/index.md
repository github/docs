---
title: Настройка GitHub Connect
intro: 'С помощью {% данных variables.product.prodname_github_connect %}можно получить доступ к дополнительным функциям и рабочим процессам, подключив {% данных variables.location.product_location %} к {% данных variables.product.prodname_ghe_cloud %}.'
redirect_from:
...
ms.openlocfilehash: bc6f1bd2157aa0a59c59bbfca93cc9a67c0fae42
ms.sourcegitcommit: d697e0ea10dc076fd62ce73c28a2b59771174ce8
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/20/2022
ms.locfileid: '148098852'
---
