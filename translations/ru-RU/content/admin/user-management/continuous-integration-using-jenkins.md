...
intro: 'You can automatically trigger build jobs on a Jenkins server when pushes are made to a repository in {{ site.data.variables.product.product_location_enterprise }}.'
redirect_from:
