---
title: Управление организациями на предприятии
redirect_from:
...
intro: 'Вы можете использовать организации для группирования пользователей в компании, таких как подразделения или группы, работающие над аналогичными проектами, и управления доступом к репозиториям.'
versions:
  ghec: '*'
  ghes: '*'
  ghae: '*'
