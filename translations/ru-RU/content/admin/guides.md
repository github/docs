---
title: Руководства по GitHub Enterprise
shortTitle: Guides
intro: 'Узнайте, как повысить продуктивность разработчиков и качество кода с помощью {% data variables.product.product_name %}.'
