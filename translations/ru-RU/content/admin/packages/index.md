---
title: Управление GitHub Packages для предприятия
intro: 'Вы можете включить {% data variables.product.prodname_registry %} для предприятия и управлять параметрами {% data variables.product.prodname_registry %} и разрешенными упакованными типами.'
redirect_from:
