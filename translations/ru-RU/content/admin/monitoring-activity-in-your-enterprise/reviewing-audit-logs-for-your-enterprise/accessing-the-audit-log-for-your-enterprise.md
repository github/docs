...
intro: 'Вы можете просматривать агрегированные действия всех организаций, принадлежащих вашей корпоративной учетной записи, в журнале корпоративного аудита.'
