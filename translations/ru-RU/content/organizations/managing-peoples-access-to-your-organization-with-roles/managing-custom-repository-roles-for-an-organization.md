...
| **Приоритизация** | Contributors who need to proactively manage issues and pull requests without write access.             |
...
To resolve conflicting access, you can adjust your organization's base permissions or the team's access, or edit the custom role. Дополнительные сведения см. в:
