---
title: Настройка периода хранения для артефактов и журналов GitHub Actions в организации
intro: 'Период хранения для артефактов и журналов в вашей организации {% data variables.product.prodname_actions %} в репозитории можно настраивать.'
redirect_from:
...
ms.locfileid: '145109752'
---
{% data reusables.actions.about-artifact-log-retention %}

## Установка периода хранения для организации
