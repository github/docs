...
{% ifversion fpt or ghec or ghes > 3.3 or ghae-issue-5974 %} Вы можете удалить доступ команды к репозиторию организации в настойках своего репозитория. Дополнительные сведения см. в разделе [Управление командами и людьми, имеющими доступ к репозиторию](/repositories/managing-your-repositorys-settings-and-features/managing-repository-settings/managing-teams-and-people-with-access-to-your-repository#removing-access-for-a-team-or-person).
