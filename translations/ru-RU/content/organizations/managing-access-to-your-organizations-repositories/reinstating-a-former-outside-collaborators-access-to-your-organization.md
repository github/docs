...
**Совет**.
 ...
 - При восстановлении потока элементов в {% data variables.product.product_location %} может использоваться термин "участник" для описания восстановления стороннего участника, но если вы восстановите этого пользователя и сохраните его предыдущие привилегии, они будут использовать только свои предыдущие [разрешения стороннего участника совместной работы](/organizations/managing-peoples-access-to-your-organization-with-roles/roles-in-an-organization#outside-collaborators).{% ifversion fpt or ghec %}
