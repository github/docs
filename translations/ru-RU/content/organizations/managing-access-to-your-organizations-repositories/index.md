---
title: Управление доступом к репозиториям вашей организации
intro: Владельцы организации могут управлять доступом отдельных пользователей и команд к репозиториям организации. Ответственные за команды также могут управлять доступом к репозиторию команды.
redirect_from:
