---
title: Управление единым входом SAML для вашей организации
intro: Владельцы организации могут управлять удостоверениями участников организации и доступом к организации с помощью единого входа SAML.
redirect_from:
