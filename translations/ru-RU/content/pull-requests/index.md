...
intro: 'Узнайте, как использовать запросы на вытягивание для предложения изменений в проект, получения предложенных изменений и устранения проблем в запросах на вытягивание, таких как конфликты слияния.'
introLinks:
