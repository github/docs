---
title: Проверка изменений в запросах на включение изменений
redirect_from:
...
intro: После открытия запроса на вытягивание можно просмотреть и обсудить набор предлагаемых изменений.
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
