...
| ------------------- | ------------------------------------ | ------------------------------------ | --------------------------------------- |
| actions             | read/write                           | нет                                  | read                                    |
| checks              | read/write                           | нет                                  | read                                    |
| contents            | read/write                           | read                                 | read                                    |
| deployments         | read/write                           | нет                                  | read                                    |
| id_token            | read/write                           | нет                                  | read                                    |
| issues              | read/write                           | нет                                  | read                                    |
| метаданные          | read                                 | read                                 | read                                    |
| пакеты              | read/write                           | нет                                  | read                                    |
| pull requests       | read/write                           | нет                                  | read                                    |
| repository projects | read/write                           | нет                                  | read                                    |
| security events     | read/write                           | нет                                  | read                                    |
| statuses            | read/write                           | нет                                  | read                                    |
{% else %}
