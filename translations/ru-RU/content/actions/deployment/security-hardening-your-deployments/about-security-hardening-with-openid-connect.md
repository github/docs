...
| `репозиторий`      | The repository from where the workflow is running.                |
...
| `рабочий процесс`  | The name of the workflow.                                         |
...
| Облачная платформа Google | `(assertion.sub=='repo:octo-org/octo-repo:ref:refs/heads/demo-branch')`                           |
