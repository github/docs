---
title: Управление запусками рабочих процессов
shortTitle: Manage workflow runs
intro: 'Вы можете повторно запустить или отменить рабочий процесс, {% ifversion fpt or ghes or ghae %}просмотреть развертывание, {% endif %}просмотреть оплачиваемые минуты выполнения задания и скачать артефакты.'
redirect_from:
