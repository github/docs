---
title: Переход на GitHub Actions
shortTitle: Migrate to GitHub Actions
intro: 'Узнайте, как перенести существующие рабочие процессы CI/CD в {% data variables.product.prodname_actions %}.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
