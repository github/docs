---
title: Руководства по GitHub Actions
intro: 'Эти руководства по {% data variables.product.prodname_actions %} включают конкретные варианты использования и примеры, которые помогут настроить рабочие процессы.'
...
ms.openlocfilehash: 4bd48a62bb403cddffb57384b62b686e474d7933
ms.sourcegitcommit: 42d16ca5031d40346f6a6f0e76d63eb8f2ad05bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/24/2022
ms.locfileid: '148105158'
---
