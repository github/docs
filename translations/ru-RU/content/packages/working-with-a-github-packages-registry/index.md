---
title: Работа с реестром GitHub Packages
shortTitle: Working with a GitHub Packages registry
intro: 'Узнайте, как использовать поддерживаемый реестр {% data variables.product.prodname_registry %}.'
redirect_from:
...
ms.locfileid: '145140446'
---
{% data reusables.package_registry.packages-ghes-release-stage %} {% data reusables.package_registry.packages-ghae-release-stage %} {% ifversion fpt or ghec %} ![Схема, демонстрирующая поддержку пакетов для Docker, Реестра контейнеров, RubyGems, npm, Apache Maven, NuGet и Gradle](/assets/images/help/package-registry/packages-diagram-with-container-registry.png) {% else %} ![Схема, демонстрирующая поддержку пакетов для Docker, RubyGems, npm, Apache Maven, Gradle, NuGet и Docker](/assets/images/help/package-registry/packages-diagram-without-container-registry.png) {% endif %}
