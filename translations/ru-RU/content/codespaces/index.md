---
title: Документация по кодовым пространствам GitHub
shortTitle: GitHub Codespaces
intro: 'Создайте codespace, чтобы начать разработку в безопасной, настраиваемой специально выделенной среде разработки, которая выполняет необходимые задачи в нужном месте.'
introLinks:
