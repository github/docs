---
title: Управление GitHub Codespaces для организации
allowTitleToDifferFromFilename: true
shortTitle: Managing your organization
intro: 'Вы можете управлять тем, как пользователи в вашей организации могут использовать {% data variables.product.prodname_github_codespaces %}.'
versions:
  fpt: '*'
  ghec: '*'
topics:
