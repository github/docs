...
| Notification (Оповещения) | Notification access allows apps to read your {{ site.data.variables.product.product_name }} notifications, such as comments on issues and pull requests. However, apps remain unable to access anything in your repositories.                                                    |
