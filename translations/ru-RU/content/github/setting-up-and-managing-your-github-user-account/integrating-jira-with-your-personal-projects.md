...
3. In the left sidebar, click **{{ site.data.variables.product.prodname_oauth_app }}s**. ![{ site.data.variables.product.prodname_oauth_app }}s tab in the left sidebar](/assets/images/help/settings/developer-settings-oauth-apps.png)
