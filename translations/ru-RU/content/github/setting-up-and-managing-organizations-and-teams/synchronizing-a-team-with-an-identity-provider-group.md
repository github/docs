...
All team membership changes made through your IdP will appear in the audit log on {{ site.data.variables.product.product_name }} as changes made by the team synchronization bot. Your IdP will send team membership data to {{ site.data.variables.product.prodname_dotcom }} once every hour. Connecting a team to an IdP group may remove some team members. For more information, see "[Requirements for members of synchronized teams](#requirements-for-members-of-synchronized-teams)."
