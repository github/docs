---
title: 'Конечные точки, доступные для детализированных личных маркеров доступа'
intro: '{% data variables.product.pat_v2 %} может отправлять запросы к следующим конечным точкам REST.'
versions:
  feature: pat-v2
