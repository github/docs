...
shortTitle: Overview
intro: 'Узнайте о ресурсах, библиотеках, предварительных версиях и устранении неполадок для REST API {% data variables.product.prodname_dotcom %}.'
versions:
  fpt: '*'
  ghes: '*'
  ghae: '*'
