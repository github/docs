...
ms.locfileid: '147064301'
---
## Сведения об API веб-каналов

Чтобы узнать, какие веб-каналы доступны вам, используйте операцию [Получить веб-каналы](#get-feeds). Затем можно получить веб-канал, отправив запрос на один из URL-адресов веб-канала.

### Пример получения веб-канала Atom
