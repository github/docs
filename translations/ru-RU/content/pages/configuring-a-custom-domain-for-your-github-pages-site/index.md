---
title: Настройка личного домена для сайта GitHub Pages
intro: 'Вы можете настроить доменное имя сайта {% data variables.product.prodname_pages %}.'
redirect_from:
