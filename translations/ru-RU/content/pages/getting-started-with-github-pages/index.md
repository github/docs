---
title: Начало работы с GitHub Pages
intro: 'Вы можете настроить базовый сайт {% data variables.product.prodname_pages %} для себя, своей организации или проекта.'
redirect_from:
