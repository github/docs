---
title: Настройка сайта GitHub Pages с помощью Jekyll
intro: 'Для дальнейшей настройки сайта {% data variables.product.prodname_pages %} можно использовать Jekyll — популярный генератор статических сайтов.'
redirect_from:
