...
intro: 'Защитите свою учетную запись и данные с помощью таких функций, как {% ifversion not ghae %}двухфакторная проверка подлинности, {% endif %}SSH{% ifversion not ghae %},{% endif %} и проверка подписи фиксации.'
redirect_from:
