---
title: GitHub Global Campus для учащихся
intro: 'В качестве учащегося используйте {% data variables.product.prodname_dotcom %} для совместной работы над школьными проектами и получения реального опыта.'
redirect_from:
