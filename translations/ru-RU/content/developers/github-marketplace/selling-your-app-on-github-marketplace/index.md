---
title: Продажа приложения в GitHub Marketplace
intro: 'Узнайте о требованиях и рекомендациях по продаже приложения в {% data variables.product.prodname_marketplace %}.'
redirect_from:
