...
| `marketplace_purchase` | `объект` | The {{ site.data.variables.product.prodname_marketplace }} purchase information.                                                                                                                                                                                                                                                                                                                 |
...
| `billing_cycle`      | `строка`  | Can be `yearly` or `monthly`. When the `account` owner has a free GitHub plan and has purchased a free {{ site.data.variables.product.prodname_marketplace }} plan, `billing_cycle` will be `nil`.                                                                                                                                             |
...
| `next_billing_date`  | `строка`  | The date that the next billing cycle will start. When the `account` owner has a free GitHub.com plan and has purchased a free {{ site.data.variables.product.prodname_marketplace }} plan, `next_billing_date` will be `nil`.                                                                                                                  |
