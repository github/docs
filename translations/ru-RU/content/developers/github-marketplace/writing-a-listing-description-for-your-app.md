...
- Describe the app’s functionality. Don't use this space for a call to action. Например:
...
- Only capitalize proper nouns. Например:
...
- Avoid acronyms unless they’re well established (such as API). Например:
...
- For each value proposition, include a title followed by a paragraph of description. Format the title as a [level-three header](/articles/basic-writing-and-formatting-syntax/#headings) using Markdown. Например:
