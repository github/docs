...
| --------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `refresh_token` | `строка` | **Required.** The token generated when the  {{ site.data.variables.product.prodname_github_app }} owner enables expiring tokens and issues a new user access token. |
| `grant_type`    | `строка` | **Required.** Value must be `refresh_token` (required by the OAuth specification).                                                                                    |
| `client_id`     | `строка` | **Required.** The  client ID for your {{ site.data.variables.product.prodname_github_app }}.                                                                        |
| `client_secret` | `строка` | **Required.** The  client secret for your {{ site.data.variables.product.prodname_github_app }}.                                                                    |
