...
2. Use the **Owner** drop-down menu, and select the organization{% ifversion fpt or ghae or ghes or ghec %} or user account{% endif %} you want to create default files for. ![Owner drop-down menu](/assets/images/help/repository/create-repository-owner.png)
