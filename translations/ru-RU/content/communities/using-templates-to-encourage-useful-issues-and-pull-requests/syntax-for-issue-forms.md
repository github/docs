...
| Клавиша     | Description                                                                                                | Required | Тип                             |
|:----------- |:---------------------------------------------------------------------------------------------------------- |:-------- |:------------------------------- |
| `name`      | A name for the issue form template. Must be unique from all other templates, including Markdown templates. | Required | Строка                          |
| `описание`  | A description for the issue form template, which appears in the template chooser interface.                | Required | Строка                          |
| `тело`      | Definition of the input types in the form.                                                                 | Required | Array                           |
...
| `labels`    | Labels that will automatically be added to issues created with this template.                              | Optional | Строка                          |
| `title`     | A default title that will be pre-populated in the issue submission form.                                   | Optional | Строка                          |
