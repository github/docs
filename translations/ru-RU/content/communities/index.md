---
title: Создание сообществ
shortTitle: Building communities
intro: 'Ознакомьтесь с рекомендациями по модерации и настройке совместных, безопасных и эффективных сообществ с помощью средств, протестированных сообществом GitHub.'
redirect_from:
