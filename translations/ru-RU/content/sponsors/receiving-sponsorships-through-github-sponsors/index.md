---
title: Получение спонсорства через GitHub Sponsors
shortTitle: Receiving sponsorships
intro: 'Вы или ваша организация можете стать спонсируемым участником проекта с открытым кодом, чтобы получать оплату за выполненную работу, изменять сведения о спонсорстве и общаться со своими спонсорами.'
redirect_from:
