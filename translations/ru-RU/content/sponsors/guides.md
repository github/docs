---
title: Руководства по спонсорам GitHub
shortTitle: Guides
intro: 'Узнайте, как максимально эффективно использовать {% data variables.product.prodname_sponsors %}.'
