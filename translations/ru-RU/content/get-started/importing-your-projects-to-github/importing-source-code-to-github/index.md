---
title: Импорт исходного кода в GitHub
intro: 'Репозитории можно импортировать в GitHub с помощью {% ifversion fpt %}средства импортирования GitHub, командной строки,{% else %}командной строки{% endif %} или сторонних средств миграции.'
redirect_from:
