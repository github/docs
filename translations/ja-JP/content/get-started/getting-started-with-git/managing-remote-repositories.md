...
[資格情報ヘルパーを使用](/github/getting-started-with-github/caching-your-github-credentials-in-git)して、Git が GitHub と通信するたびに、GitHub ユーザー名と個人用アクセス トークンを記憶させることができます。
