...
コマンド パレットを使用して、{% data variables.product.product_location %} 上の任意の項目を検索できます。
...
|`Open in new codespace`|このリポジトリのコードスペースを作成して開きます。 詳細については、「[codespace を作成する](/codespaces/developing-in-codespaces/creating-a-codespace)」を参照してください。|
...
|`Open in new codespace`|pull request のヘッド ブランチのコードスペースを作成して開きます。 詳細については、「[codespace を作成する](/codespaces/developing-in-codespaces/creating-a-codespace)」を参照してください。
