...
追加した返信テンプレートは、Issue でもプルリクエストでも利用できます。 返信テンプレートは、個人アカウントに関連付けられます。 作成した返信テンプレートは、リポジトリや Organization にまたがって利用できます。
...
- 「[返信テンプレートの使用](/articles/using-saved-replies)」
