...
{% data reusables.code-scanning.about-code-scanning %}詳細については、「[{% data variables.product.prodname_code_scanning %} について](/code-security/secure-coding/about-code-scanning)」を参照してください。
...
詳しい情報については、「[{% data variables.product.prodname_codeql_cli %} を CI システムで実行する](/code-security/secure-coding/running-codeql-cli-in-your-ci-system)」を参照してください。
