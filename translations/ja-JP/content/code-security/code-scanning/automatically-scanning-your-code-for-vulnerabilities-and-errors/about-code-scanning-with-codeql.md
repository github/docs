...
## {% data variables.product.prodname_codeql %}との{% data variables.product.prodname_code_scanning %}について
...
{% data variables.product.prodname_codeql %} はコンパイル言語とインタープリタ言語の両方をサポートし、サポートされている言語で記述されたコードの脆弱性とエラーを見つけることができます。
