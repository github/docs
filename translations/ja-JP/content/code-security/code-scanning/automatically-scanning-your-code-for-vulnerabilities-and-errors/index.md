...
intro: '{% data variables.product.prodname_dotcom %} でプロジェクトのコード内の脆弱性とエラーを見つけるだけでなく、関連する {% data variables.product.prodname_code_scanning %} アラートの表示、トリアージ、理解、解決を行うことができます。'
