...
1. 任意のページの上部で、 **[Marketplace]** クリックします。
  ![Marketplace リンク](/assets/images/help/search/marketplace-link.png)
2. キーワードを入力し、**Enter** キーを押します。
  ![{% data variables.product.prodname_marketplace %} でリンターを検索する](/assets/images/help/search/marketplace-apps-and-actions-search-field.png)
...
3. 左側のサイドバーで、 **[Marketplace]** をクリックします。
  ![Marketplace のサイドメニュー オプションが強調表示されているリンターの検索結果](/assets/images/help/search/marketplace-left-side-navigation.png)

## 参考資料

- 「[{% data variables.product.prodname_marketplace %} について](/github/customizing-your-github-workflow/about-github-marketplace)」
- "[ワークフローで {% data variables.product.prodname_marketplace %} のアクションを使用する](/actions/automating-your-workflow-with-github-actions/using-actions-from-github-marketplace-in-your-workflow)"
