...
ms.locfileid: '145112598'
---
詳細について、または {% data variables.product.prodname_enterprise %} を購入する方法については、[{% data variables.product.prodname_enterprise %}](https://github.com/enterprise) を参照してください。

{% data reusables.enterprise_installation.request-a-trial %}

インストール プロセスについて質問がある場合は、[{% data variables.product.prodname_enterprise %} サポートの使用](/enterprise/admin/guides/enterprise-support/)に関するページを参照してください。
