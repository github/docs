---
title: GitHub Connect の構成
intro: '{% data variables.product.prodname_github_connect %} では、{% data variables.product.product_location %} を {% data variables.product.prodname_ghe_cloud %} に接続することで、追加の機能とワークフローにアクセスできます。'
redirect_from:
