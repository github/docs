...
- 特定のイベントの監査ログを検索する{% ifversion ghec %}ことや、監査ログ データをエクスポートする{% endif %}ことができます。 詳しくは、「[企業の監査ログの検索](/admin/monitoring-activity-in-your-enterprise/reviewing-audit-logs-for-your-enterprise/searching-the-audit-log-for-your-enterprise)」{% ifversion ghec %}および「[企業の監査ログのエクスポート](/admin/monitoring-activity-in-your-enterprise/reviewing-audit-logs-for-your-enterprise/exporting-audit-log-activity-for-your-enterprise)」{% endif %}を参照してください。{% ifversion audit-data-retention-tab %}
