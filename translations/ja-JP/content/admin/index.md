...
intro: '{% data variables.product.product_name %} を{% ifversion ghes %}デプロイ、{% endif %}設定{% ifversion ghes %}、{% endif %}および管理する Enterprise 管理者、システム管理者、およびセキュリティスペシャリスト向けのドキュメントとガイドです。'
redirect_from:
