...
ms.locfileid: '145090268'
---
{% data reusables.profile.access_org %} {% data reusables.profile.org_settings %} {% data reusables.organizations.block_users %}
5. [Blocked users] の下で、Organization からブロックしたユーザの一覧を確認します。
  ![ブロックされたユーザーの一覧](/assets/images/help/settings/list-of-blocked-users-for-org.png)
...
- 「[個人アカウントからブロックしたユーザーを表示する](/articles/viewing-users-you-ve-blocked-from-your-personal-account)」
