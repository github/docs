...
4. [クーポンの適用] で、*個人* アカウントのユーザー名の横にある **[選択]** をクリックします。
   ![[選択] ボタン](/assets/images/help/settings/redeem-coupon-choose-button-for-personal-accounts.png) {% data reusables.dotcom_billing.redeem_coupon %}
...
{% data reusables.dotcom_billing.enter_coupon_code_on_redeem_page %}
4. [クーポンの引き換え] で、クーポンを適用する **組織** の横にある *[選択*] をクリックします。 まだ存在していない新しい Organization にクーポンを適用する場合は、 **[新しい Organization の作成]** をクリックします。
   ![[選択] ボタン](/assets/images/help/settings/redeem-coupon-choose-button.png) {% data reusables.dotcom_billing.redeem_coupon %}
