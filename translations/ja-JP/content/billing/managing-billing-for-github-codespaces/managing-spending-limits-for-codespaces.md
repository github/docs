...
intro: '{% data variables.product.prodname_codespaces %} に対して使用制限を設定できます。'
versions:
  fpt: '*'
  ghec: '*'
type: how_to
...
ms.locfileid: "145088067"
---
## <a name="about-spending-limits-for--data-variablesproductprodname_codespaces-"></a>{% data variables.product.prodname_codespaces %} の利用上限について
...
{% data variables.product.prodname_codespaces %} の使用に対する価格の詳細については、「[{% data variables.product.prodname_codespaces %} の支払いについて](/billing/managing-billing-for-github-codespaces/about-billing-for-codespaces)」を参照してください。

{% ifversion ghec %}
## <a name="using-your-azure-subscription"></a>Azureサブスクリプションの利用
...
## <a name="managing-the-spending-limit-for--data-variablesproductprodname_codespaces--for-your-organization"></a>組織の {% data variables.product.prodname_codespaces %} に対する利用上限を管理する
...
{% ifversion ghec %}
## <a name="managing-the-spending-limit-for--data-variablesproductprodname_codespaces--for-your-enterprise-account"></a>エンタープライズ アカウントの {% data variables.product.prodname_codespaces %} に対する利用上限を管理する
...
## <a name="managing-usage-and-spending-limit-email-notifications"></a>使用状況の管理と利用上限のメール通知
