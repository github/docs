...
- 自分がレビューした pull request{% ifversion fpt or ghae-issue-5181 or ghes > 3.2 or ghec %}
...
- [レビューを要求した](/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/requesting-a-pull-request-review)特定のユーザーごとに pull request をフィルター処理する: `state:open type:pr review-requested:octocat`{% ifversion fpt or ghae-issue-5181 or ghes > 3.2 or ghec %}
- 誰かから直接レビューするよう求められた pull request をフィルター処理する: `state:open type:pr user-review-requested:@me`{% endif %}
- レビューを要求したチームで pull request をフィルター処理する: `state:open type:pr team-review-requested:github/atom`
