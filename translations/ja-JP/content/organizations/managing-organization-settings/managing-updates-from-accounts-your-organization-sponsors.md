...
Organization のスポンサーアカウントからの更新を無効化することもできます。 詳細は「[スポンサーシップを管理する](/github/supporting-the-open-source-community-with-github-sponsors/managing-your-sponsorship#managing-email-updates-for-your-sponsorship)」を参照してください。
...
- 「[{% data variables.product.prodname_sponsors %} でオープンソースコミュニティをサポートする](/github/supporting-the-open-source-community-with-github-sponsors)」
