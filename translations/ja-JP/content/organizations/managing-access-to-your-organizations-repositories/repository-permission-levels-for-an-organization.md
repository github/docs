...
{% endif %}
| wiki の編集                                                                                                                                                                                                                      | **X** | **X**  | **X** |  **X**   |            **X** |{% ifversion fpt %}
...
| リポジトリのデフォルトブランチ編集                                                                                                                                                                                                             |       |        |       |          |     **X** |{% ifversion fpt or ghes > 3.0 %}
...
| {% data variables.product.prodname_GH_advanced_security %}の機能へのアクセス管理（「[Organizationのセキュリティと分析設定の管理](/organizations/keeping-your-organization-secure/managing-security-and-analysis-settings-for-your-organization)」参照）       |       |        |                     |                     | **X** |{% endif %}{% ifversion fpt %}<!--Set at site-level for GHES-->
|
