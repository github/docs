...
1. Under "Publisher Verification", complete the information in the checklist:
   ...
   - Ensure that Two-factor authentication is enabled for your organization. 詳しい情報については [Organization で 2 要素認証を要求する](/github/setting-up-and-managing-organizations-and-teams/requiring-two-factor-authentication-in-your-organization)を参照してください。
