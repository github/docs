...
intro: 'Learn how to integrate the {{ site.data.variables.product.prodname_marketplace }} API and webhook events into your app for the {{ site.data.variables.product.prodname_marketplace }} .'
mapTopic: true
redirect_from:
