...
### ステップ 1. Start a new Smee channel
...
### ステップ 2. Register a new GitHub App
...
* For the "Homepage URL", use the domain issued by Smee. 例:

    ![Form with Smee domain filled in for homepage URL](/assets/images/homepage-url.png)

* For the "Webhook URL", again use the domain issued by Smee. 例:
...
### ステップ 3. Save your private key and App ID
...
### ステップ 4. Prepare the runtime environment
...
### ステップ 5. Review the GitHub App template code
...
### ステップ 7. Install the app on your account
