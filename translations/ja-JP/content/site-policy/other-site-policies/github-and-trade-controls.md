...
## <a name="export-overview"></a>輸出の概要
...
## <a name="frequently-asked-questions"></a>よくある質問
...
### <a name="will-traveling-in-these-regions-be-impacted"></a>対象地域内の旅行には影響がありますか?
...
### <a name="what-is-available-and-not-available"></a>利用できるものとできないものを教えてください。
...
### <a name="how-do-you-define-these-specific-users"></a>これらの特定のユーザーをどのように定義していますか?
...
### <a name="how-are-organization-accounts-impacted"></a>組織アカウントにはどのような影響があるのですか?
...
### <a name="can-trade-restricted-users-private-repositories-be-made-public"></a>貿易制限対象ユーザーのプライベート リポジトリは公開できますか?
...
### <a name="can-trade-restricted-users-access-private-repository-data-eg-downloading-or-deletion-of-repository-data"></a>貿易制限対象ユーザーはプライベート リポジトリ データにアクセスできますか (リポジトリ データをダウンロードまたは削除するなど)?
...
### <a name="under-the-license-github-has-received-from-ofac-which-types-of-accounts-will-be-available-in-iran"></a>GitHub が OFAC から得た許可の下、イランで利用できるのはどのようなアカウントですか?
...
### <a name="will-iranian-github-users-be-able-to-use-paid-services-under-the-license"></a>イランの GitHub ユーザーは、この許可この下で有料サービスを利用することができますか?
...
### <a name="can-you-clarify-availability-of-github-to-cuban-developers"></a>キューバの開発者に GitHub の利用可能性を明言できますか?
