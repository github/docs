...
## <a name="what-is-the-dmca"></a>DMCA とは何ですか?
...
## <a name="dmca-notices-in-a-nutshell"></a>DMCA 通知の要約
...
## <a name="a-how-does-this-actually-work"></a>A. どのように機能するのですか?
...
## <a name="b-what-about-forks-or-whats-a-fork"></a>B. フォークについて教えてください (またはフォークとは何ですか?)
...
## <a name="c-what-about-circumvention-claims"></a>C. 回避申し立てとは何ですか?
...
## <a name="d-what-if-i-inadvertently-missed-the-window-to-make-changes"></a>D. 変更を行う期間をうっかり逃してしまった場合はどうなりますか?
...
## <a name="f-repeated-infringement"></a>F. 繰り返される権利侵害

適切な状況で独自の裁量により、GitHub または他者の著作権や知的財産権を侵害するユーザーのアカウントを無効化、終了させることは、GitHub のポリシーです。

## <a name="g-submitting-notices"></a>G. 通知の送信
...
## <a name="learn-more-and-speak-up"></a>詳細と発言
