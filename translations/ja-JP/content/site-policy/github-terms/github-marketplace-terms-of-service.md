...
## <a name="a-githubcoms-terms-of-service"></a>A. GitHub.com のサービス条件
...
## <a name="b-use-requirements"></a>B. 使用要件
...
## <a name="c-developer-products-and-product-providers"></a>C. 開発者製品および製品プロバイダー
...
## <a name="d-payment-billing-schedule-and-cancellation"></a>D. 支払い、請求スケジュール、および解約
...
## <a name="e-your-data-and-githubs-privacy-policy"></a>E. お客様のデータと GitHub のプライバシー ポリシー
...
## <a name="h-developer-product-blocking"></a>H. 開発者製品のブロック
...
## <a name="i-disclaimer-limitation-of-liability-release-and-indemnification"></a>I. 免責、責任の制限、免責および補償
