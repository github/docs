...
## <a name="connecting-to-github"></a>GitHub への接続
...
## <a name="open-source-licenses-and-notices"></a>オープン ソース ライセンスおよび通知
...
## <a name="githubs-logos"></a>GitHub のロゴ
...
4. 第三者の Packages 本ソフトウェアは、本ソフトウェアの機能を改善、追加、削除、または変更できる、第三者の「Packages」をサポートしています。  これらの Packages は、本アプリケーション条件の対象ではありませんが、その特定のパッケージに適用される独自のライセンスが含まれている場合があります。
...
7. お問い合わせ。 サービス条件についてご質問がある場合は、 [当社までお問い合わせください](https://support.github.com/contact?tags=docs-policy)。
