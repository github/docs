...
##  <a name="section-1-github-enterprise-server-license-terms"></a>セクション 1: GitHub Enterprise Server ライセンス条項

第 1 条は、お客様による「ソフトウェア」の利用に適用される規約を記載しています。

### <a name="11-license-grant"></a>1.1 ライセンスの付与。
...
### <a name="12-restrictions"></a>1.2 制限事項。
...
### <a name="13-delivery"></a>1.3 デリバリー。
...
### <a name="14-verification"></a>1.4 検証。
...
### <a name="16-updates-releases"></a>1.6 更新、リリース。

#### <a name="161-generally"></a>1.6.1 一般条件。

GitHub は、「ソフトウェア」に対する「更新」および「リリース」を、お客様が「ソフトウェア」および「ライセンス キー」をダウンロードした場所と同一の安全な Web サイトでお客様が入手できるようにするものとします。

#### <a name="162-supported-releases"></a>1.6.2 サポートされるリリース。
...
### <a name="17-add-on-software"></a>1.7 アドオン ソフトウェア。
...
### <a name="18-data-protection-considerations-for-use-of-github-insights-and-learning-lab-for-enterprise-server"></a>1.8 GitHub Insights および Learning Lab for Enterprise Server を利用する際のデータ保護に関する考慮事項。
...
### <a name="19-limited-software-warranty"></a>1.9 ソフトウェアの限定保証。
...
## <a name="section-2-github-enterprise-cloud-terms-of-service"></a>セクション 2: GitHub Enterprise Cloud 利用規約

本セクション 2 では、お客様または GitHub がお客様に代わって本サービスに「企業アカウント」および/または「組織アカウント」を作成した際、お客様による本サービスの利用に適用される条件について詳細に説明します。

### <a name="21-account-terms"></a>2.1 アカウント利用規約

#### <a name="211-account-controls"></a>2.1.1 アカウント管理
...
#### <a name="212-account-requirements"></a>2.1.2 アカウントの要件
...
#### <a name="213-account-security"></a>2.1.3 アカウント セキュリティ
...
#### <a name="214-additional-terms"></a>2.1.4 追加条項
...
#### <a name="215-us-federal-government-terms"></a>2.1 5 米国連邦政府の条項
...
### <a name="22-compliance-with-laws-acceptable-use-privacy"></a>2.2 法規制の遵守、許容される使用、プライバシー

#### <a name="221-compliance-with-laws-and-regulations"></a>2.2.1 法規制の遵守

お客様による本サービスの使用は、著作権法、商標法、輸出管理法、または管轄区域の規制を含む適用法に違反してはなりません。

#### <a name="222-acceptable-use"></a>2.2.2 許諾される使用
...
#### <a name="223-privacy"></a>2.2.3 プライバシー
...
### <a name="23-content-responsibility-ownership-license-rights"></a>2.3 コンテンツの責任、所有権、ライセンスの権利

#### <a name="231-responsibility-for-user-generated-content"></a>2.3.1 ユーザー生成コンテンツに対する責任
...
#### <a name="232-ownership-of-content-right-to-post-and-license-grants"></a>2.3.2 コンテンツの所有権、投稿権、ライセンスの付与
...
#### <a name="233-license-grant-to-github"></a>2.3.3 GitHub へのライセンス付与
...
#### <a name="234-license-grant-to-external-users"></a>2.3.4 外部ユーザーへのライセンス付与
...
#### <a name="235-contributions-under-repository-license"></a>2.3.5 リポジトリ ライセンスの下でのコントリビューション
...
#### <a name="236-moral-rights"></a>2.3.6 著作者人格権
...
### <a name="24-private-repositories"></a>2.4 プライベート リポジトリ

#### <a name="241-control"></a>2.4.1 管理

お客様は、招待、組織アカウントおよびチームの管理、およびアクセスの終了など、プライベート リポジトリへのアクセスを管理する責任があります。

#### <a name="242-confidentiality"></a>2.4.2 秘密保持
...
#### <a name="243-access"></a>2.4.3 アクセス
...
#### <a name="244-exclusions"></a>2.4.4 除外
...
### <a name="25-intellectual-property-notices"></a>2.5. 知的財産に関する通知

#### <a name="251-githubs-rights-to-content"></a>2.5.1.コンテンツに対する GitHub の権利
...
#### <a name="252-copyright-infringement-and-dmca-policy"></a>2.5.2 著作権侵害と DMCA ポリシー
...
### <a name="27-communications-with-github"></a>2.7 GitHub との連絡
...
### <a name="28-service-level-agreement"></a>2.8 サービス レベル アグリーメント
...
### <a name="29-service-changes"></a>2.9 サービスの変更
...
### <a name="210-additional-service-features"></a>2.10 追加サービス機能
...
## <a name="section-3-general-provisions"></a>セクション 3: 一般条項

セクション 3 では、あらゆる「製品」について、お客様による購入および使用に適用される規約および条件を規定します。

### <a name="31-term-termination-effect-of-termination"></a>3.1 契約期間、終了、終了の効果

#### <a name="311-term"></a>3.1.1 契約期間
本 GitHub 補足条項は、セクション 3.1 の規定に従って「当事者」によって解約されるまで有効であり続けるものとします。

#### <a name="312-termination-for-convenience-account-cancellation"></a>3.1.2 当事者の都合による終了、アカウントの解約
...
#### <a name="313-termination-for-material-breach"></a>3.1.3 重大な違反による終了
...
#### <a name="314-effect-of-termination"></a>3.1.4 終了の効果
...
### <a name="32-feedback"></a>3.2 フィードバック
...
### <a name="33-compliance-with-laws-and-regulations"></a>3.3 法規制の遵守
お客様は、本製品の利用にあたり、データ保護および雇用に関する法令など、適用されるすべての法令を遵守するものとします。

### <a name="34-order-of-precedence"></a>3.4 優先順位
