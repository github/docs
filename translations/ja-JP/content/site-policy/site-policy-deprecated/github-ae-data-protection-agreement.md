...
## <a name="github-data-protection-agreement"></a>GitHub データ保護契約

### <a name="1-definitions"></a>1.定義
...
## <a name="2-status-and-compliance"></a>2. ステータスと法令遵守。

#### <a name="21-data-processing"></a>2.1 データ処理。
...
#### <a name="22-data-controllers"></a>2.2 データ管理者。
...
#### <a name="23-github-compliance-data-transfers"></a>2.3 GitHub の法令遵守、データ転送。
...
#### <a name="24-data-subject-rights-assistance-with-requests"></a>2.4 データ主体の権利、要求のサポート。
...
### <a name="3-data-protection"></a>3. データ保護。

#### <a name="31-purpose-limitation"></a>3.1 目的の制限。
GitHub は、両当事者が目的を拡大することについて書面で合意する場合を除き、許可された目的でのみ、保護データの処理および通信を行います。

#### <a name="32-data-quality-and-proportionality"></a>3.2 データの品質と比例性。
...
#### <a name="33-data-retention-and-deletion"></a>3.3 データの保持と削除。
...
#### <a name="34-data-processing"></a>3.4 データ処理。
...
### <a name="4-security-and-audit-obligations"></a>4. セキュリティと監査の義務。

#### <a name="41-technical-and-organizational-security-measures"></a>4.1 技術的および組織的なセキュリティ対策。
...
#### <a name="42-incident-response-and-breach-notification"></a>4.2 インシデント対応と侵害通知。
...
#### <a name="45-compliance-reporting"></a>4.5 コンプラインス レポート。
...
### <a name="5-use-and-disclosure-of-protected-data"></a>5. 保護データの使用と開示。
...
### <a name="6-subprocessing-and-onward-transfer"></a>6. サブプロセスと転送。

#### <a name="61-protection-of-data"></a>6.1 データの保護。
...
#### <a name="62-acceptance-of-github-subprocessors"></a>6.2 GitHub サブ処理者の承認。
お客様は、本第 6 項および本契約に従って、GitHub およびそのサブ処理者がサブ処理者を指定して使用することを承認します。

#### <a name="63-general-consent-for-onward-subprocessing"></a>6.3 転送サブプロセスに関する全面同意。
...
#### <a name="64-disclosure-of-subprocessor-agreements"></a>6.4 サブ処理者契約の開示。
...
#### <a name="65-objection-to-subprocessors"></a>6.5 サブ処理者への異議申し立て。
...
### <a name="7-termination"></a>7. 契約解除。

#### <a name="71-suspension"></a>7.1 一時停止。
...
#### <a name="72-termination-with-cause"></a>7.2 正当事由による解除。
...
#### <a name="73-breach"></a>7.3 違反。
DPA で定められている重要な規定を遵守できない場合、本契約に基づく重大な違反とみなされます。

#### <a name="74-failure-to-perform"></a>7.4 契約不履行。
...
#### <a name="76-modifications"></a>7.6 変更。
GitHub は、適用されるデータ保護法の要求に応じて、30 日前にお客様に通知することにより、適宜 DPA を変更できるものとします。

#### <a name="77-termination-requirements"></a>7.7 契約解除の要件。
...
### <a name="8-liability-for-data-processing"></a>8. データ処理に関する責任。

#### <a name="81-limitations"></a>8.1 制限事項。
適用されるデータ保護法で制限されている場合を除き、DPA に基づいて提起されたあらゆる請求は、責任制限に関する本契約の条件に従うものとします。

## <a name="attachment-1--the-standard-contractual-clauses-processors"></a>添付文書 1 – 標準契約条項 (処理者)
...
#### <a name="clause-1-definitions"></a>第 1 条:定義
...
#### <a name="clause-2-details-of-the-transfer"></a>第 2 条:移転の詳細
移転および特に特別な種類の個人データ (該当する場合) の詳細については、本条項の不可欠な部分である以下の付属文書 1 に規定するとおりとします。

#### <a name="clause-3-third-party-beneficiary-clause"></a>第 3 条:第三者受益者に関する条項
...
#### <a name="clause-4-obligations-of-the-data-exporter"></a>第 4 条:データ輸出者の義務
...
#### <a name="clause-5-obligations-of-the-data-importer"></a>第 5 条:データ輸入者の義務
...
#### <a name="clause-6-liability"></a>第 6 条:責任
...
#### <a name="clause-7-mediation-and-jurisdiction"></a>第 7 条:調停および管轄
...
#### <a name="clause-8-cooperation-with-supervisory-authorities"></a>第 8 条: 監督当局との協力
...
#### <a name="clause-9-governing-law"></a>第 9 条: 準拠法
本契約条項は、データ輸出者の設立国である加盟国の法律に準拠するものとします。

#### <a name="clause-10-variation-of-the-contract"></a>第 10 条:本契約の変更
両当事者は、本契約条項を変更または修正しないことを約束するものとします。 これは、本契約条項に矛盾するものでない限り、両当事者が必要な場合に業務関連の問題に関する条項を追加することを妨げるものではありません。

#### <a name="clause-11-subprocessing"></a>第 11 条:下請処理
...
#### <a name="clause-12-obligation-after-the-termination-of-personal-data-processing-services"></a>第 12 条:個人データ処理サービスの終了後の義務
...
### <a name="appendix-1-to-the-standard-contractual-clauses"></a>標準契約条項の添付 1
データ輸出者:お客様はデータ輸出者です。
...
### <a name="appendix-2-to-the-standard-contractual-clauses"></a>標準契約条項の添付 2
...
## <a name="security-exhibit"></a>セキュリティに関する付属文書

### <a name="1-information-security-program"></a>1. 情報セキュリティプログラム。

#### <a name="11-security-management"></a>1.1 セキュリティ管理。
...
#### <a name="12-security-incident-management"></a>1.2 セキュリティ インシデント管理。
...
#### <a name="13-due-diligence-over-subcontractors-and-vendors"></a>1.3 下請業者とベンダーに対するデュー デリジェンス。
GitHub は、下請業者およびベンダーを利用する場合、適切なデュー デリジェンスを維持します。 GitHub は、ベンダー評価レポートなどの評価作業を最低 3 年間保管します。

#### <a name="14-physical-and-environmental-safeguards"></a>1.4 物理的および環境的な安全対策。
...
#### <a name="2-requests-for-information"></a>2. 情報の要求。
...
#### <a name="3-cooperation-with-regulatory-audits"></a>3. 規制監査との協力。
