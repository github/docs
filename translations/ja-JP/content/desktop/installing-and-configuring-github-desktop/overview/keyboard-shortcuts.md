...
|<kbd>Option</kbd>+<kbd>Command</kbd>+<kbd>I</kbd> | 開発者ツールの切り替え
...
|<kbd>Shift</kbd>+<kbd>Command</kbd>+<kbd>N</kbd> | 新しいブランチを作成する
...
|<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>I</kbd> | 開発者ツールの切り替え
...
|<kbd>Space</kbd>| ハイライトされたすべてのファイルを選択または選択解除
|<kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>N</kbd> | 新しいブランチを作成する
