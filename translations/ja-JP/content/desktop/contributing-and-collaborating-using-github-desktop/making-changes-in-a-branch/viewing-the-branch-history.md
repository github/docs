...
2. **[履歴]** タブで、レビューするコミットをクリックします。
![[履歴] タブのコミット](/assets/images/help/desktop/branch-history-commit.png)
3. コミットに複数のファイルがある場合、個別のファイルをクリックすると、そのコミットのそのファイルに加えられた変更が表示されます。
![コミット内のファイル](/assets/images/help/desktop/branch-history-file.png)
