...
intro: 'ローカルでプロジェクトに変更を加えていくと、リモートリポジトリと同期できます。 Git では、 *"リモート"* とは、コードが保存されているサーバーのことです。 あなたの場合、サーバーは、{% data variables.product.prodname_dotcom %}、または{% data variables.product.prodname_enterprise %}にあるリポジトリです。'
redirect_from:
