...
作成ログを確認して、必要に応じて設定を更新し、コマンドパレットで**Codespaces: Rebuild Container** を実行して再試行します。 For more information, see " [Codespaces logs](/codespaces/troubleshooting/codespaces-logs)" and "[Configuring {% data variables.product.prodname_codespaces %} for your project](/github/developing-online-with-codespaces/configuring-codespaces-for-your-project#apply-changes-to-your-configuration)."
