...
**注**: 
  ...
  -  {% data variables.product.prodname_emu_enterprise %} のメンバーである場合、{% data variables.product.prodname_dotcom_the_website %} 上で自分のメール アドレスを変更することはできません。 {% data reusables.enterprise-accounts.emu-more-info-account %}
...
- 「[メール プリファレンスの管理](/articles/managing-email-preferences/)」
