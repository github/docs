...
ms.locfileid: "145090070"
---
## <a name="about-commit-email-addresses"></a>コミットメールアドレスについて
...
**注:** 2017 年 7 月 18 日 _以降に_ {% data variables.product.product_location %} にアカウントを作成した場合、{% data variables.product.product_name %} の `no-reply` メール アドレスは 7 桁の ID 番号、ユーザー名は <code><em>ID+username</em>@users.noreply.github.com</code> の形式になります。 2017 年 7 月 18 日 _以前に_ {% data variables.product.product_location %} でアカウントを作成した場合、{% data variables.product.product_name %} の `no-reply` メール アドレスは <code><em>username</em>@users.noreply.github.com</code> になります。 {% data variables.product.product_name %} の ID ベースの `no-reply` メール アドレスを取得するには、メール設定で **[Keep my email address private]\(メール アドレスを非公開にする\)** を選択 (または選択解除して再選択) します。
...
## <a name="setting-your-commit-email-address-on--data-variablesproductprodname_dotcom-"></a>{% data variables.product.prodname_dotcom %} のコミットメールアドレスを設定する
...
## <a name="setting-your-commit-email-address-in-git"></a>Git のコミットメールアドレスを設定する
...
### <a name="setting-your-email-address-for-every-repository-on-your-computer"></a>コンピュータにあるすべてのリポジトリ用にメールアドレスを設定する
...
### <a name="setting-your-email-address-for-a-single-repository"></a>単一リポジトリ用にメールアドレスを設定する
