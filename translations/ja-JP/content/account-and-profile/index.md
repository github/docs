---
title: GitHub のアカウントとプロファイル
shortTitle: Account and profile
intro: '個人アカウントの設定の調整、プロファイル ページのカスタマイズ、および {% data variables.product.prodname_dotcom %} で受け取るアクティビティに関する通知の管理を行うことで、{% data variables.product.product_name %} が最適な方法で機能するようにします。'
introLinks:
