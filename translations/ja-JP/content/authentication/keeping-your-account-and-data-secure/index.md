...
intro: '個人情報を保護するには、{% ifversion ghae %}{% data variables.product.product_name %}{% else %}{% data variables.location.product_location %}{% endif %} のアカウントと関連するデータの両方をセキュリティで保護する必要があります。'
redirect_from:
