...
intro: 'サイトを{% if currentVersion == "free-pro-team@latest" %}パブリックに{% else %}{{ site.data.variables.product.product_location }} を使用する誰にも{% endif %} 使用できないように、{{ site.data.variables.product.prodname_pages }} サイトを取り下げることができます。'
redirect_from:
...
5. {{ site.data.variables.product.prodname_pages }} で、[**Source**] ドロップダウンメニューを使用して [**None**] を選択します。 ![公開元を選択するドロップダウンメニュー](/assets/images/help/pages/publishing-source-drop-down.png)
