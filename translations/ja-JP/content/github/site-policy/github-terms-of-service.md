...
当社は、法律、[GitHub の規約またはポリシー](/github/site-policy)に違反すると当社が独自に判断したあらゆる「ユーザ生成コンテンツ」 を拒否および削除する権利を有します。 モバイル向けにGitHubで表示される「ユーザ生成コンテンツ」には、モバイルアプリケーションストアの追加条項が適用される場合があります。
