...
Enterprise アカウントは、複数の {{ site.data.variables.product.prodname_dotcom_the_website }} Organization のポリシーと支払いを集中管理するために利用できます。
...
{{ site.data.reusables.organizations.org-ownership-recommendation }}詳細は、「[Organization の所有権の継続性を管理する](/github/setting-up-and-managing-organizations-and-teams/maintaining-ownership-continuity-for-your-organization)」を参照してください。
...
{{ site.data.reusables.organizations.enter-data-protection-agreement }} 詳細は「[GDPR 準拠のために {{ site.data.variables.product.prodname_dotcom }} とデータ保護契約を締結する](/articles/entering-a-data-protection-agreement-with-github-for-gdpr-compliance)」を参照してください。
{% endif %}
