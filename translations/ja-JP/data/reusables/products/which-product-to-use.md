{{ site.data.variables.product.prodname_ghe_server }}もしくは{{ site.data.variables.product.prodname_ghe_cloud }}、あるいはその両方が自分の組織にとって最適化がはっきりしない場合は、{{ site.data.variables.contact.contact_enterprise_sales }}に連絡してください。
