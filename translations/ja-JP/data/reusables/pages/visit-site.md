1. 公開されたサイトを見るには、"{{ site.data.variables.product.prodname_pages }}"の下で、サイトのURLをクリックしてください。 ![公開されたサイトのURL](/assets/images/help/pages/click-pages-url-to-preview.png)
