...
class Page {
  ...
  async _render(context) {
    ...
    const [_intro,  _introPlainText, _title, html] = await Promise.all([
      renderContentWithFallback(this, 'rawIntro', context),
      renderContentWithFallback(this, 'rawIntro', context, {
        textOnly: true,
      }),
      renderContentWithFallback(this, 'rawTitle', context, {
        textOnly: true,
        throwIfEmpty: true,
      }),
      renderContentWithFallback(this, 'markdown', context)
    ])

    this.intro = _intro
    this.introPlainText = _introPlainText
    this.title = _title
