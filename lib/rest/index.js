...
export default async function getRest(version, category, subCategory) {
  ...
  if (subCategory) {
    ...
    // Some pages are just a category on its own level, and some categories are a subcategory
    // E.g. /rest/licenses versus /rest/branches/branches
    return restOperations.get(openApiVersion)[category][category]
  } else {
