...
const publicContentProductIds = contentProductIds.filter(id => !id.startsWith('early-access'))
...
const earlyAccessId = contentProductIds.find(id => id.startsWith('early-access'))
