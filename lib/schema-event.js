...
const context = {
  ...
  properties: {
    ...
    timezone: {
      type: 'number',
      description:
        'The timezone the user is in, as `new Date().getTimezoneOffset() / -60`.'
    },
    user_language: {
      type: 'string',
...
const pageSchema = {
  ...
  properties: {
    ...
    page_render_duration: {
      type: 'number',
      description:
        'How long the server took to render the page content, in seconds.',
      minimum: 0.001
    }
  }
}
...
const exitSchema = {
  additionalProperties: false,
  required: ['type', 'context', 'exit_page_id'],
  properties: {
    context,
    type: {
      type: 'string',
...
const searchSchema = {
  ...
  properties: {
    ...
    search_query: {
      type: 'string',
      description:
        'The actual text content of the query string the user sent to the service.'
    },
    search_context: {
      type: 'string',
...
const surveySchema = {
  ...
  properties: {
    ...
    survey_email: {
      ...
      format: 'email',
      description:
        "The user's email address, if the user provided and consented."
    }
  }
}
...
const experimentSchema = {
  ...
  properties: {
    ...
    experiment_variation: {
      ...
      description:
        'The variation this user we bucketed in, such as control or treatment.'
    },
    experiment_success: {
      type: 'boolean',
      default: true,
      description:
        'Whether or not the user successfully performed the test goal.'
    }
  }
}
