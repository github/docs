...
export default function dataDirectory(dir, opts = {}) {
  ...
  files.forEach(([filename, fileContent]) => {
    ...
    switch (extension) {
      ...
      case '.md':
      case '.markdown':
        // Drop any frontmatter since reusable Markdown files can potentially
        // have frontmatter, but we want to prevent the frontmatter from being
        // rendered.
        set(data, key, matter(fileContent).content)
        break
    }
  })
