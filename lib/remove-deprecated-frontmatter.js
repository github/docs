import { getEnterpriseServerNumber } from './patterns.js'

export default function removeDeprecatedFrontmatter (file, frontmatterVersions, versionToDeprecate, nextOldestVersion) {
