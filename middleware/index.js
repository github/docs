...
const handleInvalidPaths = require(path.resolve(process.cwd(), './middleware', './handle-invalid-paths'))
const detectLanguage = require(path.resolve(process.cwd(), './middleware', './detect-language'))
const context = require(path.resolve(process.cwd(), './middleware', './context'))
const shortVersions = require(path.resolve(process.cwd(), './middleware', './contextualizers/short-versions'))
const redirectsExternal = require(path.resolve(process.cwd(), './middleware', './redirects/external'))
const helpToDocs = require(path.resolve(process.cwd(), './middleware', './redirects/help-to-docs'))
const languageCodeRedirects = require(path.resolve(process.cwd(), './middleware', './redirects/language-code-redirects'))
const handleRedirects = require(path.resolve(process.cwd(), './middleware', './redirects/handle-redirects'))
const findPage = require(path.resolve(process.cwd(), './middleware', './find-page'))
const blockRobots = require(path.resolve(process.cwd(), './middleware', './block-robots'))
const archivedEnterpriseVersionsAssets = require(path.resolve(process.cwd(), './middleware', './archived-enterprise-versions-assets'))
const events = require(path.resolve(process.cwd(), './middleware', './events'))
const search = require(path.resolve(process.cwd(), './middleware', './search'))
const archivedEnterpriseVersions = require(path.resolve(process.cwd(), './middleware', './archived-enterprise-versions'))
const robots = require(path.resolve(process.cwd(), './middleware', './robots'))
const earlyAccessLinks = require(path.resolve(process.cwd(), './middleware', './contextualizers/early-access-links'))
const categoriesForSupport = require(path.resolve(process.cwd(), './middleware', './categories-for-support'))
const loaderio = require(path.resolve(process.cwd(), './middleware', './loaderio-verification'))
const triggerError = require(path.resolve(process.cwd(), './middleware', './trigger-error'))
const releaseNotes = require(path.resolve(process.cwd(), './middleware', './contextualizers/release-notes'))
const whatsNewChangelog = require(path.resolve(process.cwd(), './middleware', './contextualizers/whats-new-changelog'))
const graphQL = require(path.resolve(process.cwd(), './middleware', './contextualizers/graphql'))
const rest = require(path.resolve(process.cwd(), './middleware', './contextualizers/rest'))
const webhooks = require(path.resolve(process.cwd(), './middleware', './contextualizers/webhooks'))
const layout = require(path.resolve(process.cwd(), './middleware', './contextualizers/layout'))
const currentProductTree = require(path.resolve(process.cwd(), './middleware', './contextualizers/current-product-tree'))
const genericToc = require(path.resolve(process.cwd(), './middleware', './contextualizers/generic-toc'))
const breadcrumbs = require(path.resolve(process.cwd(), './middleware', './contextualizers/breadcrumbs'))
const earlyAccessBreadcrumbs = require(path.resolve(process.cwd(), './middleware', './contextualizers/early-access-breadcrumbs'))
const productExamples = require(path.resolve(process.cwd(), './middleware', './contextualizers/product-examples'))
const devToc = require(path.resolve(process.cwd(), './middleware', './dev-toc'))
const featuredLinks = require(path.resolve(process.cwd(), './middleware', './featured-links'))
const learningTrack = require(path.resolve(process.cwd(), './middleware', './learning-track'))
const isNextRequest = require(path.resolve(process.cwd(), './middleware', './is-next-request'))
const next = require(path.resolve(process.cwd(), './middleware', './next'))
const renderPage = require(path.resolve(process.cwd(), './middleware', './render-page'))
